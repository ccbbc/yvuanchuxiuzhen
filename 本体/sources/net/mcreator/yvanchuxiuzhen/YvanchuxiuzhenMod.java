...
@Mod(modid = YvanchuxiuzhenMod.MODID, version = YvanchuxiuzhenMod.VERSION)
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/YvanchuxiuzhenMod.class */
public class YvanchuxiuzhenMod {
    public static final String MODID = "yvanchuxiuzhen";
    public static final String VERSION = "2.0.19";
    public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("yvanchuxiuzhen:a");
    @SidedProxy(clientSide = "net.mcreator.yvanchuxiuzhen.ClientProxyYvanchuxiuzhenMod", serverSide = "net.mcreator.yvanchuxiuzhen.ServerProxyYvanchuxiuzhenMod")
    public static IProxyYvanchuxiuzhenMod proxy;
    @Mod.Instance(MODID)
    public static YvanchuxiuzhenMod instance;
    public ElementsYvanchuxiuzhenMod elements = new ElementsYvanchuxiuzhenMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsYvanchuxiuzhenMod.GuiHandler());
        ...
        File configFile = new File(modConfigDirFile, "BenTi.cfg");
