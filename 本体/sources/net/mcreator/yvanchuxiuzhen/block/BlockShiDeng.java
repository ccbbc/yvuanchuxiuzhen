...
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureYiZiPuDownDo2;
...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockShiDeng.class */
public class BlockShiDeng extends ElementsYvanchuxiuzhenMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhen:shi_deng")
    public static final Block block = null;
    static Map<String, Object> $_dependencies = new HashMap();

    public BlockShiDeng(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 451);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("shi_deng");
        });
    ...
    public void init(FMLInitializationEvent event) {
        GameRegistry.registerTileEntity(TileEntityCustom.class, "yvanchuxiuzhen:tileentityshi_deng");
    }

    @Override // net.mcreator.yvanchuxiuzhen.ElementsYvanchuxiuzhenMod.ModElement
    @SideOnly(Side.CLIENT)
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yvanchuxiuzhen:shi_deng", "inventory"));
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockShiDeng$BlockCustom.class */
    public static class BlockCustom extends Block implements ITileEntityProvider {
        public static final PropertyDirection FACING = BlockHorizontal.field_185512_D;

        public BlockCustom() {
            super(Material.field_151576_e);
            func_149663_c("shi_deng");
        ...
        public AxisAlignedBB func_185496_a(IBlockState state, IBlockAccess source, BlockPos pos) {
            switch (AnonymousClass1.$SwitchMap$net$minecraft$util$EnumFacing[state.func_177229_b(BlockHorizontal.field_185512_D).ordinal()]) {
                ...
                default:
                    return new AxisAlignedBB(0.1875d, 0.0d, 0.1875d, 0.8125d, 0.5625d, 0.8125d);
        ...
        public void func_176213_c(World world, BlockPos pos, IBlockState state) {
            ...
            BlockShiDeng.$_dependencies.put("x", Integer.valueOf(x));
            BlockShiDeng.$_dependencies.put("y", Integer.valueOf(y));
            BlockShiDeng.$_dependencies.put("z", Integer.valueOf(z));
            BlockShiDeng.$_dependencies.put("world", world);
            ProcedureYiZiPuDownDo2.executeProcedure(BlockShiDeng.$_dependencies);
        }
        ...
        public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
            ...
            BlockShiDeng.$_dependencies.put("z", Integer.valueOf(z));
            BlockShiDeng.$_dependencies.put("world", world);
            ProcedureYiZiBreak.executeProcedure(BlockShiDeng.$_dependencies);
            return retval;
        }
    ...
    /* renamed from: net.mcreator.yvanchuxiuzhen.block.BlockShiDeng$1  reason: invalid class name */
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockShiDeng$1.class */
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockShiDeng$TileEntityCustom.class */
    public static class TileEntityCustom extends TileEntityLockableLoot {
        ...
        public String func_174875_k() {
            return "yvanchuxiuzhen:shi_deng";
        }
