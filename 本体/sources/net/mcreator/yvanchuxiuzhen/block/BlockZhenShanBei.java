...
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureZhenShanBeiBeRightClickDo;
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureZhenShanBeiReset;
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureZhenShanBeiUpdate;
...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockZhenShanBei.class */
public class BlockZhenShanBei extends ElementsYvanchuxiuzhenMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhen:zhen_shan_bei")
    public static final Block block = null;
    static Map<String, Object> $_dependencies = new HashMap();

    public BlockZhenShanBei(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 522);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("zhen_shan_bei");
        });
    ...
    public void init(FMLInitializationEvent event) {
        GameRegistry.registerTileEntity(TileEntityCustom.class, "yvanchuxiuzhen:tileentityzhen_shan_bei");
    }

    @Override // net.mcreator.yvanchuxiuzhen.ElementsYvanchuxiuzhenMod.ModElement
    @SideOnly(Side.CLIENT)
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yvanchuxiuzhen:zhen_shan_bei", "inventory"));
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockZhenShanBei$BlockCustom.class */
    public static class BlockCustom extends Block implements ITileEntityProvider {
        public static final PropertyDirection FACING = BlockHorizontal.field_185512_D;

        public BlockCustom() {
            super(Material.field_151576_e);
            func_149663_c("zhen_shan_bei");
        ...
        public void func_176213_c(World world, BlockPos pos, IBlockState state) {
            ...
            BlockZhenShanBei.$_dependencies.put("x", Integer.valueOf(x));
            BlockZhenShanBei.$_dependencies.put("y", Integer.valueOf(y));
            BlockZhenShanBei.$_dependencies.put("z", Integer.valueOf(z));
            BlockZhenShanBei.$_dependencies.put("world", world);
            ProcedureZhenShanBeiReset.executeProcedure(BlockZhenShanBei.$_dependencies);
        }
        ...
        public void func_180650_b(World world, BlockPos pos, IBlockState state, Random random) {
            ...
            BlockZhenShanBei.$_dependencies.put("z", Integer.valueOf(z));
            BlockZhenShanBei.$_dependencies.put("world", world);
            ProcedureZhenShanBeiUpdate.executeProcedure(BlockZhenShanBei.$_dependencies);
            world.func_175684_a(new BlockPos(x, y, z), this, func_149738_a(world));
        }
        ...
        public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction, float hitX, float hitY, float hitZ) {
            ...
            if (entity instanceof EntityPlayer) {
                entity.openGui(YvanchuxiuzhenMod.instance, GuiZhenShanBeiGui.GUIID, world, x, y, z);
            }
            BlockZhenShanBei.$_dependencies.put("entity", entity);
            BlockZhenShanBei.$_dependencies.put("x", Integer.valueOf(x));
            BlockZhenShanBei.$_dependencies.put("y", Integer.valueOf(y));
            BlockZhenShanBei.$_dependencies.put("z", Integer.valueOf(z));
            BlockZhenShanBei.$_dependencies.put("world", world);
            ProcedureZhenShanBeiBeRightClickDo.executeProcedure(BlockZhenShanBei.$_dependencies);
            return true;
        }
    }

    /* renamed from: net.mcreator.yvanchuxiuzhen.block.BlockZhenShanBei$1  reason: invalid class name */
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockZhenShanBei$1.class */
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockZhenShanBei$TileEntityCustom.class */
    public static class TileEntityCustom extends TileEntityLockableLoot {
        ...
        public String func_70005_c_() {
            return "container.zhen_shan_bei";
        }
        ...
        public String func_174875_k() {
            return "yvanchuxiuzhen:zhen_shan_bei";
        }

        public Container func_174876_a(InventoryPlayer playerInventory, EntityPlayer playerIn) {
            return new GuiZhenShanBeiGui.GuiContainerMod(func_145831_w(), func_174877_v().func_177958_n(), func_174877_v().func_177956_o(), func_174877_v().func_177952_p(), playerIn);
        }
