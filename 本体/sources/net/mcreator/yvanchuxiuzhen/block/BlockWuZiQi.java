...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockWuZiQi.class */
public class BlockWuZiQi extends ElementsYvanchuxiuzhenMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhen:wu_zi_qi")
    public static final Block block = null;
    static Map<String, Object> $_dependencies = new HashMap();

    public BlockWuZiQi(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 453);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("wu_zi_qi");
        });
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yvanchuxiuzhen:wu_zi_qi", "inventory"));
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockWuZiQi$BlockCustom.class */
    public static class BlockCustom extends Block {
        public static final PropertyDirection FACING = BlockHorizontal.field_185512_D;

        public BlockCustom() {
            super(Material.field_151575_d);
            func_149663_c("wu_zi_qi");
        ...
        public void func_180650_b(World world, BlockPos pos, IBlockState state, Random random) {
            ...
            int y = pos.func_177956_o();
            int z = pos.func_177952_p();
            BlockWuZiQi.$_dependencies.put("x", Integer.valueOf(x));
            BlockWuZiQi.$_dependencies.put("y", Integer.valueOf(y));
            BlockWuZiQi.$_dependencies.put("z", Integer.valueOf(z));
            BlockWuZiQi.$_dependencies.put("world", world);
            ProcedureHuiLingSu.executeProcedure(BlockWuZiQi.$_dependencies);
            world.func_175684_a(new BlockPos(x, y, z), this, func_149738_a(world));
        }
    }

    /* renamed from: net.mcreator.yvanchuxiuzhen.block.BlockWuZiQi$1  reason: invalid class name */
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/block/BlockWuZiQi$1.class */
