...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/procedure/ProcedureSectTokenBind.class */
public class ProcedureSectTokenBind extends ElementsYvanchuxiuzhenMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureSectTokenBind(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 526);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entityPlayer.getEntityData().func_74769_h("SectLevel") == 0.0d) {
            if ((entityPlayer instanceof EntityPlayer) && entityPlayer.field_71071_by.func_70431_c(new ItemStack(Item.func_111206_d("fabaokuozhan:caiitem04"), 1))) {
                ...
                (entityPlayer instanceof EntityLivingBase ? ((EntityLivingBase) entityPlayer).func_184614_ca() : ItemStack.field_190927_a).func_151001_c("§f" + entityPlayer.func_145748_c_().func_150260_c() + "的宗门令牌");
                ...
                _stack2.func_77978_p().func_74780_a("SectLevel", -1.0d);
                entityPlayer.getEntityData().func_74780_a("SectLevel", -1.0d);
                return;
            }
