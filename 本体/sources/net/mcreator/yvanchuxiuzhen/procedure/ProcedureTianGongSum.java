...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/procedure/ProcedureTianGongSum.class */
public class ProcedureTianGongSum extends ElementsYvanchuxiuzhenMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureTianGongSum(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 370);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!((World) worldServer).field_72995_K && (template8 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "tiangong1"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template7 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "tiangong2"))) != null) {
            BlockPos spawnTo2 = new BlockPos(x + 27, y, z);
        ...
        if (!((World) worldServer).field_72995_K && (template6 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "tiangong3"))) != null) {
            BlockPos spawnTo3 = new BlockPos(x, y, z - 23);
        ...
        if (!((World) worldServer).field_72995_K && (template5 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "tiangong4"))) != null) {
            BlockPos spawnTo4 = new BlockPos(x + 27, y, z - 23);
        ...
        if (!((World) worldServer).field_72995_K && (template4 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "tiangong5"))) != null) {
            BlockPos spawnTo5 = new BlockPos(x, y + 22, z);
        ...
        if (!((World) worldServer).field_72995_K && (template3 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "tiangong6"))) != null) {
            BlockPos spawnTo6 = new BlockPos(x + 27, y + 22, z);
        ...
        if (!((World) worldServer).field_72995_K && (template2 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "tiangong7"))) != null) {
            BlockPos spawnTo7 = new BlockPos(x, y + 22, z - 23);
        ...
        if (!((World) worldServer).field_72995_K && (template = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "tiangong8"))) != null) {
            BlockPos spawnTo8 = new BlockPos(x + 27, y + 22, z - 23);
