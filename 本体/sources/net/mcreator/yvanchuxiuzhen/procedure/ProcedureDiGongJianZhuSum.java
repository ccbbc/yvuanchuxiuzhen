...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/procedure/ProcedureDiGongJianZhuSum.class */
public class ProcedureDiGongJianZhuSum extends ElementsYvanchuxiuzhenMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureDiGongJianZhuSum(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 359);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!((World) worldServer).field_72995_K && (template15 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongjiao"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template14 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongmen"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template13 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongjiao"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template12 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongmen2"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template11 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongjiao"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template10 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongmen"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template9 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongjiao"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template8 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongmen2"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template7 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongzhongxin"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template6 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongting"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template5 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongting"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template4 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongting"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template3 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digongting"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template2 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "digong1"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "zhuozi"))) != null) {
            BlockPos spawnTo15 = new BlockPos(x + 51, y + 1, z - 12);
        ...
        if (!((World) worldServer).field_72995_K && worldServer.func_73046_m() != null) {
            worldServer.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuxiuzhen.procedure.ProcedureDiGongJianZhuSum.1
