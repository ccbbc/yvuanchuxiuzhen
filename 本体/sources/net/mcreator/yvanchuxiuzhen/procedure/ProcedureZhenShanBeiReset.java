...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/procedure/ProcedureZhenShanBeiReset.class */
public class ProcedureZhenShanBeiReset extends ElementsYvanchuxiuzhenMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureZhenShanBeiReset(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 552);
    }

    /* JADX WARN: Type inference failed for: r0v23, types: [net.mcreator.yvanchuxiuzhen.procedure.ProcedureZhenShanBeiReset$1] */
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!new Object() { // from class: net.mcreator.yvanchuxiuzhen.procedure.ProcedureZhenShanBeiReset.1
        ...
        }.getValue(new BlockPos(x, y, z), "Reset")) {
            if (!world.field_72995_K) {
                BlockPos _bp = new BlockPos(x, y, z);
                TileEntity _tileEntity = world.func_175625_s(_bp);
                IBlockState _bs = world.func_180495_p(_bp);
                if (_tileEntity != null) {
                    _tileEntity.getTileData().func_74778_a("SectJobName6", "宗主");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity2 != null) {
                    _tileEntity2.getTileData().func_74778_a("SectJobName5", "副宗主");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity3 != null) {
                    _tileEntity3.getTileData().func_74778_a("SectJobName4", "长老");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity4 != null) {
                    _tileEntity4.getTileData().func_74778_a("SectJobName3", "执事");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity5 != null) {
                    _tileEntity5.getTileData().func_74778_a("SectJobName2", "精英");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity6 != null) {
                    _tileEntity6.getTileData().func_74778_a("SectJobName1", "弟子");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity7 != null) {
                    _tileEntity7.getTileData().func_74778_a("SectLevelName", "寂寂无名");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity8 != null) {
                    _tileEntity8.getTileData().func_74778_a("SectLevelName1", "寂寂无名");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity9 != null) {
                    _tileEntity9.getTileData().func_74778_a("SectLevelName2", "初露峥嵘");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity10 != null) {
                    _tileEntity10.getTileData().func_74778_a("SectLevelName3", "名声日显");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity11 != null) {
                    _tileEntity11.getTileData().func_74778_a("SectLevelName4", "一方独尊");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity12 != null) {
                    _tileEntity12.getTileData().func_74778_a("SectLevelName5", "仙门正统");
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity13 != null) {
                    _tileEntity13.getTileData().func_74780_a("SectLevel", 1.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity14 != null) {
                    _tileEntity14.getTileData().func_74780_a("SectJobUpdate1", 1.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity15 != null) {
                    _tileEntity15.getTileData().func_74780_a("SectJobUpdate2", 1.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity16 != null) {
                    _tileEntity16.getTileData().func_74780_a("SectJobUpdate3", 1.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity17 != null) {
                    _tileEntity17.getTileData().func_74780_a("SectJobUpdate4", 1.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity18 != null) {
                    _tileEntity18.getTileData().func_74780_a("SectJobLevel", 6.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity19 != null) {
                    _tileEntity19.getTileData().func_74780_a("SectLimit", 5.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity20 != null) {
                    _tileEntity20.getTileData().func_74780_a("SectLimit1", 4.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity21 != null) {
                    _tileEntity21.getTileData().func_74780_a("SectLimit6", 1.0d);
                }
            ...
            if (!world.field_72995_K) {
                ...
                if (_tileEntity22 != null) {
                    _tileEntity22.getTileData().func_74757_a("Reset", true);
                }
