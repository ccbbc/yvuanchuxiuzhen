...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/item/ItemWeimian01.class */
public class ItemWeimian01 extends Item {
    @GameRegistry.ObjectHolder("yvanchuxiuzhen:weimian01")
    public static final Item block = null;

    public ItemWeimian01() {
    ...
    public EnumActionResult func_180614_a(EntityPlayer entity, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (world.func_175623_d(pos2)) {
            WorldWeimian01.portal.portalSpawn(world, pos2);
        }
