...
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureGDown;
...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingZhongShangButton.class */
public class KeyBindingZhongShangButton extends ElementsYvanchuxiuzhenMod.ModElement {
    private KeyBinding keys;
    static Map<String, Object> $_dependencies = new HashMap();

    public KeyBindingZhongShangButton(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 307);
    }
    ...
    public void init(FMLInitializationEvent event) {
        this.keys = new KeyBinding("key.mcreator.zhong_shang_button", 12, "key.categories.initial");
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingZhongShangButton$KeyBindingPressedMessageHandler.class */
    public static class KeyBindingPressedMessageHandler implements IMessageHandler<KeyBindingPressedMessage, IMessage> {
        public IMessage onMessage(KeyBindingPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                KeyBindingZhongShangButton.pressAction(entity);
            });
            return null;
        }
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingZhongShangButton$KeyBindingPressedMessage.class */
