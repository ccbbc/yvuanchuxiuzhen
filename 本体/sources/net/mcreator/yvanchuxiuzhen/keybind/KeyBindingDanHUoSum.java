...
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureDanHuoSumDown;
...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingDanHUoSum.class */
public class KeyBindingDanHUoSum extends ElementsYvanchuxiuzhenMod.ModElement {
    private KeyBinding keys;
    static Map<String, Object> $_dependencies = new HashMap();

    public KeyBindingDanHUoSum(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 325);
    }
    ...
    public void init(FMLInitializationEvent event) {
        this.keys = new KeyBinding("key.mcreator.dan_h_uo_sum", 21, "key.categories.initial");
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingDanHUoSum$KeyBindingPressedMessageHandler.class */
    public static class KeyBindingPressedMessageHandler implements IMessageHandler<KeyBindingPressedMessage, IMessage> {
        public IMessage onMessage(KeyBindingPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                KeyBindingDanHUoSum.pressAction(entity);
            });
            return null;
        }
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingDanHUoSum$KeyBindingPressedMessage.class */
    ...
    public static void pressAction(EntityPlayer entity) {
        ...
        ProcedureDanHuoSumDown.executeProcedure($_dependencies);
    }
}
