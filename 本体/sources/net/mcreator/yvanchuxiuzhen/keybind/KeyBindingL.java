...
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureLJingJie;
...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingL.class */
public class KeyBindingL extends ElementsYvanchuxiuzhenMod.ModElement {
    private KeyBinding keys;
    static Map<String, Object> $_dependencies = new HashMap();

    public KeyBindingL(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 350);
    }
    ...
    public void init(FMLInitializationEvent event) {
        this.keys = new KeyBinding("key.mcreator.l", 25, "key.categories.initial");
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingL$KeyBindingPressedMessageHandler.class */
    public static class KeyBindingPressedMessageHandler implements IMessageHandler<KeyBindingPressedMessage, IMessage> {
        public IMessage onMessage(KeyBindingPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                KeyBindingL.pressAction(entity);
            });
            return null;
        }
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingL$KeyBindingPressedMessage.class */
    ...
    public static void pressAction(EntityPlayer entity) {
        ...
        ProcedureLJingJie.executeProcedure($_dependencies);
    }
}
