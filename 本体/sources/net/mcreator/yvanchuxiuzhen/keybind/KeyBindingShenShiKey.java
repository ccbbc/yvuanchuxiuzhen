...
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureShenShiImplement;
...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingShenShiKey.class */
public class KeyBindingShenShiKey extends ElementsYvanchuxiuzhenMod.ModElement {
    private KeyBinding keys;
    static Map<String, Object> $_dependencies = new HashMap();

    public KeyBindingShenShiKey(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 489);
    }
    ...
    public void init(FMLInitializationEvent event) {
        this.keys = new KeyBinding("key.mcreator.shen_shi_key", 8, "key.categories.misc");
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingShenShiKey$KeyBindingPressedMessageHandler.class */
    public static class KeyBindingPressedMessageHandler implements IMessageHandler<KeyBindingPressedMessage, IMessage> {
        public IMessage onMessage(KeyBindingPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                KeyBindingShenShiKey.pressAction(entity);
            });
            return null;
        }
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/keybind/KeyBindingShenShiKey$KeyBindingPressedMessage.class */
    ...
    public static void pressAction(EntityPlayer entity) {
        ...
        ProcedureShenShiImplement.executeProcedure($_dependencies);
    }
}
