...
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureSectTokenBind;
import net.mcreator.yvanchuxiuzhen.procedure.ProcedureSectTokenUnBind;
...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/gui/GuiSectTokenGui.class */
public class GuiSectTokenGui extends ElementsYvanchuxiuzhenMod.ModElement {
    public static int GUIID = 9;
    public static HashMap guistate = new HashMap();
    static Map<String, Object> $_dependencies = new HashMap();

    public GuiSectTokenGui(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 520);
    }
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/gui/GuiSectTokenGui$GuiContainerMod.class */
    public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        */
        protected boolean func_75135_a(net.minecraft.item.ItemStack r5, int r6, int r7, boolean r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: net.mcreator.yvanchuxiuzhen.gui.GuiSectTokenGui.GuiContainerMod.func_75135_a(net.minecraft.item.ItemStack, int, int, boolean):boolean");
        }
        ...
        private void slotChanged(int slotid, int ctype, int meta) {
            if (this.world != null && this.world.field_72995_K) {
                ...
                GuiSectTokenGui.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
            }
        }
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/gui/GuiSectTokenGui$GuiWindow.class */
    public static class GuiWindow extends GuiContainer {
        ...
        private int z;
        private EntityPlayer entity;
        private static final ResourceLocation texture = new ResourceLocation("yvanchuxiuzhen:textures/sect_token_gui.png");
        ...
        protected void func_146979_b(int par1, int par2) {
            this.field_146289_q.func_78276_b("" + this.entity.getEntityData().func_74779_i("SxlGuiTip") + "", 67, 36, -12829636);
            this.field_146289_q.func_78276_b("§4§l背包内有精血即可绑定令牌", 25, 16, -12829636);
        }
        ...
        protected void func_146284_a(GuiButton button) {
            ...
            GuiSectTokenGui.handleButtonAction(this.entity, button.field_146127_k, this.x, this.y, this.z);
        }
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/gui/GuiSectTokenGui$GUIButtonPressedMessageHandler.class */
    public static class GUIButtonPressedMessageHandler implements IMessageHandler<GUIButtonPressedMessage, IMessage> {
        public IMessage onMessage(GUIButtonPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiSectTokenGui.handleButtonAction(entity, buttonID, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/gui/GuiSectTokenGui$GUISlotChangedMessageHandler.class */
    public static class GUISlotChangedMessageHandler implements IMessageHandler<GUISlotChangedMessage, IMessage> {
        public IMessage onMessage(GUISlotChangedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiSectTokenGui.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/gui/GuiSectTokenGui$GUIButtonPressedMessage.class */
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/gui/GuiSectTokenGui$GUISlotChangedMessage.class */
    ...
    public static void handleButtonAction(EntityPlayer entity, int buttonID, int x, int y, int z) {
        ...
        if (buttonID == 0) {
            ...
            ProcedureSectTokenUnBind.executeProcedure($_dependencies);
        }
        if (buttonID == 1) {
            $_dependencies.put("entity", entity);
            ProcedureSectTokenBind.executeProcedure($_dependencies);
        }
    }
