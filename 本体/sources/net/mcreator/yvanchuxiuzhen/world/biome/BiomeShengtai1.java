...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/world/biome/BiomeShengtai1.class */
public class BiomeShengtai1 extends ElementsYvanchuxiuzhenMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhen:shengtai1")
    public static final BiomeGenCustom biome = null;

    public BiomeShengtai1(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 209);
    }
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/world/biome/BiomeShengtai1$BiomeGenCustom.class */
    public static class BiomeGenCustom extends Biome {
        public BiomeGenCustom() {
            super(new Biome.BiomeProperties("云端之上").func_185395_b(0.5f).func_185398_c(0.0f).func_185400_d(0.2f).func_185410_a(0.5f));
            setRegistryName("shengtai1");
            this.field_76752_A = BlockFangkuai001.block.func_176223_P();
            this.field_76753_B = BlockFangkuai001.block.func_176223_P();
    ...
    /* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/world/biome/BiomeShengtai1$CustomTree.class */
    static class CustomTree extends WorldGenAbstractTree {
        ...
        public boolean func_180709_b(World world, Random rand, BlockPos position) {
            ...
            if (position.func_177956_o() >= 1 && position.func_177956_o() + height + 1 <= world.func_72800_K()) {
                ...
                if (ground == BlockFangkuai001.block.func_176223_P().func_177230_c() || ground == BlockFangkuai001.block.func_176223_P().func_177230_c()) {
                    if (ground2 != BlockFangkuai001.block.func_176223_P().func_177230_c() && ground2 != BlockFangkuai001.block.func_176223_P().func_177230_c()) {
                        return false;
                    }
                    world.func_180495_p(position.func_177977_b());
                    if (position.func_177956_o() < (world.func_72800_K() - height) - 1) {
                        world.func_180501_a(position.func_177977_b(), BlockFangkuai001.block.func_176223_P(), 2);
                        ...
                        for (int genh2 = 0; genh2 < height; genh2++) {
                            ...
                            if (state2.func_177230_c().isAir(state2, world, genhPos) || state2.func_177230_c() == Blocks.field_150350_a.func_176223_P().func_177230_c() || state2.func_177230_c() == Blocks.field_150350_a.func_176223_P().func_177230_c()) {
                                func_175903_a(world, position.func_177981_b(genh2), Blocks.field_150350_a.func_176223_P());
                                if (genh2 > 0) {
        ...
        protected boolean func_150523_a(Block blockType) {
            return blockType.func_176223_P().func_185904_a() == Material.field_151579_a || blockType == Blocks.field_150350_a.func_176223_P().func_177230_c() || blockType == Blocks.field_150350_a.func_176223_P().func_177230_c() || blockType == BlockFangkuai001.block.func_176223_P().func_177230_c() || blockType == BlockFangkuai001.block.func_176223_P().func_177230_c();
        }

        protected void func_175921_a(World world, BlockPos pos) {
            if (world.func_180495_p(pos).func_177230_c() != BlockFangkuai001.block.func_176223_P().func_177230_c()) {
                func_175903_a(world, pos, BlockFangkuai001.block.func_176223_P());
            }
        }
