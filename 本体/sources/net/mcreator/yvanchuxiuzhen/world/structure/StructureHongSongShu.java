...
/* loaded from: 本体-mc1.12.2-2.0.22.jar:net/mcreator/yvanchuxiuzhen/world/structure/StructureHongSongShu.class */
public class StructureHongSongShu extends ElementsYvanchuxiuzhenMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public StructureHongSongShu(ElementsYvanchuxiuzhenMod instance) {
        super(instance, 483);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 5000) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (blockCriteria) {
                    if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YvanchuxiuzhenMod.MODID, "hongsongshu"))) == null) {
                        return;
                    }
