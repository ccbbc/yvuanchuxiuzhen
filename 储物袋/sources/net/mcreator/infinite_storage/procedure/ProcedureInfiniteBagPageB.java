...
/* loaded from: 储物袋-mc1.12.2-2.0.0.jar:net/mcreator/infinite_storage/procedure/ProcedureInfiniteBagPageB.class */
public class ProcedureInfiniteBagPageB extends ElementsInfiniteStorageMod.ModElement {
    public ProcedureInfiniteBagPageB(ElementsInfiniteStorageMod instance) {
        super(instance, 24);
    }

    /* JADX WARN: Type inference failed for: r1v17, types: [net.mcreator.infinite_storage.procedure.ProcedureInfiniteBagPageB$1] */
    public static void executeProcedure(Map<String, Object> dependencies) {
        if (dependencies.get("entity") == null) {
            return;
        }
        final EntityPlayerMP entityPlayerMP = (Entity) dependencies.get("entity");
        if (entityPlayerMP.getEntityData().func_74769_h("InfiniteBagPage") < entityPlayerMP.getEntityData().func_74769_h("InfiniteBagPageAdd")) {
            ...
            if (entityPlayerMP instanceof EntityPlayer) {
                ...
                _scr.func_96647_c(new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureInfiniteBagPageB.1
