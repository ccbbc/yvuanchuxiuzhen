...
/* loaded from: 储物袋-mc1.12.2-2.0.0.jar:net/mcreator/infinite_storage/procedure/ProcedureBigBagGuiOpen.class */
public class ProcedureBigBagGuiOpen extends ElementsInfiniteStorageMod.ModElement {
    public ProcedureBigBagGuiOpen(ElementsInfiniteStorageMod instance) {
        super(instance, 14);
    }

    /* JADX WARN: Type inference failed for: r0v143, types: [net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen$8] */
    /* JADX WARN: Type inference failed for: r0v175, types: [net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen$5] */
    /* JADX WARN: Type inference failed for: r2v33, types: [net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen$6] */
    /* JADX WARN: Type inference failed for: r2v43, types: [net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen$4] */
    /* JADX WARN: Type inference failed for: r2v7, types: [net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen$1] */
    /* JADX WARN: Type inference failed for: r2v9, types: [net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen$2] */
    /* JADX WARN: Type inference failed for: r3v10, types: [net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen$7] */
    /* JADX WARN: Type inference failed for: r3v5, types: [net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen$3] */
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entityLivingBase.getEntityData().func_74769_h("ShenShi") >= 192.0d && entityLivingBase.getEntityData().func_74769_h("Power") >= 10.0d) {
            entityLivingBase.getEntityData().func_74780_a("Power", entityLivingBase.getEntityData().func_74769_h("Power") - 10.0d);
            if (!(entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_184592_cb() : ItemStack.field_190927_a).func_77973_b().getRegistryName().toString().contains("_bag")) {
                if (entityLivingBase instanceof EntityPlayer) {
                    ((EntityPlayer) entityLivingBase).openGui(InfiniteStorageMod.instance, GuiBigBagGui.GUIID, world, x, y, z);
                }
                ...
                if (!str.equals("")) {
                    ...
                    for (int index0 = 0; index0 < 54; index0++) {
                        ...
                        _stack2.func_77978_p().func_74778_a("ItemStackTemp", new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen.1
                            String string;
                            String[] value;
                            String indexvalue;
                        ...
                        _stack3.func_77978_p().func_74780_a("ItemStackNumTemp", new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen.2
                        ...
                        }.convert(new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen.3
                            String string;
                            String[] value;
                            String indexvalue;
                        ...
                        if (!str2.equals("")) {
                            ...
                            _stack4.func_77978_p().func_74778_a("ItemStackNbtTemp", new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen.4
                                String string;
                                String[] value;
                                String indexvalue;
                        ...
                        if (!str3.equals("-1")) {
                            ...
                            ?? r0 = new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen.5
                        ...
                        if (!str4.equals("")) {
                            ...
                            _stack6.func_77978_p().func_74780_a("ItemStackMetaTemp", new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen.6
                                int convert(String s) {
                                    try {
                                        return Integer.parseInt(s.trim());
                                    } catch (Exception e2) {
                            ...
                            }.convert(new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen.7
                                String string;
                                String[] value;
                                String indexvalue;
                            ...
                            if (d2 != 0.0d) {
                                ?? r02 = new Object() { // from class: net.mcreator.infinite_storage.procedure.ProcedureBigBagGuiOpen.8
                                    public ItemStack getItemStack(int sltid) {
                                        if (entityLivingBase instanceof EntityPlayerMP) {
                                            Supplier supplier2 = entityLivingBase.field_71070_bA;
                                            if (supplier2 instanceof Supplier) {
