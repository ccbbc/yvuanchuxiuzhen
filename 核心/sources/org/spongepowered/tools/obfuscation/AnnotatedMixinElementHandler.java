...
/* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/tools/obfuscation/AnnotatedMixinElementHandler.class */
public abstract class AnnotatedMixinElementHandler {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/tools/obfuscation/AnnotatedMixinElementHandler$AnnotatedElement.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/tools/obfuscation/AnnotatedMixinElementHandler$AliasedElementName.class */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/tools/obfuscation/AnnotatedMixinElementHandler$ShadowElementName.class */
    ...
    public final void checkConstraints(ExecutableElement method, AnnotationHandle annotation) {
        try {
            ...
            this.ap.printMessage(Diagnostic.Kind.WARNING, ex2.getMessage(), method, annotation.asMirror(), SuppressedBy.CONSTRAINTS);
        }
    }
        ...
        for (TypeHandle target : this.mixin.getTargets()) {
            if (!target.isImaginary()) {
                ...
                if (targetField == null) {
                    ...
                    if (targetField == null) {
                        this.ap.printMessage(Diagnostic.Kind.WARNING, "Cannot find target for " + type + " field in " + target, field, annotation.asMirror(), SuppressedBy.TARGET);
                    }
                }
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final void validateReferencedTarget(ExecutableElement method, AnnotationHandle inject, ITargetSelector reference, String type) {
        ...
        for (TypeHandle target : this.mixin.getTargets()) {
            if (!target.isImaginary()) {
                ...
                if (targetMethod == null) {
                    this.ap.printMessage(Diagnostic.Kind.WARNING, "Cannot find target method for " + type + " in " + target, method, inject.asMirror(), SuppressedBy.TARGET);
                }
            }
        }
    }
