...
/* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/tools/obfuscation/mapping/mcp/MappingWriterSrg.class */
public class MappingWriterSrg extends MappingWriter {
    ...
    public void write(String output, ObfuscationType type, IMappingConsumer.MappingSet<MappingField> fields, IMappingConsumer.MappingSet<MappingMethod> methods) {
        ...
        try {
            try {
                writer = openFileWriter(output, type);
                writeHeader(writer);
    ...
    protected PrintWriter openFileWriter(String output, ObfuscationType type) throws IOException {
        return openFileWriter(output, type + " output SRGs");
    }
