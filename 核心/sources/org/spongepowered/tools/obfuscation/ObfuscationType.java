...
/* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/tools/obfuscation/ObfuscationType.class */
public final class ObfuscationType {
    ...
    public boolean isDefault() {
        String defaultEnv = this.options.getOption(SupportedOptions.DEFAULT_OBFUSCATION_ENV, "searge").toLowerCase(Locale.ROOT);
