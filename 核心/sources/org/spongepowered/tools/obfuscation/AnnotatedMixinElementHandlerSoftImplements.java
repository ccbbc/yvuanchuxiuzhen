...
/* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/tools/obfuscation/AnnotatedMixinElementHandlerSoftImplements.class */
        ...
        for (AnnotationHandle interfaceAnnotation : interfaces) {
            ...
            if (remap != Interface.Remap.NONE) {
                try {
                    ...
                    this.ap.printMessage(Diagnostic.Kind.ERROR, (CharSequence) ("Unexpected error: " + ex.getClass().getName() + ": " + ex.getMessage()), (Element) this.mixin.getMixin(), interfaceAnnotation.asMirror());
                }
            }
        }
    }
