...
/* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/tools/obfuscation/validation/TargetValidator.class */
    ...
    private void validateInterfaceMixin(TypeElement mixin, Collection<TypeHandle> targets) {
        ...
        for (Element element : mixin.getEnclosedElements()) {
            if (element.getKind() == ElementKind.METHOD) {
                ...
                containsNonAccessorMethod |= (isAccessor || isInvoker) ? false : true;
            }
        }
