...
/* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/asm/mixin/injection/struct/InjectorGroupInfo.class */
public class InjectorGroupInfo {
    ...
    /* loaded from: 核心-mc1.12.2-0.0.2.jar:org/spongepowered/asm/mixin/injection/struct/InjectorGroupInfo$Map.class */
    ...
    public void setMinRequired(int min) {
        ...
        if (this.minCallbackCount > 0 && this.minCallbackCount != min) {
            LogManager.getLogger(MixinLaunchPlugin.NAME).warn("Conflicting min value '{}' on @Group({}), previously specified {}", new Object[]{Integer.valueOf(min), this.name, Integer.valueOf(this.minCallbackCount)});
        }
    ...
    public void setMaxAllowed(int max) {
        ...
        if (this.maxCallbackCount < Integer.MAX_VALUE && this.maxCallbackCount != max) {
            LogManager.getLogger(MixinLaunchPlugin.NAME).warn("Conflicting max value '{}' on @Group({}), previously specified {}", new Object[]{Integer.valueOf(max), this.name, Integer.valueOf(this.maxCallbackCount)});
        }
