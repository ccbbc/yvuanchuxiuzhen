...
/* loaded from: 练气三千年-mc1.12.2-1.1.2.jar:net/mcreator/lianqisanqiannian/LianqisanqiannianModVariables.class */
public class LianqisanqiannianModVariables {

    /* loaded from: 练气三千年-mc1.12.2-1.1.2.jar:net/mcreator/lianqisanqiannian/LianqisanqiannianModVariables$MapVariables.class */
    public static class MapVariables extends WorldSavedData {
        public static final String DATA_NAME = "lianqisanqiannian_mapvars";
        ...
        public void syncData(World world) {
            ...
            if (world.field_72995_K) {
                LianqisanqiannianMod.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(0, this));
            } else {
                LianqisanqiannianMod.PACKET_HANDLER.sendToAll(new WorldSavedDataSyncMessage(0, this));
            }
        }
    ...
    /* loaded from: 练气三千年-mc1.12.2-1.1.2.jar:net/mcreator/lianqisanqiannian/LianqisanqiannianModVariables$WorldVariables.class */
    public static class WorldVariables extends WorldSavedData {
        public static final String DATA_NAME = "lianqisanqiannian_worldvars";
        ...
        public void syncData(World world) {
            func_76185_a();
            if (world.field_72995_K) {
                LianqisanqiannianMod.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(1, this));
            } else {
                LianqisanqiannianMod.PACKET_HANDLER.sendToDimension(new WorldSavedDataSyncMessage(1, this), world.field_73011_w.getDimension());
            }
        }
    ...
    /* loaded from: 练气三千年-mc1.12.2-1.1.2.jar:net/mcreator/lianqisanqiannian/LianqisanqiannianModVariables$WorldSavedDataSyncMessageHandler.class */
    public static class WorldSavedDataSyncMessageHandler implements IMessageHandler<WorldSavedDataSyncMessage, IMessage> {
        ...
        private void syncData(WorldSavedDataSyncMessage message, MessageContext context, World world) {
            if (context.side == Side.SERVER) {
                ...
                if (message.type == 0) {
                    LianqisanqiannianMod.PACKET_HANDLER.sendToAll(message);
                } else {
                    LianqisanqiannianMod.PACKET_HANDLER.sendToDimension(message, world.field_73011_w.getDimension());
                }
            }
            if (message.type == 0) {
    ...
    /* loaded from: 练气三千年-mc1.12.2-1.1.2.jar:net/mcreator/lianqisanqiannian/LianqisanqiannianModVariables$WorldSavedDataSyncMessage.class */
