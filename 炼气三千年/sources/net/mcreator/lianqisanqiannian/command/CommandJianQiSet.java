...
import net.mcreator.lianqisanqiannian.procedure.ProcedureJianQiCmdDo;
...
/* loaded from: 练气三千年-mc1.12.2-1.1.2.jar:net/mcreator/lianqisanqiannian/command/CommandJianQiSet.class */
public class CommandJianQiSet extends ElementsLianqisanqiannianMod.ModElement {
    public CommandJianQiSet(ElementsLianqisanqiannianMod instance) {
        super(instance, 25);
    }
    ...
    /* loaded from: 练气三千年-mc1.12.2-1.1.2.jar:net/mcreator/lianqisanqiannian/command/CommandJianQiSet$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureJianQiCmdDo.executeProcedure($_dependencies);
            }
        }
    }
}
