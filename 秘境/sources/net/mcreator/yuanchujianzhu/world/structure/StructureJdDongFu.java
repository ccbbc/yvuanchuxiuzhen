...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/world/structure/StructureJdDongFu.class */
public class StructureJdDongFu extends ElementsYuanchujianzhuMod.ModElement {
    public StructureJdDongFu(ElementsYuanchujianzhuMod instance) {
        super(instance, 134);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 666) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (blockCriteria) {
                    if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "jddongfu"))) == null) {
                        return;
                    }
