...
import net.mcreator.yuanchujianzhu.procedure.ProcedureYuanYingDongFu;
...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/world/structure/StructureDongFu2.class */
public class StructureDongFu2 extends ElementsYuanchujianzhuMod.ModElement {
    public StructureDongFu2(ElementsYuanchujianzhuMod instance) {
        super(instance, 120);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 555) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (blockCriteria) {
                    if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "dongfu1"))) == null) {
                        return;
                    }
                    ...
                    ProcedureYuanYingDongFu.executeProcedure($_dependencies);
                }
            }
        }
    }
