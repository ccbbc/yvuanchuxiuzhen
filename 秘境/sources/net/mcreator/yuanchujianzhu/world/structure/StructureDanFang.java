...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/world/structure/StructureDanFang.class */
public class StructureDanFang extends ElementsYuanchujianzhuMod.ModElement {
    public StructureDanFang(ElementsYuanchujianzhuMod instance) {
        super(instance, 187);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 750) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (((ResourceLocation) Biome.field_185377_q.func_177774_c(biome)).equals(new ResourceLocation("mutated_plains"))) {
                    biomeCriteria = true;
                }
                if (biomeCriteria) {
                    if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "dan_fang"))) == null) {
                        return;
                    }
