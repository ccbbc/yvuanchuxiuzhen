...
import net.mcreator.yuanchujianzhu.procedure.ProcedureZhuJiDongFu;
...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/world/structure/StructureDongFu1.class */
public class StructureDongFu1 extends ElementsYuanchujianzhuMod.ModElement {
    public StructureDongFu1(ElementsYuanchujianzhuMod instance) {
        super(instance, 120);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 999) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (blockCriteria) {
                    ...
                    ProcedureZhuJiDongFu.executeProcedure($_dependencies);
                }
            }
        }
    }
