...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/world/structure/StructureLingQuan.class */
public class StructureLingQuan extends ElementsYuanchujianzhuMod.ModElement {
    public StructureLingQuan(ElementsYuanchujianzhuMod instance) {
        super(instance, 268);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 300) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                IBlockState require = Blocks.field_150350_a.func_176223_P();
                if (blockAt.func_177230_c() == require.func_177230_c()) {
                    blockCriteria = true;
                }
                if (blockCriteria) {
                    if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "ling_quan_2"))) == null) {
                        return;
                    }
