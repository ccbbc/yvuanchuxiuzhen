...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/world/structure/StructureLingShiMine.class */
public class StructureLingShiMine extends ElementsYuanchujianzhuMod.ModElement {
    public StructureLingShiMine(ElementsYuanchujianzhuMod instance) {
        super(instance, 264);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 500) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                int j = height - 1;
                if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "lingshikuangjing"))) == null) {
                    return;
                }
                Rotation rotation = Rotation.NONE;
                Mirror mirror = Mirror.NONE;
                BlockPos spawnTo = new BlockPos(i, j - 35, k);
