...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/procedure/ProcedureDongFuTiShi22.class */
public class ProcedureDongFuTiShi22 extends ElementsYuanchujianzhuMod.ModElement {
    public ProcedureDongFuTiShi22(ElementsYuanchujianzhuMod instance) {
        super(instance, 175);
    }
        ...
        if (!(entityPlayer instanceof EntityPlayer) || !entityPlayer.field_71071_by.func_70431_c(new ItemStack(Item.func_111206_d("yvanchuyaoshou:breaking_cone"), 1))) {
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") < 1.0d) {
                if (!((Entity) entityPlayer).field_70170_p.field_72995_K && ((Entity) entityPlayer).field_70170_p.func_73046_m() != null) {
                    ((Entity) entityPlayer).field_70170_p.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yuanchujianzhu.procedure.ProcedureDongFuTiShi22.1
                ...
                if (!((Entity) entityPlayer).field_70170_p.field_72995_K && ((Entity) entityPlayer).field_70170_p.func_73046_m() != null) {
                    ((Entity) entityPlayer).field_70170_p.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yuanchujianzhu.procedure.ProcedureDongFuTiShi22.2
                        public String func_70005_c_() {
                            return "";
                        }
            ...
            } else if (entityPlayer.getEntityData().func_74769_h("JingJieNum") < 3.0d && !((Entity) entityPlayer).field_70170_p.field_72995_K && ((Entity) entityPlayer).field_70170_p.func_73046_m() != null) {
                ((Entity) entityPlayer).field_70170_p.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yuanchujianzhu.procedure.ProcedureDongFuTiShi22.3
                    public String func_70005_c_() {
                        return "";
                    }
