...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/procedure/ProcedureYuanYingDongFu.class */
public class ProcedureYuanYingDongFu extends ElementsYuanchujianzhuMod.ModElement {
    public ProcedureYuanYingDongFu(ElementsYuanchujianzhuMod instance) {
        super(instance, 255);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!((World) worldServer).field_72995_K && (template3 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "dongfu202"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template2 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "dongfu3"))) != null) {
        ...
        if (!((World) worldServer).field_72995_K && (template = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "dongfu4"))) != null) {
