...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/procedure/ProcedureZhuJiDongFu.class */
public class ProcedureZhuJiDongFu extends ElementsYuanchujianzhuMod.ModElement {
    public ProcedureZhuJiDongFu(ElementsYuanchujianzhuMod instance) {
        super(instance, 254);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!((World) worldServer).field_72995_K && (template3 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "dongfu201"))) != null) {
