...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/procedure/ProcedureFormationLingshiCave22.class */
public class ProcedureFormationLingshiCave22 extends ElementsYuanchujianzhuMod.ModElement {
    public ProcedureFormationLingshiCave22(ElementsYuanchujianzhuMod instance) {
        super(instance, 261);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!((World) worldServer).field_72995_K && (template5 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YuanchujianzhuMod.MODID, "kuangjin06"))) != null) {
            BlockPos spawnTo = new BlockPos(x, y - 26, z);
