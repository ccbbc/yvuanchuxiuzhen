...
import net.mcreator.yuanchujianzhu.procedure.ProcedureYaoShouBaoXiang04Do;
...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockYaoShouBaoXiang04.class */
public class BlockYaoShouBaoXiang04 extends ElementsYuanchujianzhuMod.ModElement {
    @GameRegistry.ObjectHolder("yuanchujianzhu:yao_shou_bao_xiang_04")
    public static final Block block = null;

    public BlockYaoShouBaoXiang04(ElementsYuanchujianzhuMod instance) {
        super(instance, 166);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("yao_shou_bao_xiang_04");
        });
    ...
    public void init(FMLInitializationEvent event) {
        GameRegistry.registerTileEntity(TileEntityCustom.class, "yuanchujianzhu:tileentityyao_shou_bao_xiang_04");
    }

    @Override // net.mcreator.yuanchujianzhu.ElementsYuanchujianzhuMod.ModElement
    @SideOnly(Side.CLIENT)
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yuanchujianzhu:yao_shou_bao_xiang_04", "inventory"));
    }

    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockYaoShouBaoXiang04$BlockCustom.class */
    public static class BlockCustom extends Block implements ITileEntityProvider {
        public static final PropertyDirection FACING = BlockHorizontal.field_185512_D;

        public BlockCustom() {
            super(Material.field_151575_d);
            func_149663_c("yao_shou_bao_xiang_04");
        ...
        public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction, float hitX, float hitY, float hitZ) {
            ...
            ProcedureYaoShouBaoXiang04Do.executeProcedure($_dependencies);
            return true;
        }
    }

    /* renamed from: net.mcreator.yuanchujianzhu.block.BlockYaoShouBaoXiang04$1  reason: invalid class name */
    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockYaoShouBaoXiang04$1.class */
    ...
    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockYaoShouBaoXiang04$TileEntityCustom.class */
    public static class TileEntityCustom extends TileEntityLockableLoot {
        ...
        public String func_70005_c_() {
            return "container.yao_shou_bao_xiang_04";
        }
        ...
        public String func_174875_k() {
            return "yuanchujianzhu:yao_shou_bao_xiang_04";
        }
