...
import net.mcreator.yuanchujianzhu.procedure.ProcedureCangShuBaoXiangSet;
...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockCangShuBaoXiang.class */
public class BlockCangShuBaoXiang extends ElementsYuanchujianzhuMod.ModElement {
    @GameRegistry.ObjectHolder("yuanchujianzhu:cang_shu_bao_xiang")
    public static final Block block = null;

    public BlockCangShuBaoXiang(ElementsYuanchujianzhuMod instance) {
        super(instance, 229);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("cang_shu_bao_xiang");
        });
    ...
    public void init(FMLInitializationEvent event) {
        GameRegistry.registerTileEntity(TileEntityCustom.class, "yuanchujianzhu:tileentitycang_shu_bao_xiang");
    }

    @Override // net.mcreator.yuanchujianzhu.ElementsYuanchujianzhuMod.ModElement
    @SideOnly(Side.CLIENT)
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yuanchujianzhu:cang_shu_bao_xiang", "inventory"));
    }

    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockCangShuBaoXiang$BlockCustom.class */
    public static class BlockCustom extends Block implements ITileEntityProvider {
        public static final PropertyDirection FACING = BlockHorizontal.field_185512_D;

        public BlockCustom() {
            super(Material.field_151575_d);
            func_149663_c("cang_shu_bao_xiang");
        ...
        public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction, float hitX, float hitY, float hitZ) {
            ...
            ProcedureCangShuBaoXiangSet.executeProcedure($_dependencies);
            return true;
        }
    }

    /* renamed from: net.mcreator.yuanchujianzhu.block.BlockCangShuBaoXiang$1  reason: invalid class name */
    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockCangShuBaoXiang$1.class */
    ...
    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockCangShuBaoXiang$TileEntityCustom.class */
    public static class TileEntityCustom extends TileEntityLockableLoot {
        ...
        public String func_70005_c_() {
            return "container.cang_shu_bao_xiang";
        }
        ...
        public String func_174875_k() {
            return "yuanchujianzhu:cang_shu_bao_xiang";
        }
