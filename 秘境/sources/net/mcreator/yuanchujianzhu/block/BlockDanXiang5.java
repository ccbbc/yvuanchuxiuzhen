...
import net.mcreator.yuanchujianzhu.procedure.ProcedureDanXiangSet5;
...
/* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockDanXiang5.class */
public class BlockDanXiang5 extends ElementsYuanchujianzhuMod.ModElement {
    @GameRegistry.ObjectHolder("yuanchujianzhu:dan_xiang_5")
    public static final Block block = null;

    public BlockDanXiang5(ElementsYuanchujianzhuMod instance) {
        super(instance, 197);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("dan_xiang_5");
        });
    ...
    public void init(FMLInitializationEvent event) {
        GameRegistry.registerTileEntity(TileEntityCustom.class, "yuanchujianzhu:tileentitydan_xiang_5");
    }

    @Override // net.mcreator.yuanchujianzhu.ElementsYuanchujianzhuMod.ModElement
    @SideOnly(Side.CLIENT)
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yuanchujianzhu:dan_xiang_5", "inventory"));
    }

    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockDanXiang5$BlockCustom.class */
    public static class BlockCustom extends Block implements ITileEntityProvider {
        public static final PropertyDirection FACING = BlockHorizontal.field_185512_D;

        public BlockCustom() {
            super(Material.field_151575_d);
            func_149663_c("dan_xiang_5");
        ...
        public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction, float hitX, float hitY, float hitZ) {
            ...
            ProcedureDanXiangSet5.executeProcedure($_dependencies);
            return true;
        }
    }

    /* renamed from: net.mcreator.yuanchujianzhu.block.BlockDanXiang5$1  reason: invalid class name */
    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockDanXiang5$1.class */
    ...
    /* loaded from: 秘境-mc1.12.2-2.0.3.jar:net/mcreator/yuanchujianzhu/block/BlockDanXiang5$TileEntityCustom.class */
    public static class TileEntityCustom extends TileEntityLockableLoot {
        ...
        public String func_174875_k() {
            return "yuanchujianzhu:dan_xiang_5";
        }
