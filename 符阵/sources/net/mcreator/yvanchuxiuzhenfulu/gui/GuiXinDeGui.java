...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiXinDeGui.class */
public class GuiXinDeGui extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public static int GUIID = 21;
    public static HashMap guistate = new HashMap();

    public GuiXinDeGui(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 480);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiXinDeGui$GuiContainerMod.class */
    public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
            ...
            for (int si = 0; si < 3; si++) {
                for (int sj = 0; sj < 9; sj++) {
                    func_75146_a(new Slot(player.field_71071_by, sj + ((si + 1) * 9), 258 + (sj * 18), 334 + (si * 18)));
                }
            }
            for (int si2 = 0; si2 < 9; si2++) {
                func_75146_a(new Slot(player.field_71071_by, si2, 258 + (si2 * 18), 392));
            }
        }
        ...
        */
        protected boolean func_75135_a(net.minecraft.item.ItemStack r5, int r6, int r7, boolean r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: net.mcreator.yvanchuxiuzhenfulu.gui.GuiXinDeGui.GuiContainerMod.func_75135_a(net.minecraft.item.ItemStack, int, int, boolean):boolean");
        }
        ...
        private void slotChanged(int slotid, int ctype, int meta) {
            if (this.world != null && this.world.field_72995_K) {
                ...
                GuiXinDeGui.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
            }
        }
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiXinDeGui$GuiWindow.class */
    public static class GuiWindow extends GuiContainer {
        ...
        protected void func_146976_a(float par1, int par2, int par3) {
            ...
            this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("yvanchuxiuzhenfulu:textures/shu1.png"));
        ...
        protected void func_146284_a(GuiButton button) {
            ...
            GuiXinDeGui.handleButtonAction(this.entity, button.field_146127_k, this.x, this.y, this.z);
        }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiXinDeGui$GUIButtonPressedMessageHandler.class */
    public static class GUIButtonPressedMessageHandler implements IMessageHandler<GUIButtonPressedMessage, IMessage> {
        public IMessage onMessage(GUIButtonPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiXinDeGui.handleButtonAction(entity, buttonID, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiXinDeGui$GUISlotChangedMessageHandler.class */
    public static class GUISlotChangedMessageHandler implements IMessageHandler<GUISlotChangedMessage, IMessage> {
        public IMessage onMessage(GUISlotChangedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiXinDeGui.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiXinDeGui$GUIButtonPressedMessage.class */
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiXinDeGui$GUISlotChangedMessage.class */
    ...
    public static void handleButtonAction(EntityPlayer entity, int buttonID, int x, int y, int z) {
        ...
        if (world.func_175667_e(new BlockPos(x, y, z)) && buttonID == 0) {
            ...
            ProcedureXinDeGui60.executeProcedure($_dependencies);
        }
    }
