...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureShenJiBaiZhenOpen4;
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureShenJiBaiZhenOpen6;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiShenJiBaiZhenGUI2.class */
public class GuiShenJiBaiZhenGUI2 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public static int GUIID = 45;
    public static HashMap guistate = new HashMap();

    public GuiShenJiBaiZhenGUI2(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 605);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiShenJiBaiZhenGUI2$GuiContainerMod.class */
    public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        */
        protected boolean func_75135_a(net.minecraft.item.ItemStack r5, int r6, int r7, boolean r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: net.mcreator.yvanchuxiuzhenfulu.gui.GuiShenJiBaiZhenGUI2.GuiContainerMod.func_75135_a(net.minecraft.item.ItemStack, int, int, boolean):boolean");
        }
        ...
        private void slotChanged(int slotid, int ctype, int meta) {
            if (this.world != null && this.world.field_72995_K) {
                ...
                GuiShenJiBaiZhenGUI2.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
            }
        }
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiShenJiBaiZhenGUI2$GuiWindow.class */
    public static class GuiWindow extends GuiContainer {
        ...
        protected void func_146976_a(float par1, int par2, int par3) {
            ...
            this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("yvanchuxiuzhenfulu:textures/shen_ji_4.png"));
        ...
        protected void func_146284_a(GuiButton button) {
            ...
            GuiShenJiBaiZhenGUI2.handleButtonAction(this.entity, button.field_146127_k, this.x, this.y, this.z);
        }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiShenJiBaiZhenGUI2$GUIButtonPressedMessageHandler.class */
    public static class GUIButtonPressedMessageHandler implements IMessageHandler<GUIButtonPressedMessage, IMessage> {
        public IMessage onMessage(GUIButtonPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiShenJiBaiZhenGUI2.handleButtonAction(entity, buttonID, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiShenJiBaiZhenGUI2$GUISlotChangedMessageHandler.class */
    public static class GUISlotChangedMessageHandler implements IMessageHandler<GUISlotChangedMessage, IMessage> {
        public IMessage onMessage(GUISlotChangedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiShenJiBaiZhenGUI2.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiShenJiBaiZhenGUI2$GUIButtonPressedMessage.class */
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/gui/GuiShenJiBaiZhenGUI2$GUISlotChangedMessage.class */
    ...
    public static void handleButtonAction(EntityPlayer entity, int buttonID, int x, int y, int z) {
        ...
        if (buttonID == 0) {
            ...
            ProcedureShenJiBaiZhenOpen4.executeProcedure($_dependencies);
        }
        if (buttonID == 1) {
            ...
            ProcedureShenJiBaiZhenOpen6.executeProcedure($_dependencies2);
        }
    }
