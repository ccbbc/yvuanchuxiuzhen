...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureXueTaoMuCuiShu;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/block/BlockXueTaoMuMiao.class */
public class BlockXueTaoMuMiao extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:xue_tao_mu_miao")
    public static final Block block = null;

    public BlockXueTaoMuMiao(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 497);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("xue_tao_mu_miao");
        });
    ...
    public void init(FMLInitializationEvent event) {
        GameRegistry.registerTileEntity(TileEntityCustom.class, "yvanchuxiuzhenfulu:tileentityxue_tao_mu_miao");
    }

    @Override // net.mcreator.yvanchuxiuzhenfulu.ElementsYvanchuxiuzhenfuluMod.ModElement
    @SideOnly(Side.CLIENT)
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yvanchuxiuzhenfulu:xue_tao_mu_miao", "inventory"));
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/block/BlockXueTaoMuMiao$BlockCustom.class */
    public static class BlockCustom extends Block implements ITileEntityProvider {
        public static final PropertyDirection FACING = BlockHorizontal.field_185512_D;

        public BlockCustom() {
            super(Material.field_151585_k);
            func_149663_c("xue_tao_mu_miao");
        ...
        public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction, float hitX, float hitY, float hitZ) {
            ...
            ProcedureXueTaoMuCuiShu.executeProcedure($_dependencies);
            return true;
        }
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/block/BlockXueTaoMuMiao$TileEntityCustom.class */
    public static class TileEntityCustom extends TileEntityLockableLoot {
        ...
        public String func_70005_c_() {
            return "container.xue_tao_mu_miao";
        }
        ...
        public String func_174875_k() {
            return "yvanchuxiuzhenfulu:xue_tao_mu_miao";
        }
