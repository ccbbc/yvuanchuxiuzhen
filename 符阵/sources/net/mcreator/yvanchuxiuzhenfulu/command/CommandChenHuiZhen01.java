...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureChenHuiZhen02;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandChenHuiZhen01.class */
public class CommandChenHuiZhen01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandChenHuiZhen01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 364);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandChenHuiZhen01$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureChenHuiZhen02.executeProcedure($_dependencies);
            }
        }
    }
}
