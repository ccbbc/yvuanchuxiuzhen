...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureShanghaimDangMingLingBeiZhiXingShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghaim.class */
public class CommandShanghaim extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandShanghaim(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 307);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghaim$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghaimDangMingLingBeiZhiXingShi.executeProcedure($_dependencies);
            }
        }
    }
}
