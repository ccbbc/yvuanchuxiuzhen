...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureShanghaiCommandExecuted;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghai.class */
public class CommandShanghai extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandShanghai(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 125);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghai$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghaiCommandExecuted.executeProcedure($_dependencies);
            }
        }
    }
}
