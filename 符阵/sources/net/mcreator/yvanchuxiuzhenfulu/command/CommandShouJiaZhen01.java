...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureShouJiaZhen2;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShouJiaZhen01.class */
public class CommandShouJiaZhen01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandShouJiaZhen01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 435);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShouJiaZhen01$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShouJiaZhen2.executeProcedure($_dependencies);
            }
        }
    }
}
