...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureZhenFaShangHaiDangMingLingBeiZhiXingShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandZhenFaShangHai.class */
public class CommandZhenFaShangHai extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandZhenFaShangHai(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 507);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandZhenFaShangHai$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public String func_71517_b() {
            return "zhenfashanghai";
        }

        public String func_71518_a(ICommandSender var1) {
            return "/zhenfashanghai [<arguments>]";
        }
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureZhenFaShangHaiDangMingLingBeiZhiXingShi.executeProcedure($_dependencies);
            }
        }
    }
}
