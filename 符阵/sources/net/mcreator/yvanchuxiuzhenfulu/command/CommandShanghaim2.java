...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureShanghaim2ZhiXing;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghaim2.class */
public class CommandShanghaim2 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandShanghaim2(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 450);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghaim2$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghaim2ZhiXing.executeProcedure($_dependencies);
            }
        }
    }
}
