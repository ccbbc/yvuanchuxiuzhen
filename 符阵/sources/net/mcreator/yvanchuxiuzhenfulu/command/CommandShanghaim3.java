...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureShanghaim3ZhiXing;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghaim3.class */
public class CommandShanghaim3 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandShanghaim3(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 451);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghaim3$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghaim3ZhiXing.executeProcedure($_dependencies);
            }
        }
    }
}
