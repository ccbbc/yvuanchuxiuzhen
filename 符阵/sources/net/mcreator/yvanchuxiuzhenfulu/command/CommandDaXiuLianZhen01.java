...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureDaXiuLianZhen02;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandDaXiuLianZhen01.class */
public class CommandDaXiuLianZhen01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandDaXiuLianZhen01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 391);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandDaXiuLianZhen01$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public String func_71517_b() {
            return "daxiulianzhen";
        }

        public String func_71518_a(ICommandSender var1) {
            return "/daxiulianzhen [<arguments>]";
        }
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureDaXiuLianZhen02.executeProcedure($_dependencies);
            }
        }
    }
}
