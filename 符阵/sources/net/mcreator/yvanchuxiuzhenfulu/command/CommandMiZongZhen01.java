...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureMiZongZhen02;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandMiZongZhen01.class */
public class CommandMiZongZhen01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandMiZongZhen01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 373);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandMiZongZhen01$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureMiZongZhen02.executeProcedure($_dependencies);
            }
        }
    }
}
