...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureHuiLingZhen02;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandHuiLingZhen01.class */
public class CommandHuiLingZhen01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandHuiLingZhen01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 367);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandHuiLingZhen01$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureHuiLingZhen02.executeProcedure($_dependencies);
            }
        }
    }
}
