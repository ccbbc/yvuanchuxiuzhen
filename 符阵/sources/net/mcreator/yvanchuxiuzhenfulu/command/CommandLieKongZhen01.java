...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureLieKongZhen02;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandLieKongZhen01.class */
public class CommandLieKongZhen01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandLieKongZhen01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 362);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandLieKongZhen01$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureLieKongZhen02.executeProcedure($_dependencies);
            }
        }
    }
}
