...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureYuanchuDangMingLingBeiZhiXingShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandYuanchu.class */
public class CommandYuanchu extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandYuanchu(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 454);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandYuanchu$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureYuanchuDangMingLingBeiZhiXingShi.executeProcedure($_dependencies);
            }
        }
    }
}
