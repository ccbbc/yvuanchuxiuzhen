...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureZhenFaTp1;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandZhenFaTp.class */
public class CommandZhenFaTp extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandZhenFaTp(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 374);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandZhenFaTp$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public boolean func_184882_a(MinecraftServer server, ICommandSender var1) {
            return var1.func_70003_b(4, "zhenfatp");
        }
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureZhenFaTp1.executeProcedure($_dependencies);
            }
        }
    }
}
