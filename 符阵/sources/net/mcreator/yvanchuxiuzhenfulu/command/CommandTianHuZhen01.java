...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureTianHuZhen02;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandTianHuZhen01.class */
public class CommandTianHuZhen01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandTianHuZhen01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 372);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandTianHuZhen01$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureTianHuZhen02.executeProcedure($_dependencies);
            }
        }
    }
}
