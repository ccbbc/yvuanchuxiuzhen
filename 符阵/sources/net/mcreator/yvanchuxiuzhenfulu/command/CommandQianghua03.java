...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureQianghua03CommandExecuted;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandQianghua03.class */
public class CommandQianghua03 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandQianghua03(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 188);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandQianghua03$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureQianghua03CommandExecuted.executeProcedure($_dependencies);
            }
        }
    }
}
