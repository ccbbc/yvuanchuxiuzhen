...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureFuluXpDangMingLingBeiZhiXingShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandFuluXp.class */
public class CommandFuluXp extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandFuluXp(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 453);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandFuluXp$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureFuluXpDangMingLingBeiZhiXingShi.executeProcedure($_dependencies);
            }
        }
    }
}
