...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureXiuLianZhen02;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandXiuLianZhen01.class */
public class CommandXiuLianZhen01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandXiuLianZhen01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 378);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandXiuLianZhen01$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureXiuLianZhen02.executeProcedure($_dependencies);
            }
        }
    }
}
