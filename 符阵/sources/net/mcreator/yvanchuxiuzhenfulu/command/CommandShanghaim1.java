...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureShanghaim1ZhiXing;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghaim1.class */
public class CommandShanghaim1 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public CommandShanghaim1(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 446);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/command/CommandShanghaim1$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghaim1ZhiXing.executeProcedure($_dependencies);
            }
        }
    }
}
