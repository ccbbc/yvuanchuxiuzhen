...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/procedure/ProcedureDaXiuLianZhen0.class */
public class ProcedureDaXiuLianZhen0 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public ProcedureDaXiuLianZhen0(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 423);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!((World) worldServer).field_72995_K) {
            ...
            if (_tileEntity != null) {
                _tileEntity.getTileData().func_74780_a("阵法", 9.0d);
            }
