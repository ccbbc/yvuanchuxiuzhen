...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/procedure/ProcedureTaoShuMiaoCuiShu.class */
public class ProcedureTaoShuMiaoCuiShu extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public ProcedureTaoShuMiaoCuiShu(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 495);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (d > 0.0d) {
            if ((entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_184614_ca() : ItemStack.field_190927_a).func_77973_b().getRegistryName().toString().equals("yvanchuliandan:ling_ye") && worldServer.func_180495_p(new BlockPos(x, y, z)).func_177230_c() == BlockTaoShuMiao.block.func_176223_P().func_177230_c()) {
                ...
                if (!((World) worldServer).field_72995_K && (template2 = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "jiegoutaomu"))) != null) {
        ...
        if ((entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_184614_ca() : ItemStack.field_190927_a).func_77973_b().getRegistryName().toString().equals("yvanchuliandan:xiao_lv_ping") && worldServer.func_180495_p(new BlockPos(x, y, z)).func_177230_c() == BlockTaoShuMiao.block.func_176223_P().func_177230_c()) {
            if (worldServer instanceof WorldServer) {
                worldServer.func_175739_a(EnumParticleTypes.VILLAGER_HAPPY, x + 0.5d, y, z + 0.5d, 10, 0.5d, 0.5d, 0.5d, 0.0d, new int[0]);
            }
            if (!((World) worldServer).field_72995_K && (template = worldServer.func_184163_y().func_186237_a(worldServer.func_73046_m(), new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "jiegoutaomu"))) != null) {
