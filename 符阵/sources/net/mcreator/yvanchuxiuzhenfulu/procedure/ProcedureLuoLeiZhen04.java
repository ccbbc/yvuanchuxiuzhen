...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/procedure/ProcedureLuoLeiZhen04.class */
public class ProcedureLuoLeiZhen04 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public ProcedureLuoLeiZhen04(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 424);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!world.field_72995_K && world.func_73046_m() != null) {
            world.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureLuoLeiZhen04.1
            ...
            }, "summon yvanchuxiuzhenfulu:zhen_fa_sheng_ceng_01 ~ ~1 ~ {CustomName:\"1\",CustomNameVisible:0b}");
        }
        if (!world.field_72995_K && world.func_73046_m() != null) {
            world.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureLuoLeiZhen04.2
                public String func_70005_c_() {
                    return "";
                }
