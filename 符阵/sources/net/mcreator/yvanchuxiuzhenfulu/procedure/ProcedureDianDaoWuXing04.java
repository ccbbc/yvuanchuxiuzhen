...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/procedure/ProcedureDianDaoWuXing04.class */
public class ProcedureDianDaoWuXing04 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public ProcedureDianDaoWuXing04(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 560);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!world.field_72995_K && world.func_73046_m() != null) {
            world.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureDianDaoWuXing04.1
            ...
            }, "summon yvanchuxiuzhenfulu:zhen_fa_sheng_ceng_01 ~ ~1 ~ {CustomName:\"17\",CustomNameVisible:0b}");
        }
        if (!world.field_72995_K && world.func_73046_m() != null) {
            world.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureDianDaoWuXing04.2
                public String func_70005_c_() {
                    return "";
                }
