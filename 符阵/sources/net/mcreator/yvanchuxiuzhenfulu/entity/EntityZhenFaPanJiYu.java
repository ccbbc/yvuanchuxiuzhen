...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureZhenFaPanJiYuDangShiTiGengXinKeShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/entity/EntityZhenFaPanJiYu.class */
public class EntityZhenFaPanJiYu extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public static final int ENTITYID = 41;
    public static final int ENTITYID_RANGED = 42;

    public EntityZhenFaPanJiYu(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 433);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "zhen_fa_pan_ji_yu"), 41).name("zhen_fa_pan_ji_yu").tracker(64, 3, true).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new ModelChicken(), 0.5f) { // from class: net.mcreator.yvanchuxiuzhenfulu.entity.EntityZhenFaPanJiYu.1
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/entity/EntityZhenFaPanJiYu$EntityCustom.class */
    public static class EntityCustom extends EntityCreature {
        ...
        public void func_70030_z() {
            ...
            ProcedureZhenFaPanJiYuDangShiTiGengXinKeShi.executeProcedure($_dependencies);
        }
