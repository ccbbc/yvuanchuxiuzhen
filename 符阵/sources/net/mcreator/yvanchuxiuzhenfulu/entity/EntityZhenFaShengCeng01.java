...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureZhenFaShengCeng01DangShiTiGengXinKeShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/entity/EntityZhenFaShengCeng01.class */
public class EntityZhenFaShengCeng01 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public static final int ENTITYID = 39;
    public static final int ENTITYID_RANGED = 40;

    public EntityZhenFaShengCeng01(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 412);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "zhen_fa_sheng_ceng_01"), 39).name("zhen_fa_sheng_ceng_01").tracker(64, 3, true).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new ModelChicken(), 0.5f) { // from class: net.mcreator.yvanchuxiuzhenfulu.entity.EntityZhenFaShengCeng01.1
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/entity/EntityZhenFaShengCeng01$EntityCustom.class */
    public static class EntityCustom extends EntityCreature {
        ...
        public void func_70030_z() {
            ...
            ProcedureZhenFaShengCeng01DangShiTiGengXinKeShi.executeProcedure($_dependencies);
        }
