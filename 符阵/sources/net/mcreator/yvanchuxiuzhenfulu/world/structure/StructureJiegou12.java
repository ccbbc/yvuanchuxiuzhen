...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/world/structure/StructureJiegou12.class */
public class StructureJiegou12 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public StructureJiegou12(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 165);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 80000) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (blockCriteria) {
                    ...
                    if (!biomeCriteria) {
                        continue;
                    } else if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "jiegou12"))) == null) {
                        return;
                    } else {
