package net.mcreator.yvanchuxiuzhenfulu.world.structure;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/world/structure/StructureJiegou05.class */
public class StructureJiegou05 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    public StructureJiegou05(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 163);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 6000) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (blockCriteria) {
                    ...
                    if (((ResourceLocation) Biome.field_185377_q.func_177774_c(biome)).equals(new ResourceLocation("yvanchuxiuzhenfulu:shengtai16"))) {
                        biomeCriteria = true;
                    }
                    if (((ResourceLocation) Biome.field_185377_q.func_177774_c(biome)).equals(new ResourceLocation("yvanchuxiuzhenfulu:shengtai23"))) {
                        biomeCriteria = true;
                    }
                    if (!biomeCriteria) {
                        continue;
                    } else if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "jiegou05"))) == null) {
                        return;
                    } else {
