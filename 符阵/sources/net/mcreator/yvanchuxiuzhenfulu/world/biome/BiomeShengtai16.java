package net.mcreator.yvanchuxiuzhenfulu.world.biome;
...
import net.mcreator.yvanchuxiuzhenfulu.block.BlockFangkuai10202;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/world/biome/BiomeShengtai16.class */
public class BiomeShengtai16 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:shengtai16")
    public static final BiomeGenCustom biome = null;

    public BiomeShengtai16(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 160);
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/world/biome/BiomeShengtai16$BiomeGenCustom.class */
    public static class BiomeGenCustom extends Biome {
        public BiomeGenCustom() {
            super(new Biome.BiomeProperties("Shengtai 1 6").func_185395_b(0.5f).func_185398_c(0.1f).func_185402_a(-16724890).func_185400_d(0.2f).func_185410_a(0.5f));
            setRegistryName("shengtai16");
            this.field_76752_A = Blocks.field_150349_c.func_176223_P();
            this.field_76753_B = BlockFangkuai101.block.func_176223_P();
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/world/biome/BiomeShengtai16$CustomTree.class */
    static class CustomTree extends WorldGenAbstractTree {
        ...
        public boolean func_180709_b(World world, Random rand, BlockPos position) {
            ...
            if (position.func_177956_o() >= 1 && position.func_177956_o() + height + 1 <= world.func_72800_K()) {
                ...
                if (ground == Blocks.field_150349_c.func_176223_P().func_177230_c() || ground == BlockFangkuai101.block.func_176223_P().func_177230_c()) {
                    if (ground2 != Blocks.field_150349_c.func_176223_P().func_177230_c() && ground2 != BlockFangkuai101.block.func_176223_P().func_177230_c()) {
                        return false;
                    }
                    world.func_180495_p(position.func_177977_b());
                    if (position.func_177956_o() < (world.func_72800_K() - height) - 1) {
                        world.func_180501_a(position.func_177977_b(), BlockFangkuai101.block.func_176223_P(), 2);
                            ...
                            for (int k1 = position.func_177958_n() - j1; k1 <= position.func_177958_n() + j1; k1++) {
                                for (int i2 = position.func_177952_p() - j1; i2 <= position.func_177952_p() + j1; i2++) {
                                    ...
                                    if (Math.abs(position.func_177958_n()) != j1 || Math.abs(j2) != j1 || (rand.nextInt(2) != 0 && i4 != 0)) {
                                        ...
                                        if (state.func_177230_c().isAir(state, world, blockpos) || state.func_177230_c().isLeaves(state, world, blockpos) || state.func_177230_c() == Blocks.field_150350_a.func_176223_P().func_177230_c() || state.func_177230_c() == BlockFangkuai10202.block.func_176223_P().func_177230_c()) {
                                            func_175903_a(world, blockpos, BlockFangkuai10202.block.func_176223_P());
                                        }
                                    }
                                }
                            }
                        ...
                        for (int genh2 = 0; genh2 < height; genh2++) {
                            ...
                            if (state2.func_177230_c().isAir(state2, world, genhPos) || state2.func_177230_c() == Blocks.field_150350_a.func_176223_P().func_177230_c() || state2.func_177230_c() == BlockFangkuai10202.block.func_176223_P().func_177230_c()) {
                                func_175903_a(world, position.func_177981_b(genh2), BlockFangkuai10201.block.func_176223_P());
                                if (genh2 > 0) {
                        ...
                        for (int genh3 = (position.func_177956_o() - 3) + height; genh3 <= position.func_177956_o() + height; genh3++) {
                            ...
                            for (int genx = position.func_177958_n() - k4; genx <= position.func_177958_n() + k4; genx++) {
                                for (int genz = position.func_177952_p() - k4; genz <= position.func_177952_p() + k4; genz++) {
                                    ...
                                    if (state3.func_177230_c().isLeaves(state3, world, bpos) || state3.func_177230_c() == BlockFangkuai10202.block.func_176223_P().func_177230_c()) {
        ...
        protected boolean func_150523_a(Block blockType) {
            return blockType.func_176223_P().func_185904_a() == Material.field_151579_a || blockType == BlockFangkuai10201.block.func_176223_P().func_177230_c() || blockType == BlockFangkuai10202.block.func_176223_P().func_177230_c() || blockType == Blocks.field_150349_c.func_176223_P().func_177230_c() || blockType == BlockFangkuai101.block.func_176223_P().func_177230_c();
        }

        protected void func_175921_a(World world, BlockPos pos) {
            if (world.func_180495_p(pos).func_177230_c() != BlockFangkuai101.block.func_176223_P().func_177230_c()) {
                func_175903_a(world, pos, BlockFangkuai101.block.func_176223_P());
            }
        }
