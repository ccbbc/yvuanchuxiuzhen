...
@Mod(modid = YvanchuxiuzhenfuluMod.MODID, version = YvanchuxiuzhenfuluMod.VERSION)
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/YvanchuxiuzhenfuluMod.class */
public class YvanchuxiuzhenfuluMod {
    public static final String MODID = "yvanchuxiuzhenfulu";
    public static final String VERSION = "1.8.2";
    public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("yvanchuxiuzhenfulu:a");
    @SidedProxy(clientSide = "net.mcreator.yvanchuxiuzhenfulu.ClientProxyYvanchuxiuzhenfuluMod", serverSide = "net.mcreator.yvanchuxiuzhenfulu.ServerProxyYvanchuxiuzhenfuluMod")
    public static IProxyYvanchuxiuzhenfuluMod proxy;
    @Mod.Instance(MODID)
    public static YvanchuxiuzhenfuluMod instance;
    public ElementsYvanchuxiuzhenfuluMod elements = new ElementsYvanchuxiuzhenfuluMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsYvanchuxiuzhenfuluMod.GuiHandler());
