...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureHanDiFuBaoXiaoGuo;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHanDiFuBao.class */
public class ItemHanDiFuBao extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:han_di_fu_bao")
    public static final Item block = null;
    public static final int ENTITYID = 26;

    public ItemHanDiFuBao(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 26);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "entitybullethan_di_fu_bao"), 26).name("entitybullethan_di_fu_bao").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("yvanchuxiuzhenfulu:han_di_fu_bao", "inventory"));
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHanDiFuBao$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(0);
            func_77664_n();
            func_77655_b("han_di_fu_bao");
            setRegistryName("han_di_fu_bao");
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHanDiFuBao$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureHanDiFuBaoXiaoGuo.executeProcedure($_dependencies);
        }
