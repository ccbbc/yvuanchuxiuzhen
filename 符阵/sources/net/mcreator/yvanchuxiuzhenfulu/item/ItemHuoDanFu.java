...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureHuoDanFuXiaoGuo;
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureHuoQiuLiZI;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHuoDanFu.class */
public class ItemHuoDanFu extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:huo_dan_fu")
    public static final Item block = null;
    public static final int ENTITYID = 20;

    public ItemHuoDanFu(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 5);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "entitybullethuo_dan_fu"), 20).name("entitybullethuo_dan_fu").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("yvanchuxiuzhenfulu:huo_dan_fu", "inventory"));
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
            return new RenderSnowball(renderManager, new ItemStack(Blocks.field_150480_ab, 1).func_77973_b(), Minecraft.func_71410_x().func_175599_af());
        });
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHuoDanFu$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(0);
            func_77664_n();
            func_77655_b("huo_dan_fu");
            setRegistryName("huo_dan_fu");
            ...
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                while (true) {
                    if (i < entity.field_71071_by.field_70462_a.size()) {
                        ...
                        if (stack == null || stack.func_77973_b() != new ItemStack(ItemHuoDanFu.block, 1).func_77973_b() || stack.func_77960_j() != new ItemStack(ItemHuoDanFu.block, 1).func_77960_j()) {
                            i++;
                        } else {
                            slotID = i;
                            break;
                ...
                if (entity.field_71075_bZ.field_75098_d || EnchantmentHelper.func_77506_a(Enchantments.field_185312_x, itemstack) > 0 || slotID != -1) {
                    ...
                    if (entity.field_71075_bZ.field_75098_d) {
                    ...
                    } else if (new ItemStack(ItemHuoDanFu.block, 1).func_77984_f()) {
                        ...
                        entity.field_71071_by.func_174925_a(new ItemStack(ItemHuoDanFu.block, 1).func_77973_b(), -1, 1, (NBTTagCompound) null);
                    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHuoDanFu$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureHuoDanFuXiaoGuo.executeProcedure($_dependencies);
        }
        ...
        public void func_70071_h_() {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureHuoQiuLiZI.executeProcedure($_dependencies);
            if (this.field_70254_i) {
                ...
                ProcedureHuoDanFuXiaoGuo.executeProcedure($_dependencies2);
