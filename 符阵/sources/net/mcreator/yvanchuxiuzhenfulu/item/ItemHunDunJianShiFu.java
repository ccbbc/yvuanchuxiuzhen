...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureHunDunJianShiFuDangZiDanJiZhongFangKuaiShi;
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureHunDunJianShiFuDangZiDanJiZhongShengCunShiTiShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHunDunJianShiFu.class */
public class ItemHunDunJianShiFu extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:hun_dun_jian_shi_fu")
    public static final Item block = null;
    public static final int ENTITYID = 28;

    public ItemHunDunJianShiFu(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 27);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "entitybullethun_dun_jian_shi_fu"), 28).name("entitybullethun_dun_jian_shi_fu").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("yvanchuxiuzhenfulu:hun_dun_jian_shi_fu", "inventory"));
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
            return new RenderSnowball(renderManager, new ItemStack(ItemFeiJianFu.block, 1).func_77973_b(), Minecraft.func_71410_x().func_175599_af());
        });
    }

    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHunDunJianShiFu$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(0);
            func_77664_n();
            func_77655_b("hun_dun_jian_shi_fu");
            setRegistryName("hun_dun_jian_shi_fu");
            ...
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                while (true) {
                    if (i < entity.field_71071_by.field_70462_a.size()) {
                        ...
                        if (stack == null || stack.func_77973_b() != new ItemStack(ItemHunDunJianShiFu.block, 1).func_77973_b() || stack.func_77960_j() != new ItemStack(ItemHunDunJianShiFu.block, 1).func_77960_j()) {
                            i++;
                        } else {
                            slotID = i;
                            break;
                ...
                if (entity.field_71075_bZ.field_75098_d || EnchantmentHelper.func_77506_a(Enchantments.field_185312_x, itemstack) > 0 || slotID != -1) {
                    ...
                    if (entity.field_71075_bZ.field_75098_d) {
                    ...
                    } else if (new ItemStack(ItemHunDunJianShiFu.block, 1).func_77984_f()) {
                        ...
                        entity.field_71071_by.func_174925_a(new ItemStack(ItemHunDunJianShiFu.block, 1).func_77973_b(), -1, 1, (NBTTagCompound) null);
                    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemHunDunJianShiFu$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            Map<String, Object> $_dependencies = new HashMap<>();
            $_dependencies.put("entity", entity);
            ProcedureHunDunJianShiFuDangZiDanJiZhongShengCunShiTiShi.executeProcedure($_dependencies);
        }
        ...
        public void func_70071_h_() {
            ...
            if (this.field_70254_i) {
                ...
                $_dependencies.put("z", Integer.valueOf(z));
                $_dependencies.put("world", world);
                ProcedureHunDunJianShiFuDangZiDanJiZhongFangKuaiShi.executeProcedure($_dependencies);
