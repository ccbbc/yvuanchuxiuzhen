...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureRanshanFuXiaoGuo;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemRanShanFu.class */
public class ItemRanShanFu extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:ran_shan_fu")
    public static final Item block = null;
    public static final int ENTITYID = 23;

    public ItemRanShanFu(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 19);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "entitybulletran_shan_fu"), 23).name("entitybulletran_shan_fu").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("yvanchuxiuzhenfulu:ran_shan_fu", "inventory"));
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemRanShanFu$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(0);
            func_77664_n();
            func_77655_b("ran_shan_fu");
            setRegistryName("ran_shan_fu");
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemRanShanFu$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureRanshanFuXiaoGuo.executeProcedure($_dependencies);
        }
        ...
        public void func_70071_h_() {
            ...
            if (this.field_70254_i) {
                ...
                ProcedureRanshanFuXiaoGuo.executeProcedure($_dependencies2);
