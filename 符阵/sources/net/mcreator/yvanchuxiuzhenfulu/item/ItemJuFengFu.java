...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureJuFengFuDangZiDanJiZhongFangKuaiShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemJuFengFu.class */
public class ItemJuFengFu extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:ju_feng_fu")
    public static final Item block = null;
    public static final int ENTITYID = 22;

    public ItemJuFengFu(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 15);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "entitybulletju_feng_fu"), 22).name("entitybulletju_feng_fu").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("yvanchuxiuzhenfulu:ju_feng_fu", "inventory"));
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemJuFengFu$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(0);
            func_77664_n();
            func_77655_b("ju_feng_fu");
            setRegistryName("ju_feng_fu");
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemJuFengFu$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureJuFengFuDangZiDanJiZhongFangKuaiShi.executeProcedure($_dependencies);
        }
