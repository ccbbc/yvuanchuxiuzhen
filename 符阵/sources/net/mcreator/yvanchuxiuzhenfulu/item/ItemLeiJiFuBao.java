...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureLeiJiFuBaoDangZiDanJiZhongFangKuaiShi;
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureLeiJiFuBaoDangZiDanJiZhongShengCunShiTiShi;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemLeiJiFuBao.class */
public class ItemLeiJiFuBao extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:lei_ji_fu_bao")
    public static final Item block = null;
    public static final int ENTITYID = 25;

    public ItemLeiJiFuBao(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 24);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "entitybulletlei_ji_fu_bao"), 25).name("entitybulletlei_ji_fu_bao").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("yvanchuxiuzhenfulu:lei_ji_fu_bao", "inventory"));
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemLeiJiFuBao$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(0);
            func_77664_n();
            func_77655_b("lei_ji_fu_bao");
            setRegistryName("lei_ji_fu_bao");
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemLeiJiFuBao$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            Map<String, Object> $_dependencies = new HashMap<>();
            $_dependencies.put("entity", entity);
            ProcedureLeiJiFuBaoDangZiDanJiZhongShengCunShiTiShi.executeProcedure($_dependencies);
        }
        ...
        public void func_70071_h_() {
            ...
            if (this.field_70254_i) {
                Map<String, Object> $_dependencies = new HashMap<>();
                ProcedureLeiJiFuBaoDangZiDanJiZhongFangKuaiShi.executeProcedure($_dependencies);
