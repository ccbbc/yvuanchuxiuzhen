...
import net.mcreator.yvanchuxiuzhenfulu.procedure.ProcedureFulu05BulletHitsBlock;
...
/* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemFulu05.class */
public class ItemFulu05 extends ElementsYvanchuxiuzhenfuluMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuxiuzhenfulu:fulu05")
    public static final Item block = null;
    public static final int ENTITYID = 4;

    public ItemFulu05(ElementsYvanchuxiuzhenfuluMod instance) {
        super(instance, 7);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(YvanchuxiuzhenfuluMod.MODID, "entitybulletfulu05"), 4).name("entitybulletfulu05").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("yvanchuxiuzhenfulu:fulu05", "inventory"));
    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemFulu05$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(0);
            func_77664_n();
            func_77655_b("fulu05");
            setRegistryName("fulu05");
            ...
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                while (true) {
                    if (i < entity.field_71071_by.field_70462_a.size()) {
                        ...
                        if (stack == null || stack.func_77973_b() != new ItemStack(ItemFulu05.block, 1).func_77973_b() || stack.func_77960_j() != new ItemStack(ItemFulu05.block, 1).func_77960_j()) {
                            i++;
                        } else {
                            slotID = i;
                            break;
                ...
                if (entity.field_71075_bZ.field_75098_d || EnchantmentHelper.func_77506_a(Enchantments.field_185312_x, itemstack) > 0 || slotID != -1) {
                    ...
                    if (entity.field_71075_bZ.field_75098_d) {
                    ...
                    } else if (new ItemStack(ItemFulu05.block, 1).func_77984_f()) {
                        ...
                        entity.field_71071_by.func_174925_a(new ItemStack(ItemFulu05.block, 1).func_77973_b(), -1, 1, (NBTTagCompound) null);
                    }
    ...
    /* loaded from: 符阵-mc1.12.2-2.0.11.jar:net/mcreator/yvanchuxiuzhenfulu/item/ItemFulu05$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureFulu05BulletHitsBlock.executeProcedure($_dependencies);
        }
