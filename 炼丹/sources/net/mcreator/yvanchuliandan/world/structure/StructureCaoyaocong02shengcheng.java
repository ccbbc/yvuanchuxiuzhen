...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/world/structure/StructureCaoyaocong02shengcheng.class */
public class StructureCaoyaocong02shengcheng extends ElementsYvanchuliandanMod.ModElement {
    public StructureCaoyaocong02shengcheng(ElementsYvanchuliandanMod instance) {
        super(instance, 295);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 20000) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (blockCriteria) {
                    if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YvanchuliandanMod.MODID, "caoyao03"))) == null) {
                        return;
                    }
