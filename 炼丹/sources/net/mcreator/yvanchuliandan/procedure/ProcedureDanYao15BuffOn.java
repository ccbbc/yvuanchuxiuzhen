...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/procedure/ProcedureDanYao15BuffOn.class */
public class ProcedureDanYao15BuffOn extends ElementsYvanchuliandanMod.ModElement {
    public ProcedureDanYao15BuffOn(ElementsYvanchuliandanMod instance) {
        super(instance, 323);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entity.getEntityData().func_74767_n("YaoDan15Buff")) {
            ...
            entity.getEntityData().func_74757_a("YaoDan15Buff", true);
        }
    }
}
