...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/procedure/ProcedureDanYaoRightClickDo13.class */
public class ProcedureDanYaoRightClickDo13 extends ElementsYvanchuliandanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureDanYaoRightClickDo13(ElementsYvanchuliandanMod instance) {
        super(instance, 317);
    }

    /* JADX WARN: Type inference failed for: r1v13, types: [net.mcreator.yvanchuliandan.procedure.ProcedureDanYaoRightClickDo13$1] */
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        entityPlayer.getEntityData().func_74778_a("永久增加丹药名暂存", "danyao13");
        if (ProcedureShuXingWuXiao.executeProcedure(ImmutableMap.of("entity", entityPlayer))) {
            ...
            if (entityPlayer instanceof EntityPlayer) {
                ...
                _scr.func_96647_c(new Object() { // from class: net.mcreator.yvanchuliandan.procedure.ProcedureDanYaoRightClickDo13.1
