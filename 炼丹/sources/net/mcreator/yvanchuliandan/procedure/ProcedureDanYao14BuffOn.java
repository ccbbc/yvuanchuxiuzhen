...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/procedure/ProcedureDanYao14BuffOn.class */
public class ProcedureDanYao14BuffOn extends ElementsYvanchuliandanMod.ModElement {
    public ProcedureDanYao14BuffOn(ElementsYvanchuliandanMod instance) {
        super(instance, 319);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entity.getEntityData().func_74767_n("YaoDan14Buff")) {
            ...
            entity.getEntityData().func_74757_a("YaoDan14Buff", true);
        }
    }
}
