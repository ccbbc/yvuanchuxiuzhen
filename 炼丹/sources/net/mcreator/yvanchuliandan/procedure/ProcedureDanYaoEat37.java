...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/procedure/ProcedureDanYaoEat37.class */
public class ProcedureDanYaoEat37 extends ElementsYvanchuliandanMod.ModElement {
    public ProcedureDanYaoEat37(ElementsYvanchuliandanMod instance) {
        super(instance, 370);
    }

    /* JADX WARN: Type inference failed for: r1v13, types: [net.mcreator.yvanchuliandan.procedure.ProcedureDanYaoEat37$1] */
    public static void executeProcedure(Map<String, Object> dependencies) {
        if (dependencies.get("entity") == null) {
            return;
        }
        final EntityPlayer entityPlayer = (Entity) dependencies.get("entity");
        entityPlayer.getEntityData().func_74780_a("永久增加丹药暂存", 160.0d);
        entityPlayer.getEntityData().func_74778_a("永久增加丹药名暂存", "danyao37");
        if (ProcedureShuXingWuXiao.executeProcedure(ImmutableMap.of("entity", entityPlayer))) {
            ...
            if (entityPlayer instanceof EntityPlayer) {
                ...
                _scr.func_96647_c(new Object() { // from class: net.mcreator.yvanchuliandan.procedure.ProcedureDanYaoEat37.1
