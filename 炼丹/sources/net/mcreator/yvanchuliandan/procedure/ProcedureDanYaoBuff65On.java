...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/procedure/ProcedureDanYaoBuff65On.class */
public class ProcedureDanYaoBuff65On extends ElementsYvanchuliandanMod.ModElement {
    public ProcedureDanYaoBuff65On(ElementsYvanchuliandanMod instance) {
        super(instance, 429);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entity.getEntityData().func_74767_n("YaoDan65Buff")) {
            ...
            entity.getEntityData().func_74757_a("YaoDan65Buff", true);
        }
    }
}
