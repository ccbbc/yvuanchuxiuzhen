...
import net.mcreator.yvanchuliandan.potion.PotionDanYaoBuff41;
...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/procedure/ProcedureDanYaoEat41.class */
public class ProcedureDanYaoEat41 extends ElementsYvanchuliandanMod.ModElement {
    public ProcedureDanYaoEat41(ElementsYvanchuliandanMod instance) {
        super(instance, 374);
    }

    /* JADX WARN: Type inference failed for: r1v10, types: [net.mcreator.yvanchuliandan.procedure.ProcedureDanYaoEat41$1] */
    public static void executeProcedure(Map<String, Object> dependencies) {
        if (dependencies.get("entity") == null) {
            return;
        }
        final EntityLivingBase entityLivingBase = (Entity) dependencies.get("entity");
        entityLivingBase.getEntityData().func_74778_a("丹药名暂存", "danyao41");
        if (entityLivingBase instanceof EntityLivingBase) {
            entityLivingBase.func_70690_d(new PotionEffect(PotionDanYaoBuff41.potion, 3600, 0, false, true));
        }
        if (entityLivingBase instanceof EntityPlayer) {
            ...
            _scr.func_96647_c(new Object() { // from class: net.mcreator.yvanchuliandan.procedure.ProcedureDanYaoEat41.1
