...
import net.mcreator.yvanchuliandan.procedure.ProcedureDanFang102Gui10;
import net.mcreator.yvanchuliandan.procedure.ProcedureDanFang102Gui20;
import net.mcreator.yvanchuliandan.procedure.ProcedureDanFang102Gui40;
...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/gui/GuiDanFang102Gui3.class */
public class GuiDanFang102Gui3 extends ElementsYvanchuliandanMod.ModElement {
    public static int GUIID = 18;
    public static HashMap guistate = new HashMap();

    public GuiDanFang102Gui3(ElementsYvanchuliandanMod instance) {
        super(instance, 503);
    }
    ...
    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/gui/GuiDanFang102Gui3$GuiContainerMod.class */
    public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        */
        protected boolean func_75135_a(net.minecraft.item.ItemStack r5, int r6, int r7, boolean r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: net.mcreator.yvanchuliandan.gui.GuiDanFang102Gui3.GuiContainerMod.func_75135_a(net.minecraft.item.ItemStack, int, int, boolean):boolean");
        }
        ...
        private void slotChanged(int slotid, int ctype, int meta) {
            if (this.world != null && this.world.field_72995_K) {
                ...
                GuiDanFang102Gui3.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
            }
        }
    }

    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/gui/GuiDanFang102Gui3$GuiWindow.class */
    public static class GuiWindow extends GuiContainer {
        ...
        protected void func_146976_a(float par1, int par2, int par3) {
            ...
            this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("yvanchuliandan:textures/cui_ti_3.png"));
        ...
        protected void func_146284_a(GuiButton button) {
            ...
            GuiDanFang102Gui3.handleButtonAction(this.entity, button.field_146127_k, this.x, this.y, this.z);
        }
    ...
    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/gui/GuiDanFang102Gui3$GUIButtonPressedMessageHandler.class */
    public static class GUIButtonPressedMessageHandler implements IMessageHandler<GUIButtonPressedMessage, IMessage> {
        public IMessage onMessage(GUIButtonPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiDanFang102Gui3.handleButtonAction(entity, buttonID, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/gui/GuiDanFang102Gui3$GUISlotChangedMessageHandler.class */
    public static class GUISlotChangedMessageHandler implements IMessageHandler<GUISlotChangedMessage, IMessage> {
        public IMessage onMessage(GUISlotChangedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiDanFang102Gui3.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/gui/GuiDanFang102Gui3$GUIButtonPressedMessage.class */
    ...
    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/gui/GuiDanFang102Gui3$GUISlotChangedMessage.class */
    ...
    public static void handleButtonAction(EntityPlayer entity, int buttonID, int x, int y, int z) {
        ...
        if (buttonID == 0) {
            ...
            ProcedureDanFang102Gui20.executeProcedure($_dependencies);
        }
        if (buttonID == 1) {
            ...
            ProcedureDanFang102Gui10.executeProcedure($_dependencies2);
        }
        if (buttonID == 2) {
            ...
            ProcedureDanFang102Gui40.executeProcedure($_dependencies3);
        }
    }
