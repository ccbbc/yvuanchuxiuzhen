...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/block/BlockCaoyaocong01.class */
public class BlockCaoyaocong01 extends ElementsYvanchuliandanMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuliandan:caoyaocong01")
    public static final Block block = null;

    public BlockCaoyaocong01(ElementsYvanchuliandanMod instance) {
        super(instance, 87);
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yvanchuliandan:caoyaocong01", "inventory"));
    }
    ...
    public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (((ResourceLocation) Biome.field_185377_q.func_177774_c(biome)).equals(new ResourceLocation("swampland"))) {
            biomeCriteria = true;
        }
    ...
    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/block/BlockCaoyaocong01$BlockCustomFlower.class */
    public static class BlockCustomFlower extends BlockFlower {
        public BlockCustomFlower() {
            ...
            func_149752_b(5.0f);
            func_149715_a(0.0f);
            func_149663_c("caoyaocong01");
            setRegistryName("caoyaocong01");
        }
