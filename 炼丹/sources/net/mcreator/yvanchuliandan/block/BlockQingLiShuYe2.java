...
import net.mcreator.yvanchuliandan.procedure.ProcedureQingLiShuYeDiaoLuo;
...
/* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/block/BlockQingLiShuYe2.class */
public class BlockQingLiShuYe2 extends ElementsYvanchuliandanMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuliandan:qing_li_shu_ye_2")
    public static final Block block = null;

    public BlockQingLiShuYe2(ElementsYvanchuliandanMod instance) {
        super(instance, 722);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("qing_li_shu_ye_2");
        });
    ...
    public void init(FMLInitializationEvent event) {
        GameRegistry.registerTileEntity(TileEntityCustom.class, "yvanchuliandan:tileentityqing_li_shu_ye_2");
    }

    @Override // net.mcreator.yvanchuliandan.ElementsYvanchuliandanMod.ModElement
    @SideOnly(Side.CLIENT)
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("yvanchuliandan:qing_li_shu_ye_2", "inventory"));
    }

    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/block/BlockQingLiShuYe2$BlockCustom.class */
    public static class BlockCustom extends Block implements ITileEntityProvider {
        public BlockCustom() {
            super(Material.field_151584_j);
            func_149663_c("qing_li_shu_ye_2");
        ...
        public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
            ...
            ProcedureQingLiShuYeDiaoLuo.executeProcedure($_dependencies);
            return retval;
        }
    }

    /* loaded from: 炼丹-mc1.12.2-2.0.14.jar:net/mcreator/yvanchuliandan/block/BlockQingLiShuYe2$TileEntityCustom.class */
    public static class TileEntityCustom extends TileEntityLockableLoot {
        ...
        public String func_70005_c_() {
            return "container.qing_li_shu_ye_2";
        }
        ...
        public String func_174875_k() {
            return "yvanchuliandan:qing_li_shu_ye_2";
        }
