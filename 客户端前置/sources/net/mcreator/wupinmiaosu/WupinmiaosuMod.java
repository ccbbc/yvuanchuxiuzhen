...
@Mod(modid = WupinmiaosuMod.MODID, version = WupinmiaosuMod.VERSION)
/* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/WupinmiaosuMod.class */
public class WupinmiaosuMod {
    public static final String MODID = "wupinmiaosu";
    public static final String VERSION = "2.0.6";
    public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("wupinmiaosu:a");
    @SidedProxy(clientSide = "net.mcreator.wupinmiaosu.ClientProxyWupinmiaosuMod", serverSide = "net.mcreator.wupinmiaosu.ServerProxyWupinmiaosuMod")
    public static IProxyWupinmiaosuMod proxy;
    @Mod.Instance(MODID)
    public static WupinmiaosuMod instance;
    public ElementsWupinmiaosuMod elements = new ElementsWupinmiaosuMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsWupinmiaosuMod.GuiHandler());
