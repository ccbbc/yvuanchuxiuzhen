...
/* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/procedure/ProcedureLianQiMiaoSu2.class */
public class ProcedureLianQiMiaoSu2 extends ElementsWupinmiaosuMod.ModElement {
    public ProcedureLianQiMiaoSu2(ElementsWupinmiaosuMod instance) {
        super(instance, 10);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (dependencies.get("event") != null) {
            ...
            if (_obj instanceof Event) {
                ...
                if (itemstack.func_77973_b().getRegistryName().toString().equals("fabaokuozhan:fabao04")) {
                ...
                if (itemstack.func_77973_b().getRegistryName().toString().equals("fabaokuozhan:zhu_gun")) {
                    if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : "").equals("")) {
                        _event.getToolTip().add(1, "炼制者:" + (itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : ""));
                    } else {
                ...
                if (itemstack.func_77973_b().getRegistryName().toString().equals("fabaokuozhan:xing_du_duan_d_ao")) {
                    if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : "").equals("")) {
                        _event.getToolTip().add(1, "炼制者:" + (itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : ""));
                    } else {
                        _event.getToolTip().add(1, "炼制者:Linlang");
                ...
                if (itemstack.func_77973_b().getRegistryName().toString().equals("fabaokuozhan:jin_yu_huan")) {
                    if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : "").equals("")) {
                        _event.getToolTip().add(1, "炼制者:" + (itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : ""));
                    } else {
                        _event.getToolTip().add(1, "炼制者:XiaYi");
                    ...
                    _event.getToolTip().add(2, "§bSHIFT+V键查看法宝属性");
                    _event.getToolTip().add(3, "§d法宝置于背包中提供被动加成：5%气血");
                }
                if (itemstack.func_77973_b().getRegistryName().toString().equals("fabaokuozhan:fabao31")) {
                    if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : "").equals("")) {
                        _event.getToolTip().add(1, "炼制者:" + (itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : ""));
                    } else {
                        _event.getToolTip().add(1, "炼制者:Linlang");
                ...
                if (itemstack.func_77973_b().getRegistryName().toString().equals("fabaokuozhan:fabao0801")) {
                    if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : "").equals("")) {
                        _event.getToolTip().add(1, "炼制者:" + (itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("炼制者") : ""));
                    } else {
                        _event.getToolTip().add(1, "炼制者:XiaYi");
