...
/* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/procedure/ProcedureJianDanMoShi.class */
public class ProcedureJianDanMoShi extends ElementsWupinmiaosuMod.ModElement {
    public ProcedureJianDanMoShi(ElementsWupinmiaosuMod instance) {
        super(instance, 82);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        } else if (entityPlayer.getEntityData().func_74769_h("随机值") == 4.0d) {
            entityPlayer.getEntityData().func_74757_a("TuLingGen", true);
            entityPlayer.getEntityData().func_74778_a("LingGen", "土");
            entityPlayer.getEntityData().func_74778_a("TiZhi", "土灵之体");
            entityPlayer.getEntityData().func_74780_a("TiZhiNum", 7.0d);
        }
        entityPlayer.getEntityData().func_74780_a("LingGenNum", 1.0d);
        entityPlayer.getEntityData().func_74780_a("GongFaReduce", 1.0d);
