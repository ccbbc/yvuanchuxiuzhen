...
/* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/procedure/ProcedureKunNanMoShi.class */
public class ProcedureKunNanMoShi extends ElementsWupinmiaosuMod.ModElement {
    public ProcedureKunNanMoShi(ElementsWupinmiaosuMod instance) {
        super(instance, 84);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        entityPlayer.getEntityData().func_74780_a("随机值", new Random().nextInt(2) + 4);
