...
/* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/WupinmiaosuModVariables.class */
public class WupinmiaosuModVariables {

    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/WupinmiaosuModVariables$MapVariables.class */
    public static class MapVariables extends WorldSavedData {
        public static final String DATA_NAME = "wupinmiaosu_mapvars";
        ...
        public void syncData(World world) {
            ...
            if (world.field_72995_K) {
                WupinmiaosuMod.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(0, this));
            } else {
                WupinmiaosuMod.PACKET_HANDLER.sendToAll(new WorldSavedDataSyncMessage(0, this));
            }
        }
    ...
    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/WupinmiaosuModVariables$WorldVariables.class */
    public static class WorldVariables extends WorldSavedData {
        public static final String DATA_NAME = "wupinmiaosu_worldvars";
        ...
        public void syncData(World world) {
            func_76185_a();
            if (world.field_72995_K) {
                WupinmiaosuMod.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(1, this));
            } else {
                WupinmiaosuMod.PACKET_HANDLER.sendToDimension(new WorldSavedDataSyncMessage(1, this), world.field_73011_w.getDimension());
            }
        }
    ...
    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/WupinmiaosuModVariables$WorldSavedDataSyncMessageHandler.class */
    public static class WorldSavedDataSyncMessageHandler implements IMessageHandler<WorldSavedDataSyncMessage, IMessage> {
        ...
        private void syncData(WorldSavedDataSyncMessage message, MessageContext context, World world) {
            if (context.side == Side.SERVER) {
                ...
                if (message.type == 0) {
                    WupinmiaosuMod.PACKET_HANDLER.sendToAll(message);
                } else {
                    WupinmiaosuMod.PACKET_HANDLER.sendToDimension(message, world.field_73011_w.getDimension());
                }
            }
            if (message.type == 0) {
    ...
    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/WupinmiaosuModVariables$WorldSavedDataSyncMessage.class */
