...
/* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/gui/GuiGongFa13GUI.class */
public class GuiGongFa13GUI extends ElementsWupinmiaosuMod.ModElement {
    public static int GUIID = 13;
    public static HashMap guistate = new HashMap();
    static Map<String, Object> $_dependencies = new HashMap();

    public GuiGongFa13GUI(ElementsWupinmiaosuMod instance) {
        super(instance, 26);
    }
    ...
    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/gui/GuiGongFa13GUI$GuiContainerMod.class */
    public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        */
        protected boolean func_75135_a(net.minecraft.item.ItemStack r5, int r6, int r7, boolean r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: net.mcreator.wupinmiaosu.gui.GuiGongFa13GUI.GuiContainerMod.func_75135_a(net.minecraft.item.ItemStack, int, int, boolean):boolean");
        }
        ...
        private void slotChanged(int slotid, int ctype, int meta) {
            if (this.world != null && this.world.field_72995_K) {
                ...
                GuiGongFa13GUI.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
            }
        }
    }

    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/gui/GuiGongFa13GUI$GuiWindow.class */
    public static class GuiWindow extends GuiContainer {
        ...
        protected void func_146976_a(float par1, int par2, int par3) {
            ...
            this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("wupinmiaosu:textures/mo_xiang_sen_lin_.png"));
        ...
        protected void func_146284_a(GuiButton button) {
            ...
            GuiGongFa13GUI.handleButtonAction(this.entity, button.field_146127_k, this.x, this.y, this.z);
        }
    ...
    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/gui/GuiGongFa13GUI$GUIButtonPressedMessageHandler.class */
    public static class GUIButtonPressedMessageHandler implements IMessageHandler<GUIButtonPressedMessage, IMessage> {
        public IMessage onMessage(GUIButtonPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiGongFa13GUI.handleButtonAction(entity, buttonID, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/gui/GuiGongFa13GUI$GUISlotChangedMessageHandler.class */
    public static class GUISlotChangedMessageHandler implements IMessageHandler<GUISlotChangedMessage, IMessage> {
        public IMessage onMessage(GUISlotChangedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiGongFa13GUI.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/gui/GuiGongFa13GUI$GUIButtonPressedMessage.class */
    ...
    /* loaded from: 客户端前置-mc1.12.2-2.0.12.jar:net/mcreator/wupinmiaosu/gui/GuiGongFa13GUI$GUISlotChangedMessage.class */
