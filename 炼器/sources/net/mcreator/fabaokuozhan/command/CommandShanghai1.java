...
import net.mcreator.fabaokuozhan.procedure.ProcedureShanghai1DangMingLingBeiZhiXingShi;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandShanghai1.class */
public class CommandShanghai1 extends ElementsFabaokuozhanMod.ModElement {
    public CommandShanghai1(ElementsFabaokuozhanMod instance) {
        super(instance, 298);
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandShanghai1$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghai1DangMingLingBeiZhiXingShi.executeProcedure($_dependencies);
            }
        }
    }
}
