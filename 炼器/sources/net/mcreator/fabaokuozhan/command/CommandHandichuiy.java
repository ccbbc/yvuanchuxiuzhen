...
import net.mcreator.fabaokuozhan.procedure.ProcedureHanDiChui;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandHandichuiy.class */
public class CommandHandichuiy extends ElementsFabaokuozhanMod.ModElement {
    public CommandHandichuiy(ElementsFabaokuozhanMod instance) {
        super(instance, 313);
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandHandichuiy$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureHanDiChui.executeProcedure($_dependencies);
            }
        }
    }
}
