...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao0401CommandExecuted;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandFabao0401.class */
public class CommandFabao0401 extends ElementsFabaokuozhanMod.ModElement {
    public CommandFabao0401(ElementsFabaokuozhanMod instance) {
        super(instance, 243);
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandFabao0401$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureFabao0401CommandExecuted.executeProcedure($_dependencies);
            }
        }
    }
}
