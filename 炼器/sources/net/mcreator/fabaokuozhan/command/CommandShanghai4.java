...
import net.mcreator.fabaokuozhan.procedure.ProcedureShanghai4zhixing;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandShanghai4.class */
public class CommandShanghai4 extends ElementsFabaokuozhanMod.ModElement {
    public CommandShanghai4(ElementsFabaokuozhanMod instance) {
        super(instance, 390);
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandShanghai4$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghai4zhixing.executeProcedure($_dependencies);
            }
        }
    }
}
