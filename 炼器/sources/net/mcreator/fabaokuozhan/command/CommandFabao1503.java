...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao1503CommandExecuted;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandFabao1503.class */
public class CommandFabao1503 extends ElementsFabaokuozhanMod.ModElement {
    public CommandFabao1503(ElementsFabaokuozhanMod instance) {
        super(instance, 147);
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandFabao1503$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureFabao1503CommandExecuted.executeProcedure($_dependencies);
            }
        }
    }
}
