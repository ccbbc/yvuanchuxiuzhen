...
import net.mcreator.fabaokuozhan.procedure.ProcedureShanghai5zhixing;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandShanghai5.class */
public class CommandShanghai5 extends ElementsFabaokuozhanMod.ModElement {
    public CommandShanghai5(ElementsFabaokuozhanMod instance) {
        super(instance, 391);
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandShanghai5$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghai5zhixing.executeProcedure($_dependencies);
            }
        }
    }
}
