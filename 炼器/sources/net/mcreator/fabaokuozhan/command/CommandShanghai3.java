...
import net.mcreator.fabaokuozhan.procedure.ProcedureShanghai3zhixng;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandShanghai3.class */
public class CommandShanghai3 extends ElementsFabaokuozhanMod.ModElement {
    public CommandShanghai3(ElementsFabaokuozhanMod instance) {
        super(instance, 389);
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/command/CommandShanghai3$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureShanghai3zhixng.executeProcedure($_dependencies);
            }
        }
    }
}
