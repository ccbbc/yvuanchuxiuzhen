...
import net.mcreator.fabaokuozhan.procedure.ProcedureCuiLianGuiOpen;
import net.mcreator.fabaokuozhan.procedure.ProcedureOpenBenMingGui;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/gui/GuiBenMingYuCuiLian.class */
public class GuiBenMingYuCuiLian extends ElementsFabaokuozhanMod.ModElement {
    public static int GUIID = 26;
    public static HashMap guistate = new HashMap();

    public GuiBenMingYuCuiLian(ElementsFabaokuozhanMod instance) {
        super(instance, 544);
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/gui/GuiBenMingYuCuiLian$GuiContainerMod.class */
    public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        */
        protected boolean func_75135_a(net.minecraft.item.ItemStack r5, int r6, int r7, boolean r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: net.mcreator.fabaokuozhan.gui.GuiBenMingYuCuiLian.GuiContainerMod.func_75135_a(net.minecraft.item.ItemStack, int, int, boolean):boolean");
        }
        ...
        private void slotChanged(int slotid, int ctype, int meta) {
            if (this.world != null && this.world.field_72995_K) {
                ...
                GuiBenMingYuCuiLian.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
            }
        }
    }

    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/gui/GuiBenMingYuCuiLian$GuiWindow.class */
    public static class GuiWindow extends GuiContainer {
        ...
        private int z;
        private EntityPlayer entity;
        private static final ResourceLocation texture = new ResourceLocation("fabaokuozhan:textures/ben_ming_yu_cui_lian.png");
        ...
        protected void func_146979_b(int par1, int par2) {
            this.field_146289_q.func_78276_b("本命法宝可提升,每个阶段限一次", 6, 29, -13369345);
            this.field_146289_q.func_78276_b("法宝可淬炼提升,每个阶段限一次", 6, 67, -13369447);
        }
        ...
        public void func_73866_w_() {
            ...
            this.field_146292_n.add(new GuiButton(0, this.field_147003_i + 6, this.field_147009_r + 7, 63, 20, "本命法宝提升"));
            this.field_146292_n.add(new GuiButton(1, this.field_147003_i + 6, this.field_147009_r + 43, 63, 20, "法宝淬炼提升"));
        }
        ...
        protected void func_146284_a(GuiButton button) {
            ...
            GuiBenMingYuCuiLian.handleButtonAction(this.entity, button.field_146127_k, this.x, this.y, this.z);
        }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/gui/GuiBenMingYuCuiLian$GUIButtonPressedMessageHandler.class */
    public static class GUIButtonPressedMessageHandler implements IMessageHandler<GUIButtonPressedMessage, IMessage> {
        public IMessage onMessage(GUIButtonPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiBenMingYuCuiLian.handleButtonAction(entity, buttonID, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/gui/GuiBenMingYuCuiLian$GUISlotChangedMessageHandler.class */
    public static class GUISlotChangedMessageHandler implements IMessageHandler<GUISlotChangedMessage, IMessage> {
        public IMessage onMessage(GUISlotChangedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiBenMingYuCuiLian.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/gui/GuiBenMingYuCuiLian$GUIButtonPressedMessage.class */
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/gui/GuiBenMingYuCuiLian$GUISlotChangedMessage.class */
    ...
    public static void handleButtonAction(EntityPlayer entity, int buttonID, int x, int y, int z) {
        ...
        if (buttonID == 0) {
            ...
            ProcedureOpenBenMingGui.executeProcedure($_dependencies);
        }
        if (buttonID == 1) {
            ...
            ProcedureCuiLianGuiOpen.executeProcedure($_dependencies2);
        }
    }
