...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao1201DangGongJuChuXianZaiShouZhongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao1201RightClickedInAir;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao1201.class */
public class ItemFabao1201 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao1201")
    public static final Item block = null;

    public ItemFabao1201(ElementsFabaokuozhanMod instance) {
        super(instance, 14);
    }
    ...
    public void initElements() {
        this.elements.items.add(() -> {
            return new ItemToolCustom() { // from class: net.mcreator.fabaokuozhan.item.ItemFabao1201.1
                public ActionResult<ItemStack> func_77659_a(World world, EntityPlayer entity, EnumHand hand) {
                    ...
                    ProcedureFabao1201RightClickedInAir.executeProcedure($_dependencies);
                    return retval;
                }
                ...
                public void func_77663_a(ItemStack itemstack, World world, Entity entity, int slot, boolean par5) {
                    ...
                    if ((entity instanceof EntityLivingBase) && ((EntityLivingBase) entity).func_184614_ca().equals(itemstack)) {
                        Map $_dependencies = new HashMap();
                        $_dependencies.put("itemstack", itemstack);
                        ProcedureFabao1201DangGongJuChuXianZaiShouZhongShi.executeProcedure($_dependencies);
                    }
                }
            }.func_77655_b("fabao1201").setRegistryName("fabao1201").func_77637_a(TabLianqi.tab);
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao1201", "inventory"));
    }

    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao1201$ItemToolCustom.class */
