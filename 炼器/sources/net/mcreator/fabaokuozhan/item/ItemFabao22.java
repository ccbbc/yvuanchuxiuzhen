...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao22DangGongJuChuXianZaiShouZhongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao22DangShiTiBeiGongJuJiZhongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureXueTaoMuWeiNeng;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao22.class */
public class ItemFabao22 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao22")
    public static final Item block = null;

    public ItemFabao22(ElementsFabaokuozhanMod instance) {
        super(instance, 16);
    }
    ...
    public void initElements() {
        this.elements.items.add(() -> {
            return new ItemSword(EnumHelper.addToolMaterial("FABAO22", 1, 900, 4.0f, -3.0f, 0)) { // from class: net.mcreator.fabaokuozhan.item.ItemFabao22.1
                ...
                public ActionResult<ItemStack> func_77659_a(World world, EntityPlayer entity, EnumHand hand) {
                    ...
                    ProcedureXueTaoMuWeiNeng.executeProcedure($_dependencies);
                    return retval;
                }
                ...
                public boolean func_77644_a(ItemStack itemstack, EntityLivingBase entity, EntityLivingBase sourceentity) {
                    ...
                    ProcedureFabao22DangShiTiBeiGongJuJiZhongShi.executeProcedure($_dependencies);
                    return true;
                }
                ...
                public void func_77663_a(ItemStack itemstack, World world, Entity entity, int slot, boolean par5) {
                    ...
                    if ((entity instanceof EntityLivingBase) && ((EntityLivingBase) entity).func_184614_ca().equals(itemstack)) {
                        Map $_dependencies = new HashMap();
                        $_dependencies.put("itemstack", itemstack);
                        ProcedureFabao22DangGongJuChuXianZaiShouZhongShi.executeProcedure($_dependencies);
                    }
                }
            }.func_77655_b("fabao22").setRegistryName("fabao22").func_77637_a(TabLianqi.tab);
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao22", "inventory"));
    }
}
