...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao13BulletHitsBlock;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao13DangYuanChengWuPinShiYongShi;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao13.class */
public class ItemFabao13 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao13")
    public static final Item block = null;
    public static final int ENTITYID = 8;

    public ItemFabao13(ElementsFabaokuozhanMod instance) {
        super(instance, 15);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(FabaokuozhanMod.MODID, "entitybulletfabao13"), 8).name("entitybulletfabao13").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao13", "inventory"));
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao13$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(900);
            func_77664_n();
            func_77655_b("fabao13");
            setRegistryName("fabao13");
        ...
        public void func_77615_a(ItemStack itemstack, World world, EntityLivingBase entityLivingBase, int timeLeft) {
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                ProcedureFabao13DangYuanChengWuPinShiYongShi.executeProcedure($_dependencies);
            }
        }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao13$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            ProcedureFabao13BulletHitsBlock.executeProcedure($_dependencies);
        }
