...
import net.mcreator.fabaokuozhan.procedure.ProcedureCangYunFeiHuoDangYuanChengWuPinShiYongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureCangYunFeiHuoDangZiDanJiZhongShengCunShiTiShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureCangYunFeiHuoZiDanFeiXingGanShi;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemCangYunFeiHuo.class */
public class ItemCangYunFeiHuo extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:cang_yun_fei_huo")
    public static final Item block = null;
    public static final int ENTITYID = 26;

    public ItemCangYunFeiHuo(ElementsFabaokuozhanMod instance) {
        super(instance, 403);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(FabaokuozhanMod.MODID, "entitybulletcang_yun_fei_huo"), 26).name("entitybulletcang_yun_fei_huo").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:cang_yun_fei_huo", "inventory"));
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemCangYunFeiHuo$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(1500);
            func_77664_n();
            func_77655_b("cang_yun_fei_huo");
            setRegistryName("cang_yun_fei_huo");
        ...
        public void func_77615_a(ItemStack itemstack, World world, EntityLivingBase entityLivingBase, int timeLeft) {
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                ProcedureCangYunFeiHuoDangYuanChengWuPinShiYongShi.executeProcedure($_dependencies);
            }
        }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemCangYunFeiHuo$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            Map<String, Object> $_dependencies = new HashMap<>();
            $_dependencies.put("entity", entity);
            ProcedureCangYunFeiHuoDangZiDanJiZhongShengCunShiTiShi.executeProcedure($_dependencies);
        }
        ...
        public void func_70071_h_() {
            ...
            ProcedureCangYunFeiHuoZiDanFeiXingGanShi.executeProcedure($_dependencies);
