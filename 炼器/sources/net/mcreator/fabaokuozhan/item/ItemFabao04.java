...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao04DangGongJuChuXianZaiShouZhongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao04MobIsHitWithTool;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao04.class */
public class ItemFabao04 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao04")
    public static final Item block = null;

    public ItemFabao04(ElementsFabaokuozhanMod instance) {
        super(instance, 9);
    }
    ...
    public void initElements() {
        this.elements.items.add(() -> {
            return new ItemSword(EnumHelper.addToolMaterial("FABAO04", 1, 700, 4.0f, -3.0f, 0)) { // from class: net.mcreator.fabaokuozhan.item.ItemFabao04.1
                ...
                public boolean func_77644_a(ItemStack itemstack, EntityLivingBase entity, EntityLivingBase sourceentity) {
                    ...
                    ProcedureFabao04MobIsHitWithTool.executeProcedure($_dependencies);
                    return true;
                }
                ...
                public void func_77663_a(ItemStack itemstack, World world, Entity entity, int slot, boolean par5) {
                    ...
                    if ((entity instanceof EntityLivingBase) && ((EntityLivingBase) entity).func_184614_ca().equals(itemstack)) {
                        ...
                        ProcedureFabao04DangGongJuChuXianZaiShouZhongShi.executeProcedure($_dependencies);
                    }
                }
            }.func_77655_b("fabao04").setRegistryName("fabao04").func_77637_a(TabLianqi.tab);
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao04", "inventory"));
    }
}
