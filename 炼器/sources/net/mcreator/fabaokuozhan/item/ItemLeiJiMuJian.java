...
import net.mcreator.fabaokuozhan.procedure.ProcedureLeiJiMuJianDangYuanChengWuPinShiYongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureLeiJiMuJianDangZiDanJiZhongShengCunShiTiShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureLeiJiMuJianZiDanFeiXingGanShi;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemLeiJiMuJian.class */
public class ItemLeiJiMuJian extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:lei_ji_mu_jian")
    public static final Item block = null;
    public static final int ENTITYID = 15;

    public ItemLeiJiMuJian(ElementsFabaokuozhanMod instance) {
        super(instance, 25);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(FabaokuozhanMod.MODID, "entitybulletlei_ji_mu_jian"), 15).name("entitybulletlei_ji_mu_jian").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:lei_ji_mu_jian", "inventory"));
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemLeiJiMuJian$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(1500);
            func_77664_n();
            func_77655_b("lei_ji_mu_jian");
            setRegistryName("lei_ji_mu_jian");
        ...
        public void onUsingTick(ItemStack itemstack, EntityLivingBase entityLivingBase, int count) {
            ...
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                ProcedureLeiJiMuJianDangYuanChengWuPinShiYongShi.executeProcedure($_dependencies);
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemLeiJiMuJian$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            ProcedureLeiJiMuJianDangZiDanJiZhongShengCunShiTiShi.executeProcedure($_dependencies);
        }
        ...
        public void func_70071_h_() {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureLeiJiMuJianZiDanFeiXingGanShi.executeProcedure($_dependencies);
            if (this.field_70254_i) {
                ...
                ProcedureLeiJiMuJianDangZiDanJiZhongShengCunShiTiShi.executeProcedure($_dependencies2);
