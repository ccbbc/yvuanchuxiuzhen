...
import net.mcreator.fabaokuozhan.procedure.ProcedurePoShan1;
import net.mcreator.fabaokuozhan.procedure.ProcedurePoShanDangGongJuChuXianZaiShouZhongShi;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemPoShan.class */
public class ItemPoShan extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:po_shan")
    public static final Item block = null;

    public ItemPoShan(ElementsFabaokuozhanMod instance) {
        super(instance, 420);
    }
    ...
    public void initElements() {
        this.elements.items.add(() -> {
            return new ItemSword(EnumHelper.addToolMaterial("PO_SHAN", 1, 500, 4.0f, -3.0f, 2)) { // from class: net.mcreator.fabaokuozhan.item.ItemPoShan.1
                ...
                public boolean func_77644_a(ItemStack itemstack, EntityLivingBase entity, EntityLivingBase sourceentity) {
                    ...
                    ProcedurePoShan1.executeProcedure($_dependencies);
                    return true;
                }
                ...
                public void func_77663_a(ItemStack itemstack, World world, Entity entity, int slot, boolean par5) {
                    ...
                    if ((entity instanceof EntityLivingBase) && ((EntityLivingBase) entity).func_184614_ca().equals(itemstack)) {
                        ...
                        ProcedurePoShanDangGongJuChuXianZaiShouZhongShi.executeProcedure($_dependencies);
                    }
                }
            }.func_77655_b("po_shan").setRegistryName("po_shan").func_77637_a(TabLianqi.tab);
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:po_shan", "inventory"));
    }
}
