...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao0701DangYuanChengWuPinShiYongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao07BulletHitsBlock;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao07WhileBulletFlyingTick;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao0701.class */
public class ItemFabao0701 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao0701")
    public static final Item block = null;
    public static final int ENTITYID = 6;

    public ItemFabao0701(ElementsFabaokuozhanMod instance) {
        super(instance, 19);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(FabaokuozhanMod.MODID, "entitybulletfabao0701"), 6).name("entitybulletfabao0701").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao0701", "inventory"));
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao0701$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(1200);
            func_77664_n();
            func_77655_b("fabao0701");
            setRegistryName("fabao0701");
        ...
        public void func_77615_a(ItemStack itemstack, World world, EntityLivingBase entityLivingBase, int timeLeft) {
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                ProcedureFabao0701DangYuanChengWuPinShiYongShi.executeProcedure($_dependencies);
            }
        }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao0701$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            ProcedureFabao07BulletHitsBlock.executeProcedure($_dependencies);
        }
        ...
        public void func_70071_h_() {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureFabao07WhileBulletFlyingTick.executeProcedure($_dependencies);
            if (this.field_70254_i) {
                ...
                ProcedureFabao07BulletHitsBlock.executeProcedure($_dependencies2);
