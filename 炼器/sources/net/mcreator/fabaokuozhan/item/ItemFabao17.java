...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao17DangGongJuChuXianZaiShouZhongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao17MobIsHitWithTool;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao17YouJian;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao17.class */
public class ItemFabao17 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao17")
    public static final Item block = null;

    public ItemFabao17(ElementsFabaokuozhanMod instance) {
        super(instance, 24);
    }
    ...
    public void initElements() {
        this.elements.items.add(() -> {
            return new ItemSword(EnumHelper.addToolMaterial("FABAO17", 1, 1500, 4.0f, 304.0f, 0)) { // from class: net.mcreator.fabaokuozhan.item.ItemFabao17.1
                ...
                public ActionResult<ItemStack> func_77659_a(World world, EntityPlayer entity, EnumHand hand) {
                    ...
                    ProcedureFabao17YouJian.executeProcedure($_dependencies);
                    return retval;
                }
                ...
                public boolean func_77644_a(ItemStack itemstack, EntityLivingBase entity, EntityLivingBase sourceentity) {
                    ...
                    $_dependencies.put("itemstack", itemstack);
                    ProcedureFabao17MobIsHitWithTool.executeProcedure($_dependencies);
                    return true;
                }
                ...
                public void func_77663_a(ItemStack itemstack, World world, Entity entity, int slot, boolean par5) {
                    ...
                    if ((entity instanceof EntityLivingBase) && ((EntityLivingBase) entity).func_184614_ca().equals(itemstack)) {
                        Map $_dependencies = new HashMap();
                        $_dependencies.put("itemstack", itemstack);
                        ProcedureFabao17DangGongJuChuXianZaiShouZhongShi.executeProcedure($_dependencies);
                    }
                }
            }.func_77655_b("fabao17").setRegistryName("fabao17").func_77637_a(TabLianqi.tab);
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao17", "inventory"));
    }
}
