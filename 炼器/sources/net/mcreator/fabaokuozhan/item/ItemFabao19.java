...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao19RightClickedInAir;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao19.class */
public class ItemFabao19 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao19")
    public static final Item block = null;

    public ItemFabao19(ElementsFabaokuozhanMod instance) {
        super(instance, 3);
    }
    ...
    public void initElements() {
        this.elements.items.add(() -> {
            return new ItemSword(EnumHelper.addToolMaterial("FABAO19", 1, 30, 4.0f, 1.0f, 0)) { // from class: net.mcreator.fabaokuozhan.item.ItemFabao19.1
                ...
                public ActionResult<ItemStack> func_77659_a(World world, EntityPlayer entity, EnumHand hand) {
                    ...
                    ProcedureFabao19RightClickedInAir.executeProcedure($_dependencies);
                    return retval;
                }
            }.func_77655_b("fabao19").setRegistryName("fabao19").func_77637_a(TabLianqi.tab);
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao19", "inventory"));
    }
}
