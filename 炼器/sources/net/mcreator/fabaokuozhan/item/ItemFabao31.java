...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao31BulletHitsBlock;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao31DangYuanChengWuPinShiYongShi;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao31.class */
public class ItemFabao31 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao31")
    public static final Item block = null;
    public static final int ENTITYID = 10;

    public ItemFabao31(ElementsFabaokuozhanMod instance) {
        super(instance, 11);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(FabaokuozhanMod.MODID, "entitybulletfabao31"), 10).name("entitybulletfabao31").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao31", "inventory"));
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao31$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(0);
            func_77664_n();
            func_77655_b("fabao31");
            setRegistryName("fabao31");
            ...
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                while (true) {
                    if (i < entity.field_71071_by.field_70462_a.size()) {
                        ...
                        if (stack == null || stack.func_77973_b() != new ItemStack(ItemFabao31.block, 1).func_77973_b() || stack.func_77960_j() != new ItemStack(ItemFabao31.block, 1).func_77960_j()) {
                            i++;
                        } else {
                            slotID = i;
                            break;
                ...
                if (entity.field_71075_bZ.field_75098_d || EnchantmentHelper.func_77506_a(Enchantments.field_185312_x, itemstack) > 0 || slotID != -1) {
                    ...
                    if (entity.field_71075_bZ.field_75098_d) {
                    ...
                    } else if (new ItemStack(ItemFabao31.block, 1).func_77984_f()) {
                        ...
                        entity.field_71071_by.func_174925_a(new ItemStack(ItemFabao31.block, 1).func_77973_b(), -1, 1, (NBTTagCompound) null);
                    }
                    ...
                    ProcedureFabao31DangYuanChengWuPinShiYongShi.executeProcedure($_dependencies);
                }
            }
        }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao31$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            ProcedureFabao31BulletHitsBlock.executeProcedure($_dependencies);
        }
