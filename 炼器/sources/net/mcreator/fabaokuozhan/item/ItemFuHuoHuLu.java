...
import net.mcreator.fabaokuozhan.procedure.ProcedureFuHuoHuLuDangYuanChengWuPinShiYongShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureFuHuoHuLuDangZiDanJiZhongFangKuaiShi;
import net.mcreator.fabaokuozhan.procedure.ProcedureFuHuoHuLuTick;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFuHuoHuLu.class */
public class ItemFuHuoHuLu extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fu_huo_hu_lu")
    public static final Item block = null;
    public static final int ENTITYID = 14;

    public ItemFuHuoHuLu(ElementsFabaokuozhanMod instance) {
        super(instance, 4);
    }
    ...
    public void initElements() {
        ...
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation(FabaokuozhanMod.MODID, "entitybulletfu_huo_hu_lu"), 14).name("entitybulletfu_huo_hu_lu").tracker(64, 1, true).build();
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fu_huo_hu_lu", "inventory"));
    }
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFuHuoHuLu$RangedItem.class */
    public static class RangedItem extends Item {
        public RangedItem() {
            func_77656_e(500);
            func_77664_n();
            func_77655_b("fu_huo_hu_lu");
            setRegistryName("fu_huo_hu_lu");
        ...
        public void onUsingTick(ItemStack itemstack, EntityLivingBase entityLivingBase, int count) {
            ...
            if (!world.field_72995_K && (entityLivingBase instanceof EntityPlayerMP)) {
                ...
                ProcedureFuHuoHuLuDangYuanChengWuPinShiYongShi.executeProcedure($_dependencies);
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFuHuoHuLu$EntityArrowCustom.class */
    public static class EntityArrowCustom extends EntityTippedArrow {
        ...
        protected void func_184548_a(EntityLivingBase entity) {
            ...
            ProcedureFuHuoHuLuDangZiDanJiZhongFangKuaiShi.executeProcedure($_dependencies);
        }
        ...
        public void func_70071_h_() {
            ...
            $_dependencies.put("z", Integer.valueOf(z));
            $_dependencies.put("world", world);
            ProcedureFuHuoHuLuTick.executeProcedure($_dependencies);
            if (this.field_70254_i) {
                ...
                ProcedureFuHuoHuLuDangZiDanJiZhongFangKuaiShi.executeProcedure($_dependencies2);
