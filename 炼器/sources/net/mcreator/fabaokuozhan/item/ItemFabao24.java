...
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao24MobIsHitWithTool;
import net.mcreator.fabaokuozhan.procedure.ProcedureFabao24RightClickedInAir;
...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/item/ItemFabao24.class */
public class ItemFabao24 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:fabao24")
    public static final Item block = null;

    public ItemFabao24(ElementsFabaokuozhanMod instance) {
        super(instance, 217);
    }
    ...
    public void initElements() {
        this.elements.items.add(() -> {
            return new ItemSword(EnumHelper.addToolMaterial("FABAO24", 1, 300, 4.0f, 4.0f, 0)) { // from class: net.mcreator.fabaokuozhan.item.ItemFabao24.1
                ...
                public ActionResult<ItemStack> func_77659_a(World world, EntityPlayer entity, EnumHand hand) {
                    ...
                    ProcedureFabao24RightClickedInAir.executeProcedure($_dependencies);
                    return retval;
                }
                ...
                public boolean func_77644_a(ItemStack itemstack, EntityLivingBase entity, EntityLivingBase sourceentity) {
                    ...
                    ProcedureFabao24MobIsHitWithTool.executeProcedure($_dependencies);
                    return true;
                }
            }.func_77655_b("fabao24").setRegistryName("fabao24").func_77637_a(TabLianqi.tab);
        });
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fabaokuozhan:fabao24", "inventory"));
    }
}
