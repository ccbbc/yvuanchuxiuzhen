...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/procedure/ProcedureYuJianYouJian32.class */
public class ProcedureYuJianYouJian32 extends ElementsFabaokuozhanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureYuJianYouJian32(ElementsFabaokuozhanMod instance) {
        super(instance, 461);
    }
