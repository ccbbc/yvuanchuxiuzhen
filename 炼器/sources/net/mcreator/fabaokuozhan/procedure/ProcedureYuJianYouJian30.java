...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/procedure/ProcedureYuJianYouJian30.class */
public class ProcedureYuJianYouJian30 extends ElementsFabaokuozhanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureYuJianYouJian30(ElementsFabaokuozhanMod instance) {
        super(instance, 459);
    }
