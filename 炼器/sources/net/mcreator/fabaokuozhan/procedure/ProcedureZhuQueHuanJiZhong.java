...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/procedure/ProcedureZhuQueHuanJiZhong.class */
public class ProcedureZhuQueHuanJiZhong extends ElementsFabaokuozhanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureZhuQueHuanJiZhong(ElementsFabaokuozhanMod instance) {
        super(instance, 515);
    }
