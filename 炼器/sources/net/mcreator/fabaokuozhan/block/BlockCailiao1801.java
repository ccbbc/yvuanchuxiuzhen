...
/* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/block/BlockCailiao1801.class */
public class BlockCailiao1801 extends ElementsFabaokuozhanMod.ModElement {
    @GameRegistry.ObjectHolder("fabaokuozhan:cailiao1801")
    public static final Block block = null;

    public BlockCailiao1801(ElementsFabaokuozhanMod instance) {
        super(instance, 51);
    }
    ...
    public void initElements() {
        this.elements.blocks.add(() -> {
            return new BlockCustom().setRegistryName("cailiao1801");
        });
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.func_150898_a(block), 0, new ModelResourceLocation("fabaokuozhan:cailiao1801", "inventory"));
    }
    ...
    public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            new WorldGenMinable(block.func_176223_P(), 6, new Predicate<IBlockState>() { // from class: net.mcreator.fabaokuozhan.block.BlockCailiao1801.1
    ...
    /* loaded from: 炼器-mc1.12.2-2.0.12.jar:net/mcreator/fabaokuozhan/block/BlockCailiao1801$BlockCustom.class */
    public static class BlockCustom extends Block {
        public BlockCustom() {
            super(Material.field_151576_e);
            func_149663_c("cailiao1801");
