...
import net.mcreator.yuanchuzhushou.procedure.ProcedureGongfabeilv1;
...
/* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/command/CommandGongfabeilv.class */
public class CommandGongfabeilv extends ElementsYuanchuzhushouMod.ModElement {
    public CommandGongfabeilv(ElementsYuanchuzhushouMod instance) {
        super(instance, 65);
    }
    ...
    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/command/CommandGongfabeilv$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public boolean func_184882_a(MinecraftServer server, ICommandSender var1) {
            return var1.func_70003_b(0, "gongfabeilv");
        }
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureGongfabeilv1.executeProcedure($_dependencies);
            }
        }
    }
}
