...
import net.mcreator.yuanchuzhushou.procedure.ProcedureSiWangDangMingLingBeiZhiXingShi;
...
/* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/command/CommandSiWang.class */
public class CommandSiWang extends ElementsYuanchuzhushouMod.ModElement {
    public CommandSiWang(ElementsYuanchuzhushouMod instance) {
        super(instance, 27);
    }
    ...
    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/command/CommandSiWang$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public boolean func_184882_a(MinecraftServer server, ICommandSender var1) {
            return var1.func_70003_b(0, "siwang");
        }
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                ProcedureSiWangDangMingLingBeiZhiXingShi.executeProcedure($_dependencies);
            }
        }
    }
}
