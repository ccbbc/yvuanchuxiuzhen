...
/* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/gui/GuiChaKanGui.class */
public class GuiChaKanGui extends ElementsYuanchuzhushouMod.ModElement {
    public static int GUIID = 5;
    public static HashMap guistate = new HashMap();

    public GuiChaKanGui(ElementsYuanchuzhushouMod instance) {
        super(instance, 63);
    }
    ...
    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/gui/GuiChaKanGui$GuiContainerMod.class */
    public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        */
        protected boolean func_75135_a(net.minecraft.item.ItemStack r5, int r6, int r7, boolean r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: net.mcreator.yuanchuzhushou.gui.GuiChaKanGui.GuiContainerMod.func_75135_a(net.minecraft.item.ItemStack, int, int, boolean):boolean");
        }
        ...
        private void slotChanged(int slotid, int ctype, int meta) {
            if (this.world != null && this.world.field_72995_K) {
                ...
                GuiChaKanGui.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
            }
        }
    }

    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/gui/GuiChaKanGui$GuiWindow.class */
    public static class GuiWindow extends GuiContainer {
        ...
        private int z;
        private EntityPlayer entity;
        private static final ResourceLocation texture = new ResourceLocation("yuanchuzhushou:textures/cha_kan_gui.png");
        ...
        protected void func_146979_b(int par1, int par2) {
            this.field_146289_q.func_78276_b("灵力:" + this.entity.getEntityData().func_74769_h("PowerMax1") + "", 6, 43, -16711732);
            this.field_146289_q.func_78276_b("玩家ID:" + this.entity.getEntityData().func_74779_i("ChaTanID") + "", 6, 7, -6684775);
            this.field_146289_q.func_78276_b("真元:" + this.entity.getEntityData().func_74769_h("BaseMax1") + "", 6, 61, -103);
            this.field_146289_q.func_78276_b("气血:" + this.entity.getEntityData().func_74769_h("HealthMax1") + "", 6, 25, -26215);
        }
        ...
        protected void func_146284_a(GuiButton button) {
            ...
            GuiChaKanGui.handleButtonAction(this.entity, button.field_146127_k, this.x, this.y, this.z);
        }
    ...
    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/gui/GuiChaKanGui$GUIButtonPressedMessageHandler.class */
    public static class GUIButtonPressedMessageHandler implements IMessageHandler<GUIButtonPressedMessage, IMessage> {
        public IMessage onMessage(GUIButtonPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiChaKanGui.handleButtonAction(entity, buttonID, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/gui/GuiChaKanGui$GUISlotChangedMessageHandler.class */
    public static class GUISlotChangedMessageHandler implements IMessageHandler<GUISlotChangedMessage, IMessage> {
        public IMessage onMessage(GUISlotChangedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiChaKanGui.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/gui/GuiChaKanGui$GUIButtonPressedMessage.class */
    ...
    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/gui/GuiChaKanGui$GUISlotChangedMessage.class */
