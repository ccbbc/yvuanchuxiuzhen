...
/* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/item/ItemLingGen1.class */
public class ItemLingGen1 extends ElementsYuanchuzhushouMod.ModElement {
    @GameRegistry.ObjectHolder("yuanchuzhushou:ling_gen_1")
    public static final Item block = null;

    public ItemLingGen1(ElementsYuanchuzhushouMod instance) {
        super(instance, 69);
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("yuanchuzhushou:ling_gen_1", "inventory"));
    }

    /* loaded from: 助手-mc1.12.2-1.9.7.jar:net/mcreator/yuanchuzhushou/item/ItemLingGen1$ItemCustom.class */
    public static class ItemCustom extends Item {
        public ItemCustom() {
            func_77656_e(0);
            this.field_77777_bU = 64;
            func_77655_b("ling_gen_1");
            setRegistryName("ling_gen_1");
