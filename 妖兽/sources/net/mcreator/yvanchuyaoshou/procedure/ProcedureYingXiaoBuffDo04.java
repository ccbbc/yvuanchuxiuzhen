...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureYingXiaoBuffDo04.class */
public class ProcedureYingXiaoBuffDo04 extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureYingXiaoBuffDo04(ElementsYvanchuyaoshouMod instance) {
        super(instance, 230);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!(entity instanceof EntityYingXiao02.EntityCustom) && !(entity instanceof EntityYingXiao03.EntityCustom) && !(entity instanceof EntityYingXiao04.EntityCustom) && !(entity instanceof EntityYingXiao05.EntityCustom) && !entity.getEntityData().func_74767_n("鹰枭攻击")) {
            entity.getEntityData().func_74780_a("BeMagicAttack", 690.0d);
