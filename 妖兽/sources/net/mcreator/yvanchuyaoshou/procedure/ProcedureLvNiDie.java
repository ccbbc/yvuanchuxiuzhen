...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureLvNiDie.class */
public class ProcedureLvNiDie extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureLvNiDie(ElementsYvanchuyaoshouMod instance) {
        super(instance, 143);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entityPlayerMP.func_145748_c_().func_150260_c().contains("一阶")) {
            ...
            if (Math.random() <= 0.4d && !world.field_72995_K && world.func_73046_m() != null) {
                world.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuyaoshou.procedure.ProcedureLvNiDie.1
                ...
                }, "summon minecraft:item ~ ~1 ~ {Item:{id:\"yvanchuliandan:cailiaojulingni\",Count:1b,Damage:0s}}");
            }
        }
    }
}
