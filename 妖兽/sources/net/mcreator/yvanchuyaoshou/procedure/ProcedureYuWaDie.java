...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureYuWaDie.class */
public class ProcedureYuWaDie extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureYuWaDie(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityGuLang0401.ENTITYID_RANGED);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entity.func_145748_c_().func_150260_c().contains("一阶")) {
            ...
            if (Math.random() <= 0.3d && !world.field_72995_K && world.func_73046_m() != null) {
                world.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuyaoshou.procedure.ProcedureYuWaDie.1
                ...
                }, "summon minecraft:item ~ ~1 ~ {Item:{id:\"fabaokuozhan:bi_huo_yuan\",Count:1b,Damage:0s}}");
            }
            ...
            if (Math.random() <= 0.3d && !world.field_72995_K && world.func_73046_m() != null) {
                world.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuyaoshou.procedure.ProcedureYuWaDie.2
                    public String func_70005_c_() {
                        return "";
                    }
                ...
                }, "summon minecraft:item ~ ~1 ~ {Item:{id:\"fabaokuozhan:qing_zhu\",Count:1b,Damage:0s}}");
            }
        }
    }
}
