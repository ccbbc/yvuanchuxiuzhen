...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureYaoDanHeRightClickDo1.class */
public class ProcedureYaoDanHeRightClickDo1 extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureYaoDanHeRightClickDo1(ElementsYvanchuyaoshouMod instance) {
        super(instance, 140);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (Math.random() <= 0.2d) {
            if (!world.field_72995_K) {
                EntityItem entityToSpawn = new EntityItem(world, x, y, z, new ItemStack(ItemYaodan0201.block, 1));
                entityToSpawn.func_174867_a(10);
                world.func_72838_d(entityToSpawn);
            }
        } else if (Math.random() <= 0.1d) {
            if (!world.field_72995_K) {
                EntityItem entityToSpawn2 = new EntityItem(world, x, y, z, new ItemStack(ItemYaodan0202.block, 1));
                entityToSpawn2.func_174867_a(10);
                world.func_72838_d(entityToSpawn2);
            }
        } else if (Math.random() <= 0.05d) {
            if (!world.field_72995_K) {
                EntityItem entityToSpawn3 = new EntityItem(world, x, y, z, new ItemStack(ItemYaodan0203.block, 1));
