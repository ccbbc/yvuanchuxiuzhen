...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureLvNiUpdate.class */
public class ProcedureLvNiUpdate extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureLvNiUpdate(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityGuLang0201.ENTITYID);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if ((entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_110143_aJ() : -1.0f) > 0.0f && !entityLivingBase.getEntityData().func_74767_n("初始化")) {
            if (!entityLivingBase.getEntityData().func_74767_n("信息设置")) {
                ...
                ProcedureLvNiXinXi.executeProcedure($_dependencies);
                $_dependencies.put("entity", entityLivingBase);
