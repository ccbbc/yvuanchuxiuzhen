...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureQiLinSkill.class */
public class ProcedureQiLinSkill extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureQiLinSkill(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityTianGong102.ENTITYID);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if ((entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_110143_aJ() : -1.0f) > 0.0f) {
            if ((entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_110143_aJ() : -1.0f) <= (entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_110138_aP() : -1.0f) * 0.5d && !entityLivingBase.getEntityData().func_74767_n("麒麟技能")) {
                ...
                if (!((Entity) entityLivingBase).field_70170_p.field_72995_K && ((Entity) entityLivingBase).field_70170_p.func_73046_m() != null) {
                    ((Entity) entityLivingBase).field_70170_p.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchuyaoshou.procedure.ProcedureQiLinSkill.1
                ...
                entityLivingBase.getEntityData().func_74757_a("麒麟技能", true);
                return;
            }
        }
        if ((entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_110143_aJ() : -1.0f) > 0.0f && entityLivingBase.getEntityData().func_74767_n("麒麟技能")) {
            ...
            entityLivingBase.getEntityData().func_74757_a("麒麟技能", false);
        }
    }
}
