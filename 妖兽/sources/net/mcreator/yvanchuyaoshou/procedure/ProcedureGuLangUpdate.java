...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureGuLangUpdate.class */
public class ProcedureGuLangUpdate extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGuLangUpdate(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityHunTieShou02.ENTITYID);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if ((entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_110143_aJ() : -1.0f) > 0.0f && !entityLivingBase.getEntityData().func_74767_n("初始化")) {
            if (!entityLivingBase.getEntityData().func_74767_n("信息设置")) {
                ...
                ProcedureGuLangXinXi.executeProcedure($_dependencies);
                $_dependencies.put("entity", entityLivingBase);
