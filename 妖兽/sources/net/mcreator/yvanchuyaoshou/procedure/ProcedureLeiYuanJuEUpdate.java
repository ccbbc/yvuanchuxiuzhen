...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureLeiYuanJuEUpdate.class */
public class ProcedureLeiYuanJuEUpdate extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureLeiYuanJuEUpdate(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityJiHunXie01.ENTITYID_RANGED);
    }
