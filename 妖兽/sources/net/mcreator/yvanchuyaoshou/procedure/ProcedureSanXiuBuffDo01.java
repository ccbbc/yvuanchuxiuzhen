...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureSanXiuBuffDo01.class */
public class ProcedureSanXiuBuffDo01 extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureSanXiuBuffDo01(ElementsYvanchuyaoshouMod instance) {
        super(instance, 248);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!(entity instanceof EntitySanXiu01.EntityCustom) && !(entity instanceof EntitySanXiu02.EntityCustom) && !(entity instanceof EntitySanXiu03.EntityCustom) && !(entity instanceof EntitySanXiu04.EntityCustom) && !(entity instanceof EntitySanXiu05.EntityCustom) && !entity.getEntityData().func_74767_n("散修攻击")) {
            entity.getEntityData().func_74780_a("BeMagicAttack", 10.0d);
