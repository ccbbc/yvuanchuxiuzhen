...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureZhaDanBuffDo05.class */
public class ProcedureZhaDanBuffDo05 extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureZhaDanBuffDo05(ElementsYvanchuyaoshouMod instance) {
        super(instance, 236);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!(entity instanceof EntityYingXiao02.EntityCustom) && !(entity instanceof EntityYingXiao03.EntityCustom) && !(entity instanceof EntityYingXiao04.EntityCustom) && !(entity instanceof EntityYingXiao05.EntityCustom) && !entity.getEntityData().func_74767_n("炸蛋攻击")) {
            entity.getEntityData().func_74780_a("BeMagicAttack", 1809.0d);
