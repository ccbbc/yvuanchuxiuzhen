...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureJunEYiUpdate.class */
public class ProcedureJunEYiUpdate extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureJunEYiUpdate(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityMoXiu0202.ENTITYID_RANGED);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if ((entityLivingBase instanceof EntityLivingBase ? entityLivingBase.func_110143_aJ() : -1.0f) > 0.0f && !entityLivingBase.getEntityData().func_74767_n("初始化")) {
            if (!entityLivingBase.getEntityData().func_74767_n("信息设置")) {
                ...
                ProcedureJunEYiXinXi.executeProcedure($_dependencies);
                $_dependencies.put("entity", entityLivingBase);
            ...
            if (entityLivingBase.getEntityData().func_74769_h("主计时") >= 20.0d) {
                ...
                ProcedureJunEYiSkill.executeProcedure($_dependencies);
