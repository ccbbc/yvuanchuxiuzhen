...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/procedure/ProcedureZhaDanBuffDo03.class */
public class ProcedureZhaDanBuffDo03 extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureZhaDanBuffDo03(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityXueYuZhiZhu.ENTITYID);
    }
