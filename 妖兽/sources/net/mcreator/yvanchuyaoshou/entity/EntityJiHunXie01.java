...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityJiHunXie01.class */
public class EntityJiHunXie01 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 200;
    public static final int ENTITYID_RANGED = 201;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityJiHunXie01(ElementsYvanchuyaoshouMod instance) {
        super(instance, 29);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "ji_hun_xie_01"), (int) ENTITYID).name("ji_hun_xie_01").tracker(64, 3, true).egg(-16750951, -16777114).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelji_hun_xie(), 0.4f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityJiHunXie01.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityJiHunXie01$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityJiHunXie01.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityJiHunXie01.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityJiHunXie01.$_dependencies.put("entity", this);
            EntityJiHunXie01.$_dependencies.put("x", Integer.valueOf(x));
            EntityJiHunXie01.$_dependencies.put("y", Integer.valueOf(y));
            EntityJiHunXie01.$_dependencies.put("z", Integer.valueOf(z));
            EntityJiHunXie01.$_dependencies.put("world", this.field_70170_p);
            ProcedureJiHunXieDie.executeProcedure(EntityJiHunXie01.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityJiHunXie01.$_dependencies.put("entity", this);
            EntityJiHunXie01.$_dependencies.put("world", this.field_70170_p);
            ProcedureJiHunXieUpdate.executeProcedure(EntityJiHunXie01.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityJiHunXie01$Modelji_hun_xie.class */
