...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityJunEYi05.class */
public class EntityJunEYi05 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 74;
    public static final int ENTITYID_RANGED = 75;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityJunEYi05(ElementsYvanchuyaoshouMod instance) {
        super(instance, 42);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "jun_e_yi_05"), 74).name("jun_e_yi_05").tracker(64, 3, true).egg(-10079488, -6710887).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modeljun_e_yi_(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityJunEYi05.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityJunEYi05$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityJunEYi05.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityJunEYi05.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityJunEYi05.$_dependencies.put("entity", this);
            EntityJunEYi05.$_dependencies.put("x", Integer.valueOf(x));
            EntityJunEYi05.$_dependencies.put("y", Integer.valueOf(y));
            EntityJunEYi05.$_dependencies.put("z", Integer.valueOf(z));
            EntityJunEYi05.$_dependencies.put("world", this.field_70170_p);
            ProcedureJunEYiDie.executeProcedure(EntityJunEYi05.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityJunEYi05.$_dependencies.put("entity", this);
            EntityJunEYi05.$_dependencies.put("world", this.field_70170_p);
            ProcedureJunEYiUpdate.executeProcedure(EntityJunEYi05.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityJunEYi05$Modeljun_e_yi_.class */
