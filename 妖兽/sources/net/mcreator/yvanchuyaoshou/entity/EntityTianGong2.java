...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong2.class */
public class EntityTianGong2 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 216;
    public static final int ENTITYID_RANGED = 217;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityTianGong2(ElementsYvanchuyaoshouMod instance) {
        super(instance, 96);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "tian_gong_2"), (int) ENTITYID).name("tian_gong_2").tracker(64, 3, true).egg(-13312, -26266).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityTianGong2.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/gu_lao_mo.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong2$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityTianGong2.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityTianGong2.$_dependencies);
        ...
        public void func_70030_z() {
            ...
            EntityTianGong2.$_dependencies.put("entity", this);
            EntityTianGong2.$_dependencies.put("x", Integer.valueOf(x));
            EntityTianGong2.$_dependencies.put("y", Integer.valueOf(y));
            EntityTianGong2.$_dependencies.put("z", Integer.valueOf(z));
            EntityTianGong2.$_dependencies.put("world", this.field_70170_p);
            ProcedureTianGongUpdate.executeProcedure(EntityTianGong2.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong2$Modelsteve.class */
