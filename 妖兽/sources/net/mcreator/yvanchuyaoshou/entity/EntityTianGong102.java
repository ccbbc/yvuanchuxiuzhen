...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong102.class */
public class EntityTianGong102 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 214;
    public static final int ENTITYID_RANGED = 215;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityTianGong102(ElementsYvanchuyaoshouMod instance) {
        super(instance, 95);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "tian_gong_102"), (int) ENTITYID).name("tian_gong_102").tracker(64, 3, true).egg(-13312, -26266).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityTianGong102.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/hu_fa.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong102$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityTianGong102.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityTianGong102.$_dependencies);
        ...
        public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            ...
            int i3 = (int) this.field_70161_v;
            EntityTianGong102.$_dependencies.put("entity", this);
            ProcedureNameSet.executeProcedure(EntityTianGong102.$_dependencies);
            return retval;
        }
        ...
        public void func_70030_z() {
            ...
            EntityTianGong102.$_dependencies.put("entity", this);
            EntityTianGong102.$_dependencies.put("x", Integer.valueOf(x));
            EntityTianGong102.$_dependencies.put("y", Integer.valueOf(y));
            EntityTianGong102.$_dependencies.put("z", Integer.valueOf(z));
            EntityTianGong102.$_dependencies.put("world", this.field_70170_p);
            ProcedureTianGongUpdate.executeProcedure(EntityTianGong102.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong102$Modelsteve.class */
