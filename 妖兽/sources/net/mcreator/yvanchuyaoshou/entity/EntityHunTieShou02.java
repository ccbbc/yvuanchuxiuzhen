...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou02.class */
public class EntityHunTieShou02 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 182;
    public static final int ENTITYID_RANGED = 183;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityHunTieShou02(ElementsYvanchuyaoshouMod instance) {
        super(instance, 84);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "hun_tie_shou_02"), (int) ENTITYID).name("hun_tie_shou_02").tracker((int) EntityMoXiu02.ENTITYID, 3, true).egg(-13421773, -6750208).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelhun_tie_shou(), 1.2f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityHunTieShou02.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou02$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityHunTieShou02.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityHunTieShou02.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityHunTieShou02.$_dependencies.put("entity", this);
            EntityHunTieShou02.$_dependencies.put("x", Integer.valueOf(x));
            EntityHunTieShou02.$_dependencies.put("y", Integer.valueOf(y));
            EntityHunTieShou02.$_dependencies.put("z", Integer.valueOf(z));
            EntityHunTieShou02.$_dependencies.put("world", this.field_70170_p);
            ProcedureHunTieShouDie.executeProcedure(EntityHunTieShou02.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityHunTieShou02.$_dependencies.put("entity", this);
            EntityHunTieShou02.$_dependencies.put("world", this.field_70170_p);
            ProcedureHunTieShouUpdate.executeProcedure(EntityHunTieShou02.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou02$Modelhun_tie_shou.class */
