...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHeHuanZong1.class */
public class EntityHeHuanZong1 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 206;
    public static final int ENTITYID_RANGED = 207;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityHeHuanZong1(ElementsYvanchuyaoshouMod instance) {
        super(instance, 91);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "he_huan_zong_1"), (int) ENTITYID).name("he_huan_zong_1").tracker(64, 3, true).egg(-10092391, -26317).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityHeHuanZong1.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/he_huan_zong_1.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHeHuanZong1$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityHeHuanZong1.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityHeHuanZong1.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityHeHuanZong1.$_dependencies.put("entity", this);
            EntityHeHuanZong1.$_dependencies.put("x", Integer.valueOf(x));
            EntityHeHuanZong1.$_dependencies.put("y", Integer.valueOf(y));
            EntityHeHuanZong1.$_dependencies.put("z", Integer.valueOf(z));
            EntityHeHuanZong1.$_dependencies.put("world", this.field_70170_p);
            ProcedureHeHuanZongDie.executeProcedure(EntityHeHuanZong1.$_dependencies);
        }
        ...
        public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            ...
            int i3 = (int) this.field_70161_v;
            EntityHeHuanZong1.$_dependencies.put("entity", this);
            ProcedureNameSet.executeProcedure(EntityHeHuanZong1.$_dependencies);
            return retval;
        }
        ...
        public void func_70030_z() {
            ...
            EntityHeHuanZong1.$_dependencies.put("z", Integer.valueOf(z));
            EntityHeHuanZong1.$_dependencies.put("world", this.field_70170_p);
            ProcedureHeHuanZongUpdate.executeProcedure(EntityHeHuanZong1.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHeHuanZong1$Modelsteve.class */
