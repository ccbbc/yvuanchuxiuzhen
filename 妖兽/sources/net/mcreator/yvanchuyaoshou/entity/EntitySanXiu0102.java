...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntitySanXiu0102.class */
public class EntitySanXiu0102 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 152;
    public static final int ENTITYID_RANGED = 153;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntitySanXiu0102(ElementsYvanchuyaoshouMod instance) {
        super(instance, 65);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "san_xiu_0102"), (int) ENTITYID).name("san_xiu_0102").tracker(64, 3, true).egg(-16724737, -26317).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelalex(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntitySanXiu0102.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/lian_qi_0102.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntitySanXiu0102$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntitySanXiu0102.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntitySanXiu0102.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntitySanXiu0102.$_dependencies.put("entity", this);
            EntitySanXiu0102.$_dependencies.put("x", Integer.valueOf(x));
            EntitySanXiu0102.$_dependencies.put("y", Integer.valueOf(y));
            EntitySanXiu0102.$_dependencies.put("z", Integer.valueOf(z));
            EntitySanXiu0102.$_dependencies.put("world", this.field_70170_p);
            ProcedureSanXiuDie.executeProcedure(EntitySanXiu0102.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntitySanXiu0102.$_dependencies.put("entity", this);
            EntitySanXiu0102.$_dependencies.put("world", this.field_70170_p);
            ProcedureSanXiuUpdate.executeProcedure(EntitySanXiu0102.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntitySanXiu0102$Modelalex.class */
