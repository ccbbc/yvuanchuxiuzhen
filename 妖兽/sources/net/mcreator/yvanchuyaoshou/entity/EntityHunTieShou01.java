...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou01.class */
public class EntityHunTieShou01 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 172;
    public static final int ENTITYID_RANGED = 173;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityHunTieShou01(ElementsYvanchuyaoshouMod instance) {
        super(instance, 83);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "hun_tie_shou_01"), (int) ENTITYID).name("hun_tie_shou_01").tracker((int) EntityMoXiu02.ENTITYID, 3, true).egg(-13421773, -6750208).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelhun_tie_shou(), 1.2f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityHunTieShou01.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou01$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityHunTieShou01.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityHunTieShou01.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityHunTieShou01.$_dependencies.put("entity", this);
            EntityHunTieShou01.$_dependencies.put("x", Integer.valueOf(x));
            EntityHunTieShou01.$_dependencies.put("y", Integer.valueOf(y));
            EntityHunTieShou01.$_dependencies.put("z", Integer.valueOf(z));
            EntityHunTieShou01.$_dependencies.put("world", this.field_70170_p);
            ProcedureHunTieShouDie.executeProcedure(EntityHunTieShou01.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityHunTieShou01.$_dependencies.put("entity", this);
            EntityHunTieShou01.$_dependencies.put("world", this.field_70170_p);
            ProcedureHunTieShouUpdate.executeProcedure(EntityHunTieShou01.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou01$Modelhun_tie_shou.class */
