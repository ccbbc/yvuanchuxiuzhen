...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou03.class */
public class EntityHunTieShou03 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 184;
    public static final int ENTITYID_RANGED = 185;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityHunTieShou03(ElementsYvanchuyaoshouMod instance) {
        super(instance, 85);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "hun_tie_shou_03"), (int) ENTITYID).name("hun_tie_shou_03").tracker((int) EntityMoXiu02.ENTITYID, 3, true).egg(-13421773, -6750208).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelhun_tie_shou(), 1.2f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityHunTieShou03.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou03$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityHunTieShou03.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityHunTieShou03.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityHunTieShou03.$_dependencies.put("entity", this);
            EntityHunTieShou03.$_dependencies.put("x", Integer.valueOf(x));
            EntityHunTieShou03.$_dependencies.put("y", Integer.valueOf(y));
            EntityHunTieShou03.$_dependencies.put("z", Integer.valueOf(z));
            EntityHunTieShou03.$_dependencies.put("world", this.field_70170_p);
            ProcedureHunTieShouDie.executeProcedure(EntityHunTieShou03.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityHunTieShou03.$_dependencies.put("entity", this);
            EntityHunTieShou03.$_dependencies.put("world", this.field_70170_p);
            ProcedureHunTieShouUpdate.executeProcedure(EntityHunTieShou03.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHunTieShou03$Modelhun_tie_shou.class */
