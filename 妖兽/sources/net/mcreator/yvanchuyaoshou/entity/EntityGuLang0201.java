...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0201.class */
public class EntityGuLang0201 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 144;
    public static final int ENTITYID_RANGED = 145;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityGuLang0201(ElementsYvanchuyaoshouMod instance) {
        super(instance, 80);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "gu_lang_0201"), (int) ENTITYID).name("gu_lang_0201").tracker(64, 3, true).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelcaientity16(), 0.7f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityGuLang0201.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0201$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityGuLang0201.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityGuLang0201.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityGuLang0201.$_dependencies.put("entity", this);
            EntityGuLang0201.$_dependencies.put("x", Integer.valueOf(x));
            EntityGuLang0201.$_dependencies.put("y", Integer.valueOf(y));
            EntityGuLang0201.$_dependencies.put("z", Integer.valueOf(z));
            EntityGuLang0201.$_dependencies.put("world", this.field_70170_p);
            ProcedureGuLangDie.executeProcedure(EntityGuLang0201.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityGuLang0201.$_dependencies.put("entity", this);
            EntityGuLang0201.$_dependencies.put("world", this.field_70170_p);
            ProcedureGuLangUpdate.executeProcedure(EntityGuLang0201.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0201$Modelcaientity16.class */
