...
import net.mcreator.yvanchuyaoshou.procedure.ProcedureTianGongDie;
import net.mcreator.yvanchuyaoshou.procedure.ProcedureTianGongUpdate;
...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong3.class */
public class EntityTianGong3 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 218;
    public static final int ENTITYID_RANGED = 219;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityTianGong3(ElementsYvanchuyaoshouMod instance) {
        super(instance, 97);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "tian_gong_3"), (int) ENTITYID).name("tian_gong_3").tracker(64, 3, true).egg(-13312, -26266).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityTianGong3.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/tong_tian_jiao_zhu.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong3$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityTianGong3.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityTianGong3.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityTianGong3.$_dependencies.put("entity", this);
            EntityTianGong3.$_dependencies.put("x", Integer.valueOf(x));
            EntityTianGong3.$_dependencies.put("y", Integer.valueOf(y));
            EntityTianGong3.$_dependencies.put("z", Integer.valueOf(z));
            EntityTianGong3.$_dependencies.put("world", this.field_70170_p);
            ProcedureTianGongDie.executeProcedure(EntityTianGong3.$_dependencies);
        }
        ...
        public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            ...
            int i3 = (int) this.field_70161_v;
            EntityTianGong3.$_dependencies.put("entity", this);
            ProcedureNameSet.executeProcedure(EntityTianGong3.$_dependencies);
            return retval;
        }
        ...
        public void func_70030_z() {
            ...
            EntityTianGong3.$_dependencies.put("z", Integer.valueOf(z));
            EntityTianGong3.$_dependencies.put("world", this.field_70170_p);
            ProcedureTianGongUpdate.executeProcedure(EntityTianGong3.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong3$Modelsteve.class */
