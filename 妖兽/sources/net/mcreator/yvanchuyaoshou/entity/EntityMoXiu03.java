...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu03.class */
public class EntityMoXiu03 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 130;
    public static final int ENTITYID_RANGED = 131;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityMoXiu03(ElementsYvanchuyaoshouMod instance) {
        super(instance, 72);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "mo_xiu_03"), (int) ENTITYID).name("mo_xiu_03").tracker(64, 3, true).egg(-10092391, -26317).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityMoXiu03.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/jie_dan_0201.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu03$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityMoXiu03.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityMoXiu03.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityMoXiu03.$_dependencies.put("entity", this);
            EntityMoXiu03.$_dependencies.put("x", Integer.valueOf(x));
            EntityMoXiu03.$_dependencies.put("y", Integer.valueOf(y));
            EntityMoXiu03.$_dependencies.put("z", Integer.valueOf(z));
            EntityMoXiu03.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuDie.executeProcedure(EntityMoXiu03.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityMoXiu03.$_dependencies.put("entity", this);
            EntityMoXiu03.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuUpdate.executeProcedure(EntityMoXiu03.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu03$Modelsteve.class */
