...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu05.class */
public class EntityMoXiu05 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 134;
    public static final int ENTITYID_RANGED = 135;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityMoXiu05(ElementsYvanchuyaoshouMod instance) {
        super(instance, 74);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "mo_xiu_05"), (int) ENTITYID).name("mo_xiu_05").tracker(64, 3, true).egg(-10092391, -26317).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityMoXiu05.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/hua_shen_0201.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu05$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityMoXiu05.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityMoXiu05.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityMoXiu05.$_dependencies.put("entity", this);
            EntityMoXiu05.$_dependencies.put("x", Integer.valueOf(x));
            EntityMoXiu05.$_dependencies.put("y", Integer.valueOf(y));
            EntityMoXiu05.$_dependencies.put("z", Integer.valueOf(z));
            EntityMoXiu05.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuDie.executeProcedure(EntityMoXiu05.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityMoXiu05.$_dependencies.put("entity", this);
            EntityMoXiu05.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuUpdate.executeProcedure(EntityMoXiu05.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu05$Modelsteve.class */
