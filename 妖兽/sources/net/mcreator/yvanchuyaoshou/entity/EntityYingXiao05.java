...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityYingXiao05.class */
public class EntityYingXiao05 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 66;
    public static final int ENTITYID_RANGED = 67;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityYingXiao05(ElementsYvanchuyaoshouMod instance) {
        super(instance, 36);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "ying_xiao_05"), 66).name("ying_xiao_05").tracker((int) EntityMoXiu02.ENTITYID, 3, true).egg(-10040320, -13159).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelniao_ren(), 1.0f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityYingXiao05.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityYingXiao05$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        protected void func_184651_r() {
            ...
            this.field_70714_bg.func_75776_a(6, new EntityAIWander(this, 1.5d, 20) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityYingXiao05.EntityCustom.1
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityYingXiao05.$_dependencies.put("entity", this);
            ProcedureYingXiaoShouJi.executeProcedure(EntityYingXiao05.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityYingXiao05.$_dependencies.put("entity", this);
            EntityYingXiao05.$_dependencies.put("x", Integer.valueOf(x));
            EntityYingXiao05.$_dependencies.put("y", Integer.valueOf(y));
            EntityYingXiao05.$_dependencies.put("z", Integer.valueOf(z));
            EntityYingXiao05.$_dependencies.put("world", this.field_70170_p);
            ProcedureYingXiaoDie.executeProcedure(EntityYingXiao05.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityYingXiao05.$_dependencies.put("entity", this);
            EntityYingXiao05.$_dependencies.put("world", this.field_70170_p);
            ProcedureYingXiaoUpdate.executeProcedure(EntityYingXiao05.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityYingXiao05$Modelniao_ren.class */
