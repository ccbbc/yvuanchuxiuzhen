...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0501.class */
public class EntityGuLang0501 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 146;
    public static final int ENTITYID_RANGED = 147;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityGuLang0501(ElementsYvanchuyaoshouMod instance) {
        super(instance, 81);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "gu_lang_0501"), (int) ENTITYID).name("gu_lang_0501").tracker(64, 3, true).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelcaientity16(), 0.7f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityGuLang0501.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0501$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityGuLang0501.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityGuLang0501.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityGuLang0501.$_dependencies.put("entity", this);
            EntityGuLang0501.$_dependencies.put("x", Integer.valueOf(x));
            EntityGuLang0501.$_dependencies.put("y", Integer.valueOf(y));
            EntityGuLang0501.$_dependencies.put("z", Integer.valueOf(z));
            EntityGuLang0501.$_dependencies.put("world", this.field_70170_p);
            ProcedureGuLangDie.executeProcedure(EntityGuLang0501.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityGuLang0501.$_dependencies.put("entity", this);
            EntityGuLang0501.$_dependencies.put("world", this.field_70170_p);
            ProcedureGuLangUpdate.executeProcedure(EntityGuLang0501.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0501$Modelcaientity16.class */
