...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu0302.class */
public class EntityMoXiu0302 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 166;
    public static final int ENTITYID_RANGED = 167;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityMoXiu0302(ElementsYvanchuyaoshouMod instance) {
        super(instance, 77);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "mo_xiu_0302"), (int) ENTITYID).name("mo_xiu_0302").tracker(64, 3, true).egg(-10092391, -26317).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelalex(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityMoXiu0302.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/jie_dan_0202.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu0302$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityMoXiu0302.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityMoXiu0302.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityMoXiu0302.$_dependencies.put("entity", this);
            EntityMoXiu0302.$_dependencies.put("x", Integer.valueOf(x));
            EntityMoXiu0302.$_dependencies.put("y", Integer.valueOf(y));
            EntityMoXiu0302.$_dependencies.put("z", Integer.valueOf(z));
            EntityMoXiu0302.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuDie.executeProcedure(EntityMoXiu0302.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityMoXiu0302.$_dependencies.put("entity", this);
            EntityMoXiu0302.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuUpdate.executeProcedure(EntityMoXiu0302.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu0302$Modelalex.class */
