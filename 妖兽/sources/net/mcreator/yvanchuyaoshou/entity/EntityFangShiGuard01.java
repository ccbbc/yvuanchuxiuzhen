...
import net.mcreator.yvanchuyaoshou.procedure.ProcedureFangShiGuardDie;
import net.mcreator.yvanchuyaoshou.procedure.ProcedureFangShiGuardUpDate;
...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityFangShiGuard01.class */
public class EntityFangShiGuard01 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 222;
    public static final int ENTITYID_RANGED = 223;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityFangShiGuard01(ElementsYvanchuyaoshouMod instance) {
        super(instance, 365);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "fang_shi_guard_01"), (int) ENTITYID).name("fang_shi_guard_01").tracker(64, 3, true).egg(-16711732, -3342490).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityFangShiGuard01.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/3_02.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityFangShiGuard01$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityFangShiGuard01.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityFangShiGuard01.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityFangShiGuard01.$_dependencies.put("entity", this);
            EntityFangShiGuard01.$_dependencies.put("x", Integer.valueOf(x));
            EntityFangShiGuard01.$_dependencies.put("y", Integer.valueOf(y));
            EntityFangShiGuard01.$_dependencies.put("z", Integer.valueOf(z));
            EntityFangShiGuard01.$_dependencies.put("world", this.field_70170_p);
            ProcedureFangShiGuardDie.executeProcedure(EntityFangShiGuard01.$_dependencies);
        }
        ...
        public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            ...
            int i3 = (int) this.field_70161_v;
            EntityFangShiGuard01.$_dependencies.put("entity", this);
            ProcedureNameSet.executeProcedure(EntityFangShiGuard01.$_dependencies);
            return retval;
        }
        ...
        public void func_70030_z() {
            ...
            EntityFangShiGuard01.$_dependencies.put("entity", this);
            EntityFangShiGuard01.$_dependencies.put("world", this.field_70170_p);
            ProcedureFangShiGuardUpDate.executeProcedure(EntityFangShiGuard01.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityFangShiGuard01$Modelsteve.class */
