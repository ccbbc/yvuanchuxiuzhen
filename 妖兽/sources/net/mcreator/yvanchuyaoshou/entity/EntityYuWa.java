...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityYuWa.class */
public class EntityYuWa extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 56;
    public static final int ENTITYID_RANGED = 57;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityYuWa(ElementsYvanchuyaoshouMod instance) {
        super(instance, 31);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "yu_wa"), 56).name("yu_wa").tracker(64, 3, true).egg(-6684673, -16737793).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new ModelYvwa(), 0.4f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityYuWa.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityYuWa$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityYuWa.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityYuWa.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityYuWa.$_dependencies.put("entity", this);
            EntityYuWa.$_dependencies.put("x", Integer.valueOf(x));
            EntityYuWa.$_dependencies.put("y", Integer.valueOf(y));
            EntityYuWa.$_dependencies.put("z", Integer.valueOf(z));
            EntityYuWa.$_dependencies.put("world", this.field_70170_p);
            ProcedureYuWaDie.executeProcedure(EntityYuWa.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityYuWa.$_dependencies.put("entity", this);
            EntityYuWa.$_dependencies.put("world", this.field_70170_p);
            ProcedureYuWaUpdate.executeProcedure(EntityYuWa.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityYuWa$ModelYvwa.class */
