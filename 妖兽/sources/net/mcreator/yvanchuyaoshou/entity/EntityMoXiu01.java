...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu01.class */
public class EntityMoXiu01 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 122;
    public static final int ENTITYID_RANGED = 123;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityMoXiu01(ElementsYvanchuyaoshouMod instance) {
        super(instance, 70);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "mo_xiu_01"), (int) ENTITYID).name("mo_xiu_01").tracker(64, 3, true).egg(-10092391, -26317).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityMoXiu01.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/lian_qi_0201.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu01$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityMoXiu01.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityMoXiu01.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityMoXiu01.$_dependencies.put("entity", this);
            EntityMoXiu01.$_dependencies.put("x", Integer.valueOf(x));
            EntityMoXiu01.$_dependencies.put("y", Integer.valueOf(y));
            EntityMoXiu01.$_dependencies.put("z", Integer.valueOf(z));
            EntityMoXiu01.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuDie.executeProcedure(EntityMoXiu01.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityMoXiu01.$_dependencies.put("entity", this);
            EntityMoXiu01.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuUpdate.executeProcedure(EntityMoXiu01.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu01$Modelsteve.class */
