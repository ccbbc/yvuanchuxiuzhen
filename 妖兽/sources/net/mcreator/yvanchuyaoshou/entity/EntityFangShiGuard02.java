...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityFangShiGuard02.class */
public class EntityFangShiGuard02 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 224;
    public static final int ENTITYID_RANGED = 225;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityFangShiGuard02(ElementsYvanchuyaoshouMod instance) {
        super(instance, 368);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "fang_shi_guard_02"), (int) ENTITYID).name("fang_shi_guard_02").tracker(64, 3, true).egg(-16711732, -3342490).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityFangShiGuard02.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/3_20.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityFangShiGuard02$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityFangShiGuard02.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityFangShiGuard02.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityFangShiGuard02.$_dependencies.put("entity", this);
            EntityFangShiGuard02.$_dependencies.put("x", Integer.valueOf(x));
            EntityFangShiGuard02.$_dependencies.put("y", Integer.valueOf(y));
            EntityFangShiGuard02.$_dependencies.put("z", Integer.valueOf(z));
            EntityFangShiGuard02.$_dependencies.put("world", this.field_70170_p);
            ProcedureFangShiGuardDie.executeProcedure(EntityFangShiGuard02.$_dependencies);
        }
        ...
        public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            ...
            int i3 = (int) this.field_70161_v;
            EntityFangShiGuard02.$_dependencies.put("entity", this);
            ProcedureNameSet.executeProcedure(EntityFangShiGuard02.$_dependencies);
            return retval;
        }
        ...
        public void func_70030_z() {
            ...
            EntityFangShiGuard02.$_dependencies.put("entity", this);
            EntityFangShiGuard02.$_dependencies.put("world", this.field_70170_p);
            ProcedureFangShiGuardUpDate.executeProcedure(EntityFangShiGuard02.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityFangShiGuard02$Modelsteve.class */
