...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityLeiBanLu05.class */
public class EntityLeiBanLu05 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 80;
    public static final int ENTITYID_RANGED = 81;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityLeiBanLu05(ElementsYvanchuyaoshouMod instance) {
        super(instance, 50);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "lei_ban_lu_05"), 80).name("lei_ban_lu_05").tracker(64, 3, true).egg(-655488, -3828663).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modellei_ban_lu(), 1.0f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityLeiBanLu05.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityLeiBanLu05$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public void func_70077_a(EntityLightningBolt entityLightningBolt) {
            ...
            EntityLeiBanLu05.$_dependencies.put("entity", this);
            ProcedureCaientity18ItIsStruckByLightning.executeProcedure(EntityLeiBanLu05.$_dependencies);
        }
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityLeiBanLu05.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityLeiBanLu05.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityLeiBanLu05.$_dependencies.put("entity", this);
            EntityLeiBanLu05.$_dependencies.put("x", Integer.valueOf(x));
            EntityLeiBanLu05.$_dependencies.put("y", Integer.valueOf(y));
            EntityLeiBanLu05.$_dependencies.put("z", Integer.valueOf(z));
            EntityLeiBanLu05.$_dependencies.put("world", this.field_70170_p);
            ProcedureLeiBanLuDie.executeProcedure(EntityLeiBanLu05.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityLeiBanLu05.$_dependencies.put("entity", this);
            EntityLeiBanLu05.$_dependencies.put("world", this.field_70170_p);
            ProcedureLeiBanLuUpdate.executeProcedure(EntityLeiBanLu05.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityLeiBanLu05$Modellei_ban_lu.class */
