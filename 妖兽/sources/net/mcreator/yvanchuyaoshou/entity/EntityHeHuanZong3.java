...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHeHuanZong3.class */
public class EntityHeHuanZong3 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 210;
    public static final int ENTITYID_RANGED = 211;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityHeHuanZong3(ElementsYvanchuyaoshouMod instance) {
        super(instance, 93);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "he_huan_zong_3"), (int) ENTITYID).name("he_huan_zong_3").tracker(64, 3, true).egg(-10092391, -26317).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityHeHuanZong3.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/he_huan_zong_3.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHeHuanZong3$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        protected void func_184651_r() {
            ...
            this.field_70715_bh.func_75776_a(10, new EntityAINearestAttackableTarget(this, EntitySanXiu0402.EntityCustom.class, true, true));
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityHeHuanZong3.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityHeHuanZong3.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityHeHuanZong3.$_dependencies.put("entity", this);
            EntityHeHuanZong3.$_dependencies.put("x", Integer.valueOf(x));
            EntityHeHuanZong3.$_dependencies.put("y", Integer.valueOf(y));
            EntityHeHuanZong3.$_dependencies.put("z", Integer.valueOf(z));
            EntityHeHuanZong3.$_dependencies.put("world", this.field_70170_p);
            ProcedureHeHuanZongDie.executeProcedure(EntityHeHuanZong3.$_dependencies);
        }
        ...
        public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            ...
            int i3 = (int) this.field_70161_v;
            EntityHeHuanZong3.$_dependencies.put("entity", this);
            ProcedureNameSet.executeProcedure(EntityHeHuanZong3.$_dependencies);
            return retval;
        }
        ...
        public void func_70030_z() {
            ...
            EntityHeHuanZong3.$_dependencies.put("z", Integer.valueOf(z));
            EntityHeHuanZong3.$_dependencies.put("world", this.field_70170_p);
            ProcedureHeHuanZongUpdate.executeProcedure(EntityHeHuanZong3.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityHeHuanZong3$Modelsteve.class */
