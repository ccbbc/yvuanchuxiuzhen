...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong1.class */
public class EntityTianGong1 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 212;
    public static final int ENTITYID_RANGED = 213;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityTianGong1(ElementsYvanchuyaoshouMod instance) {
        super(instance, 94);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "tian_gong_1"), (int) ENTITYID).name("tian_gong_1").tracker(64, 3, true).egg(-13312, -26266).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityTianGong1.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong1$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityTianGong1.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityTianGong1.$_dependencies);
        ...
        public IEntityLivingData func_180482_a(DifficultyInstance difficulty, IEntityLivingData livingdata) {
            ...
            int i3 = (int) this.field_70161_v;
            EntityTianGong1.$_dependencies.put("entity", this);
            ProcedureNameSet.executeProcedure(EntityTianGong1.$_dependencies);
            return retval;
        }
        ...
        public void func_70030_z() {
            ...
            EntityTianGong1.$_dependencies.put("entity", this);
            EntityTianGong1.$_dependencies.put("x", Integer.valueOf(x));
            EntityTianGong1.$_dependencies.put("y", Integer.valueOf(y));
            EntityTianGong1.$_dependencies.put("z", Integer.valueOf(z));
            EntityTianGong1.$_dependencies.put("world", this.field_70170_p);
            ProcedureTianGongUpdate.executeProcedure(EntityTianGong1.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityTianGong1$Modelsteve.class */
