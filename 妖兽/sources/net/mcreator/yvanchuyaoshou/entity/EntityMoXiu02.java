...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu02.class */
public class EntityMoXiu02 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 128;
    public static final int ENTITYID_RANGED = 129;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityMoXiu02(ElementsYvanchuyaoshouMod instance) {
        super(instance, 71);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "mo_xiu_02"), (int) ENTITYID).name("mo_xiu_02").tracker(64, 3, true).egg(-10092391, -26317).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelsteve(), 0.5f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityMoXiu02.1
                protected ResourceLocation func_110775_a(Entity entity) {
                    return new ResourceLocation("yvanchuyaoshou:textures/zhu_ji_0201.png");
                }
            };
        });
    }

    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu02$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityMoXiu02.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityMoXiu02.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityMoXiu02.$_dependencies.put("entity", this);
            EntityMoXiu02.$_dependencies.put("x", Integer.valueOf(x));
            EntityMoXiu02.$_dependencies.put("y", Integer.valueOf(y));
            EntityMoXiu02.$_dependencies.put("z", Integer.valueOf(z));
            EntityMoXiu02.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuDie.executeProcedure(EntityMoXiu02.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityMoXiu02.$_dependencies.put("entity", this);
            EntityMoXiu02.$_dependencies.put("world", this.field_70170_p);
            ProcedureMoXiuUpdate.executeProcedure(EntityMoXiu02.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityMoXiu02$Modelsteve.class */
