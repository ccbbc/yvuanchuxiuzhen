...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityLinHaiShouHuang05.class */
public class EntityLinHaiShouHuang05 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 88;
    public static final int ENTITYID_RANGED = 89;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityLinHaiShouHuang05(ElementsYvanchuyaoshouMod instance) {
        super(instance, 54);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "lin_hai_shou_huang_05"), 88).name("lin_hai_shou_huang_05").tracker(64, 3, true).egg(-256, -3368704).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelcaientity09(), 2.0f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityLinHaiShouHuang05.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityLinHaiShouHuang05$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityLinHaiShouHuang05.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityLinHaiShouHuang05.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityLinHaiShouHuang05.$_dependencies.put("entity", this);
            EntityLinHaiShouHuang05.$_dependencies.put("x", Integer.valueOf(x));
            EntityLinHaiShouHuang05.$_dependencies.put("y", Integer.valueOf(y));
            EntityLinHaiShouHuang05.$_dependencies.put("z", Integer.valueOf(z));
            EntityLinHaiShouHuang05.$_dependencies.put("world", this.field_70170_p);
            ProcedureLinHaiShouHuangDie.executeProcedure(EntityLinHaiShouHuang05.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityLinHaiShouHuang05.$_dependencies.put("entity", this);
            EntityLinHaiShouHuang05.$_dependencies.put("world", this.field_70170_p);
            ProcedureLinHaiShouHuangUpdate.executeProcedure(EntityLinHaiShouHuang05.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityLinHaiShouHuang05$Modelcaientity09.class */
