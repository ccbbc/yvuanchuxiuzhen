...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0401.class */
public class EntityGuLang0401 extends ElementsYvanchuyaoshouMod.ModElement {
    public static final int ENTITYID = 148;
    public static final int ENTITYID_RANGED = 149;
    static Map<String, Object> $_dependencies = new HashMap();

    public EntityGuLang0401(ElementsYvanchuyaoshouMod instance) {
        super(instance, 82);
    }
    ...
    public void initElements() {
        this.elements.entities.add(() -> {
            return EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation(YvanchuyaoshouMod.MODID, "gu_lang_0401"), (int) ENTITYID).name("gu_lang_0401").tracker(64, 3, true).build();
        });
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
            return new RenderLiving(renderManager, new Modelcaientity16(), 0.7f) { // from class: net.mcreator.yvanchuyaoshou.entity.EntityGuLang0401.1
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0401$EntityCustom.class */
    public static class EntityCustom extends EntityMob {
        ...
        public boolean func_70097_a(DamageSource source, float amount) {
            ...
            source.func_76346_g();
            EntityGuLang0401.$_dependencies.put("entity", this);
            ProcedureShouJiNbt.executeProcedure(EntityGuLang0401.$_dependencies);
        ...
        public void func_70645_a(DamageSource source) {
            ...
            EntityGuLang0401.$_dependencies.put("entity", this);
            EntityGuLang0401.$_dependencies.put("x", Integer.valueOf(x));
            EntityGuLang0401.$_dependencies.put("y", Integer.valueOf(y));
            EntityGuLang0401.$_dependencies.put("z", Integer.valueOf(z));
            EntityGuLang0401.$_dependencies.put("world", this.field_70170_p);
            ProcedureGuLangDie.executeProcedure(EntityGuLang0401.$_dependencies);
        }
        ...
        public void func_70030_z() {
            ...
            EntityGuLang0401.$_dependencies.put("entity", this);
            EntityGuLang0401.$_dependencies.put("world", this.field_70170_p);
            ProcedureGuLangUpdate.executeProcedure(EntityGuLang0401.$_dependencies);
        }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/entity/EntityGuLang0401$Modelcaientity16.class */
