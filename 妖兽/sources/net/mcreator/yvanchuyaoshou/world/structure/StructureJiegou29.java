...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/world/structure/StructureJiegou29.class */
public class StructureJiegou29 extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public StructureJiegou29(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityMoXiu03.ENTITYID_RANGED);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 100000) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (biomeCriteria) {
                    if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YvanchuyaoshouMod.MODID, "jiegou29"))) == null) {
                        return;
                    }
