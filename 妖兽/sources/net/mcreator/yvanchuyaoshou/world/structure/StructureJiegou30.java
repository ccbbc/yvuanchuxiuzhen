...
import net.mcreator.yvanchuyaoshou.procedure.ProcedureJiegou30OnStructureInstanceGenerated;
...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/world/structure/StructureJiegou30.class */
public class StructureJiegou30 extends ElementsYvanchuyaoshouMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public StructureJiegou30(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntityYuWa2.ENTITYID);
    }
    ...
    public void generateWorld(Random random, int i2, int k2, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
        ...
        if (dimensionCriteria && random.nextInt(1000000) + 1 <= 50000) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (((ResourceLocation) Biome.field_185377_q.func_177774_c(biome)).equals(new ResourceLocation("yvanchuyaoshou:shengtai17"))) {
                    biomeCriteria = true;
                }
                if (((ResourceLocation) Biome.field_185377_q.func_177774_c(biome)).equals(new ResourceLocation("yvanchuyaoshou:shengtai21"))) {
                    biomeCriteria = true;
                }
                if (biomeCriteria) {
                    if (world.field_72995_K || (template = ((WorldServer) world).func_184163_y().func_186237_a(world.func_73046_m(), new ResourceLocation(YvanchuyaoshouMod.MODID, "jiegou30"))) == null) {
                        return;
                    }
                    ...
                    ProcedureJiegou30OnStructureInstanceGenerated.executeProcedure($_dependencies);
                }
            }
        }
    }
