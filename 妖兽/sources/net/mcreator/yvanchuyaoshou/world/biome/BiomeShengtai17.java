...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/world/biome/BiomeShengtai17.class */
public class BiomeShengtai17 extends ElementsYvanchuyaoshouMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuyaoshou:shengtai17")
    public static final BiomeGenCustom biome = null;

    public BiomeShengtai17(ElementsYvanchuyaoshouMod instance) {
        super(instance, 111);
    }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/world/biome/BiomeShengtai17$BiomeGenCustom.class */
    public static class BiomeGenCustom extends Biome {
        public BiomeGenCustom() {
            super(new Biome.BiomeProperties("破碎山石岭").func_185395_b(0.5f).func_185398_c(1.0f).func_185402_a(-14329397).func_185400_d(2.0f).func_185410_a(1.0f));
            setRegistryName("shengtai17");
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/world/biome/BiomeShengtai17$CustomTree.class */
    static class CustomTree extends WorldGenAbstractTree {
        ...
        public boolean func_180709_b(World world, Random rand, BlockPos position) {
            ...
            if (position.func_177956_o() >= 1 && position.func_177956_o() + height + 1 <= world.func_72800_K()) {
                ...
                if (ground == Blocks.field_150348_b.func_176203_a(0).func_177230_c() || ground == Blocks.field_150348_b.func_176203_a(0).func_177230_c()) {
                    if (ground2 != Blocks.field_150348_b.func_176203_a(0).func_177230_c() && ground2 != Blocks.field_150348_b.func_176203_a(0).func_177230_c()) {
                        return false;
                    }
                    ...
                    if (position.func_177956_o() < (world.func_72800_K() - height) - 1) {
                            ...
                            for (int k1 = position.func_177958_n() - j1; k1 <= position.func_177958_n() + j1; k1++) {
                                for (int i2 = position.func_177952_p() - j1; i2 <= position.func_177952_p() + j1; i2++) {
                                    ...
                                    if (Math.abs(position.func_177958_n()) != j1 || Math.abs(j2) != j1 || (rand.nextInt(2) != 0 && i4 != 0)) {
                                        ...
                                        if (state.func_177230_c().isAir(state, world, blockpos) || state.func_177230_c().isLeaves(state, world, blockpos) || state.func_177230_c() == Blocks.field_150348_b.func_176203_a(0).func_177230_c() || state.func_177230_c() == Blocks.field_150350_a.func_176223_P().func_177230_c()) {
                        ...
                        for (int genh2 = 0; genh2 < height; genh2++) {
                            ...
                            if (state2.func_177230_c().isAir(state2, world, genhPos) || state2.func_177230_c() == Blocks.field_150348_b.func_176203_a(0).func_177230_c() || state2.func_177230_c() == Blocks.field_150350_a.func_176223_P().func_177230_c()) {
                                func_175903_a(world, position.func_177981_b(genh2), Blocks.field_150348_b.func_176203_a(0));
                                if (genh2 > 0) {
                                    if (rand.nextInt(3) > 0 && world.func_175623_d(position.func_177982_a(-1, genh2, 0))) {
                                        func_175903_a(world, position.func_177982_a(-1, genh2, 0), Blocks.field_150348_b.func_176203_a(0));
                                    }
                                    if (rand.nextInt(3) > 0 && world.func_175623_d(position.func_177982_a(1, genh2, 0))) {
                                        func_175903_a(world, position.func_177982_a(1, genh2, 0), Blocks.field_150348_b.func_176203_a(0));
                                    }
                                    if (rand.nextInt(3) > 0 && world.func_175623_d(position.func_177982_a(0, genh2, -1))) {
                                        func_175903_a(world, position.func_177982_a(0, genh2, -1), Blocks.field_150348_b.func_176203_a(0));
                                    }
                                    if (rand.nextInt(3) > 0 && world.func_175623_d(position.func_177982_a(0, genh2, 1))) {
                                        func_175903_a(world, position.func_177982_a(0, genh2, 1), Blocks.field_150348_b.func_176203_a(0));
                                    }
        ...
        private void addVines(World world, BlockPos pos) {
            ...
            for (int i = 5; world.func_175623_d(blockpos) && i > 0; i--) {
                func_175903_a(world, blockpos, Blocks.field_150348_b.func_176203_a(0));
                blockpos = blockpos.func_177977_b();
            }
        }

        protected boolean func_150523_a(Block blockType) {
            return blockType.func_176223_P().func_185904_a() == Material.field_151579_a || blockType == Blocks.field_150348_b.func_176203_a(0).func_177230_c() || blockType == Blocks.field_150350_a.func_176223_P().func_177230_c() || blockType == Blocks.field_150348_b.func_176203_a(0).func_177230_c() || blockType == Blocks.field_150348_b.func_176203_a(0).func_177230_c();
        }
