...
/* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/world/biome/BiomeShengtai15.class */
public class BiomeShengtai15 extends ElementsYvanchuyaoshouMod.ModElement {
    @GameRegistry.ObjectHolder("yvanchuyaoshou:shengtai15")
    public static final BiomeGenCustom biome = null;

    public BiomeShengtai15(ElementsYvanchuyaoshouMod instance) {
        super(instance, EntitySanXiu03.ENTITYID);
    }
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/world/biome/BiomeShengtai15$BiomeGenCustom.class */
    public static class BiomeGenCustom extends Biome {
        public BiomeGenCustom() {
            super(new Biome.BiomeProperties("雷击地").func_185395_b(1.0f).func_185398_c(0.0f).func_185402_a(-205).func_185400_d(0.0f).func_185410_a(0.5f));
            setRegistryName("shengtai15");
            this.field_76752_A = Blocks.field_150346_d.func_176203_a(0);
    ...
    /* loaded from: 妖兽-mc1.12.2-2.0.16.jar:net/mcreator/yvanchuyaoshou/world/biome/BiomeShengtai15$CustomTree.class */
    static class CustomTree extends WorldGenAbstractTree {
        ...
        public boolean func_180709_b(World world, Random rand, BlockPos position) {
            ...
            if (position.func_177956_o() >= 1 && position.func_177956_o() + height + 1 <= world.func_72800_K()) {
                ...
                if (ground == Blocks.field_150346_d.func_176203_a(0).func_177230_c() || ground == Blocks.field_150348_b.func_176203_a(0).func_177230_c()) {
                    if (ground2 != Blocks.field_150346_d.func_176203_a(0).func_177230_c() && ground2 != Blocks.field_150348_b.func_176203_a(0).func_177230_c()) {
                        return false;
                    }
        ...
        protected boolean func_150523_a(Block blockType) {
            return blockType.func_176223_P().func_185904_a() == Material.field_151579_a || blockType == Blocks.field_150350_a.func_176223_P().func_177230_c() || blockType == Blocks.field_150350_a.func_176223_P().func_177230_c() || blockType == Blocks.field_150346_d.func_176203_a(0).func_177230_c() || blockType == Blocks.field_150348_b.func_176203_a(0).func_177230_c();
        }
