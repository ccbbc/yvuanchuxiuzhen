...
/* loaded from: 修仙指南0.4.jar:net/mcreator/yindaoshu/YindaoshuModVariables.class */
public class YindaoshuModVariables {

    /* loaded from: 修仙指南0.4.jar:net/mcreator/yindaoshu/YindaoshuModVariables$MapVariables.class */
    public static class MapVariables extends WorldSavedData {
        public static final String DATA_NAME = "yindaoshu_mapvars";
        ...
        public void syncData(World world) {
            ...
            if (world.field_72995_K) {
                YindaoshuMod.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(0, this));
            } else {
                YindaoshuMod.PACKET_HANDLER.sendToAll(new WorldSavedDataSyncMessage(0, this));
            }
        }
    ...
    /* loaded from: 修仙指南0.4.jar:net/mcreator/yindaoshu/YindaoshuModVariables$WorldVariables.class */
    public static class WorldVariables extends WorldSavedData {
        public static final String DATA_NAME = "yindaoshu_worldvars";
        ...
        public void syncData(World world) {
            func_76185_a();
            if (world.field_72995_K) {
                YindaoshuMod.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(1, this));
            } else {
                YindaoshuMod.PACKET_HANDLER.sendToDimension(new WorldSavedDataSyncMessage(1, this), world.field_73011_w.getDimension());
            }
        }
    ...
    /* loaded from: 修仙指南0.4.jar:net/mcreator/yindaoshu/YindaoshuModVariables$WorldSavedDataSyncMessageHandler.class */
    public static class WorldSavedDataSyncMessageHandler implements IMessageHandler<WorldSavedDataSyncMessage, IMessage> {
        ...
        private void syncData(WorldSavedDataSyncMessage message, MessageContext context, World world) {
            if (context.side == Side.SERVER) {
                ...
                if (message.type == 0) {
                    YindaoshuMod.PACKET_HANDLER.sendToAll(message);
                } else {
                    YindaoshuMod.PACKET_HANDLER.sendToDimension(message, world.field_73011_w.getDimension());
                }
            }
            if (message.type == 0) {
    ...
    /* loaded from: 修仙指南0.4.jar:net/mcreator/yindaoshu/YindaoshuModVariables$WorldSavedDataSyncMessage.class */
