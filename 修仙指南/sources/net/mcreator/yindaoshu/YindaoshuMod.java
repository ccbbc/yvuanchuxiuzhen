...
import net.mcreator.yindaoshu.ElementsYindaoshuMod;
...
@Mod(modid = YindaoshuMod.MODID, version = YindaoshuMod.VERSION)
/* loaded from: 修仙指南0.4.jar:net/mcreator/yindaoshu/YindaoshuMod.class */
public class YindaoshuMod {
    public static final String MODID = "yindaoshu";
    public static final String VERSION = "1.0.0";
    public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("yindaoshu:a");
    @SidedProxy(clientSide = "net.mcreator.yindaoshu.ClientProxyYindaoshuMod", serverSide = "net.mcreator.yindaoshu.ServerProxyYindaoshuMod")
    public static IProxyYindaoshuMod proxy;
    @Mod.Instance(MODID)
    public static YindaoshuMod instance;
    public ElementsYindaoshuMod elements = new ElementsYindaoshuMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsYindaoshuMod.GuiHandler());
