...
/* loaded from: 飞行法器-mc1.12.2-1.9.0.jar:edebe/flyinginstrument/entity/EntityFlyingInstrument.class */
public class EntityFlyingInstrument extends EntityLiving implements IFlyingInstrumentEntity {
    private static final String NBT_KEY_ITEMSTACK = "ItemStack";
    private static final String NBT_KEY_OWNER_UUID = "OwnerUniqueID";
    private static final DataParameter<ItemStack> SWORD_ITEM_STACK = EntityDataManager.func_187226_a(EntityFlyingInstrument.class, DataSerializers.field_187196_f);
    private static final DataParameter<Byte> CONTROL_STATE = EntityDataManager.func_187226_a(EntityFlyingInstrument.class, DataSerializers.field_187191_a);
    protected static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.func_187226_a(EntityFlyingInstrument.class, DataSerializers.field_187203_m);
    protected double mountedYOffset;
    protected boolean shouldRiderSit;

    public EntityFlyingInstrument(World worldIn) {
        super(worldIn);
        func_184224_h(true);
    }

    public EntityFlyingInstrument(World worldIn, ItemStack stackIn, EntityPlayer playerIn) {
        this(worldIn);
