...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/command/CommandRc2.class */
public class CommandRc2 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public CommandRc2(ElementsYvanchujiguanMod instance) {
        super(instance, 230);
    }
    ...
    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/command/CommandRc2$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public boolean func_184882_a(MinecraftServer server, ICommandSender var1) {
            return var1.func_70003_b(0, "rc2");
        }
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                CommandRc2.$_dependencies.put("entity", entity);
                ProcedureSanGongShow2.executeProcedure(CommandRc2.$_dependencies);
            }
        }
    }
}
