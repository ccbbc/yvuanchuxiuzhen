...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/command/CommandRc3.class */
public class CommandRc3 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public CommandRc3(ElementsYvanchujiguanMod instance) {
        super(instance, 231);
    }
    ...
    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/command/CommandRc3$CommandHandler.class */
    public static class CommandHandler implements ICommand {
        ...
        public boolean func_184882_a(MinecraftServer server, ICommandSender var1) {
            return var1.func_70003_b(0, "rc3");
        }
        ...
        public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                CommandRc3.$_dependencies.put("entity", entity);
                ProcedureSanGongShow3.executeProcedure(CommandRc3.$_dependencies);
            }
        }
    }
}
