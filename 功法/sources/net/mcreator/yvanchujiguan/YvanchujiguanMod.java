...
@Mod(modid = YvanchujiguanMod.MODID, version = YvanchujiguanMod.VERSION)
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/YvanchujiguanMod.class */
public class YvanchujiguanMod {
    public static final String MODID = "yvanchujiguan";
    public static final String VERSION = "1.5.5";
    public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("yvanchujiguan:a");
    @SidedProxy(clientSide = "net.mcreator.yvanchujiguan.ClientProxyYvanchujiguanMod", serverSide = "net.mcreator.yvanchujiguan.ServerProxyYvanchujiguanMod")
    public static IProxyYvanchujiguanMod proxy;
    @Mod.Instance(MODID)
    public static YvanchujiguanMod instance;
    public ElementsYvanchujiguanMod elements = new ElementsYvanchujiguanMod();
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsYvanchujiguanMod.GuiHandler());
