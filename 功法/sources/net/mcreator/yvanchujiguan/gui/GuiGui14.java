...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/gui/GuiGui14.class */
public class GuiGui14 extends ElementsYvanchujiguanMod.ModElement {
    public static int GUIID = 17;
    public static HashMap guistate = new HashMap();
    static Map<String, Object> $_dependencies = new HashMap();

    public GuiGui14(ElementsYvanchujiguanMod instance) {
        super(instance, 197);
    }
    ...
    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/gui/GuiGui14$GuiContainerMod.class */
    public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
        ...
        */
        protected boolean func_75135_a(net.minecraft.item.ItemStack r5, int r6, int r7, boolean r8) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: net.mcreator.yvanchujiguan.gui.GuiGui14.GuiContainerMod.func_75135_a(net.minecraft.item.ItemStack, int, int, boolean):boolean");
        }
        ...
        private void slotChanged(int slotid, int ctype, int meta) {
            if (this.world != null && this.world.field_72995_K) {
                ...
                GuiGui14.handleSlotAction(this.entity, slotid, ctype, meta, this.x, this.y, this.z);
            }
        }
    }

    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/gui/GuiGui14$GuiWindow.class */
    public static class GuiWindow extends GuiContainer {
        ...
        protected void func_146976_a(float par1, int par2, int par3) {
            ...
            this.field_146297_k.field_71446_o.func_110577_a(new ResourceLocation("yvanchujiguan:textures/xuan_bing_jue_.png"));
        ...
        protected void func_146284_a(GuiButton button) {
            ...
            GuiGui14.handleButtonAction(this.entity, button.field_146127_k, this.x, this.y, this.z);
        }
    ...
    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/gui/GuiGui14$GUIButtonPressedMessageHandler.class */
    public static class GUIButtonPressedMessageHandler implements IMessageHandler<GUIButtonPressedMessage, IMessage> {
        public IMessage onMessage(GUIButtonPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiGui14.handleButtonAction(entity, buttonID, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/gui/GuiGui14$GUISlotChangedMessageHandler.class */
    public static class GUISlotChangedMessageHandler implements IMessageHandler<GUISlotChangedMessage, IMessage> {
        public IMessage onMessage(GUISlotChangedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                ...
                int y = message.y;
                int z = message.z;
                GuiGui14.handleSlotAction(entity, slotID, changeType, meta, x, y, z);
            });
            return null;
        }
    }

    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/gui/GuiGui14$GUIButtonPressedMessage.class */
    ...
    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/gui/GuiGui14$GUISlotChangedMessage.class */
