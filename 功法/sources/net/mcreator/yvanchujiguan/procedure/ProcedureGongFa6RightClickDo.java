...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa6RightClickDo.class */
public class ProcedureGongFa6RightClickDo extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa6RightClickDo(ElementsYvanchujiguanMod instance) {
        super(instance, 57);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entityPlayer.getEntityData().func_74769_h("GongFa6") != 0.0d) {
            if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals(entityPlayer.func_145748_c_().func_150260_c()) && !entityPlayer.getEntityData().func_74779_i("GongFaShow").equals("")) {
                if (entityPlayer.getEntityData().func_74767_n("MuLingGen")) {
                    ...
                    entityPlayer.getEntityData().func_74780_a("GongFa", 6.0d);
                    entityPlayer.getEntityData().func_74778_a("GongFaShow", "青元剑诀");
        ...
        if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
            if (entityPlayer.getEntityData().func_74779_i("GongFaShow").equals("")) {
                if (entityPlayer.getEntityData().func_74769_h("GongFa6") == 0.0d && entityPlayer.getEntityData().func_74767_n("MuLingGen") && entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 1.0d) {
                    ProcedureGongFaMingXianShi.executeProcedure($_dependencies);
                    entityPlayer.getEntityData().func_74780_a("GongFa6", 1.0d);
                    entityPlayer.getEntityData().func_74780_a("GongFa", 6.0d);
                    if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
