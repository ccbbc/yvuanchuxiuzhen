...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa29RightClickDoing.class */
public class ProcedureGongFa29RightClickDoing extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa29RightClickDoing(ElementsYvanchujiguanMod instance) {
        super(instance, 133);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("b") : "").equals("")) {
            ...
            if (entityPlayer.getEntityData().func_74769_h("GongFa29") != 0.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("GongFa", 29.0d);
        ...
        if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("a") : "").equals("")) {
            if (!entityPlayer.func_70093_af()) {
                if (entityPlayer.getEntityData().func_74779_i("DaoLv").equals("") && entityPlayer.getEntityData().func_74769_h("GongFa29") != 0.0d) {
                    entityPlayer.getEntityData().func_74780_a("GongFa", 29.0d);
                    entityPlayer.getEntityData().func_74780_a("GongFa29", 1.0d);
                    entityPlayer.getEntityData().func_74778_a("GongFaShow", "阴阳合欢功");
        ...
        } else if (entityPlayer.getEntityData().func_74779_i("GongFaShow").equals("")) {
            if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("a") : "").equals(entityPlayer.func_145748_c_().func_150260_c()) && !entityPlayer.func_70093_af()) {
                if (entityPlayer.getEntityData().func_74779_i("DaoLv").equals("")) {
                    ...
                    if (!((Entity) entityPlayer).field_70170_p.field_72995_K && ((Entity) entityPlayer).field_70170_p.func_73046_m() != null) {
                        ((Entity) entityPlayer).field_70170_p.func_73046_m().func_71187_D().func_71556_a(new ICommandSender() { // from class: net.mcreator.yvanchujiguan.procedure.ProcedureGongFa29RightClickDoing.1
