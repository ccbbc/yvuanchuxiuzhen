...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa25RightClickDo.class */
public class ProcedureGongFa25RightClickDo extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa25RightClickDo(ElementsYvanchujiguanMod instance) {
        super(instance, 92);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entityPlayer.func_70093_af()) {
            if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals(entityPlayer.func_145748_c_().func_150260_c())) {
                if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
                    if (entityPlayer.getEntityData().func_74769_h("GongFa25") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa26") == 0.0d && !entityPlayer.func_70093_af() && entityPlayer.getEntityData().func_74769_h("ShaQi") < 50.0d) {
                        ProcedureGongFaMingXianShi.executeProcedure($_dependencies);
                        entityPlayer.getEntityData().func_74780_a("GongFa25", 1.0d);
                        entityPlayer.getEntityData().func_74780_a("GongFa", 25.0d);
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                            entityPlayer.func_146105_b(new TextComponentString("已学习" + itemstack.func_82833_r() + "§f需要打坐研习才能掌握功法。"), false);
                        }
                        entityPlayer.getEntityData().func_74778_a("GongFaShowFu", "太白剑诀");
                        entityPlayer.getEntityData().func_74778_a("GongFaShow6", "太白剑诀");
        ...
        if (entityPlayer.func_70093_af() && (entityPlayer instanceof EntityPlayer)) {
            entityPlayer.openGui(YvanchujiguanMod.instance, GuiGui25.GUIID, world, x, y, z);
        }
    }
}
