...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFaNbtSet31.class */
public class ProcedureGongFaNbtSet31 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFaNbtSet31(ElementsYvanchujiguanMod instance) {
        super(instance, 254);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entity.getEntityData().func_74779_i("GongFa名暂存").equals("31")) {
            entity.getEntityData().func_74778_a("GongFaGui3", " §1第一层:加1法攻");
            entity.getEntityData().func_74778_a("GongFaGui4", " §1第二层:加320灵力，减2物攻");
            entity.getEntityData().func_74778_a("GongFaGui5", " §1第三层:加2法攻");
            ...
            entity.getEntityData().func_74778_a("GongFaGui11", " §1第七层:加6法攻");
            entity.getEntityData().func_74778_a("GongFaGui12", " §1第八层:加6法攻");
            entity.getEntityData().func_74778_a("GongFaGui13", " §1第九层:加27法攻，减15物攻");
            ...
            entity.getEntityData().func_74778_a("GongFaGui17", " §1第十二层:加70法攻，减34物攻");
