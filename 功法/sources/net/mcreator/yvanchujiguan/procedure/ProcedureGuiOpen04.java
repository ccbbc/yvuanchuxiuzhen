...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGuiOpen04.class */
public class ProcedureGuiOpen04 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGuiOpen04(ElementsYvanchujiguanMod instance) {
        super(instance, 216);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entityPlayer.getEntityData().func_74767_n("OpenGui4")) {
            if (entityPlayer instanceof EntityPlayer) {
                entityPlayer.openGui(YvanchujiguanMod.instance, GuiKMianBan2.GUIID, world, x, y, z);
            }
            entityPlayer.getEntityData().func_74757_a("OpenGui4", false);
        }
    }
