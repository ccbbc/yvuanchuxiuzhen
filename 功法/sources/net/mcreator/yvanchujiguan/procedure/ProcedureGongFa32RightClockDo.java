...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa32RightClockDo.class */
public class ProcedureGongFa32RightClockDo extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa32RightClockDo(ElementsYvanchujiguanMod instance) {
        super(instance, 164);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entityPlayer.func_70093_af()) {
            if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals(entityPlayer.func_145748_c_().func_150260_c())) {
                ...
                entityPlayer.getEntityData().func_74780_a("GongFa", 32.0d);
                entityPlayer.getEntityData().func_74778_a("GongFaShow1", "大衍决");
                ...
                if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
                    if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 1.0d && entityPlayer.getEntityData().func_74769_h("GongFa28") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa19") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa18") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa17") == 0.0d) {
                        ProcedureGongFaMingXianShi.executeProcedure($_dependencies);
                        entityPlayer.getEntityData().func_74780_a("GongFa32", 1.0d);
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                        ...
                        entityPlayer.getEntityData().func_74778_a("FanRenXiuXian1", itemstack.func_82833_r());
                    } else if (entityPlayer.getEntityData().func_74769_h("GongFa19") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa18") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa17") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa28") > 0.0d) {
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
        ...
        if (entityPlayer.func_70093_af() && (entityPlayer instanceof EntityPlayer)) {
            entityPlayer.openGui(YvanchujiguanMod.instance, GuiGui32.GUIID, world, x, y, z);
        }
    }
}
