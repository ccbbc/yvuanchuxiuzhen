...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFaAdd17.class */
public class ProcedureGongFaAdd17 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFaAdd17(ElementsYvanchujiguanMod instance) {
        super(instance, 104);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        entityPlayer.getEntityData().func_74778_a("功法顺序暂存", "17");
        if (entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存")) == 1.0d && entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存") + "Num") >= entityPlayer.getEntityData().func_74769_h("单层进度最大值")) {
            ...
            entityPlayer.getEntityData().func_74780_a("ThunderAttack", entityPlayer.getEntityData().func_74769_h("ThunderAttack") + 4.0d);
            entityPlayer.getEntityData().func_74780_a("ThunderDefense", entityPlayer.getEntityData().func_74769_h("ThunderDefense") + 2.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 3.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("ThunderAttack", entityPlayer.getEntityData().func_74769_h("ThunderAttack") + 12.0d);
                entityPlayer.getEntityData().func_74780_a("ThunderDefense", entityPlayer.getEntityData().func_74769_h("ThunderDefense") + 6.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 4.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("ThunderAttack", entityPlayer.getEntityData().func_74769_h("ThunderAttack") + 36.0d);
                entityPlayer.getEntityData().func_74780_a("ThunderDefense", entityPlayer.getEntityData().func_74769_h("ThunderDefense") + 18.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 5.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("ThunderAttack", entityPlayer.getEntityData().func_74769_h("ThunderAttack") + 216.0d);
                entityPlayer.getEntityData().func_74780_a("ThunderDefense", entityPlayer.getEntityData().func_74769_h("ThunderDefense") + 108.0d);
