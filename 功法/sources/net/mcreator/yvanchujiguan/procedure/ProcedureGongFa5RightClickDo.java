...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa5RightClickDo.class */
public class ProcedureGongFa5RightClickDo extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa5RightClickDo(ElementsYvanchujiguanMod instance) {
        super(instance, 56);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entityPlayer.func_70093_af()) {
            if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals(entityPlayer.func_145748_c_().func_150260_c()) && entityPlayer.getEntityData().func_74769_h("GongFa5") != 0.0d) {
                if (entityPlayer.getEntityData().func_74767_n("TuLingGen") && entityPlayer.getEntityData().func_74769_h("GongFa5") > 0.0d) {
                    if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                        entityPlayer.func_146105_b(new TextComponentString("修炼功法已切换至 " + itemstack.func_82833_r()), false);
                    }
                    entityPlayer.getEntityData().func_74780_a("GongFa", 5.0d);
                    entityPlayer.getEntityData().func_74778_a("GongFaShow", "地蕴功");
            ...
            if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
                if (entityPlayer.getEntityData().func_74769_h("JingJieNum") < 1.0d && entityPlayer.getEntityData().func_74767_n("TuLingGen") && entityPlayer.getEntityData().func_74769_h("GongFa5") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa2") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa3") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa4") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa1") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa27") == 0.0d && !entityPlayer.func_70093_af()) {
                    if (entityPlayer.getEntityData().func_74779_i("GongFaShow").equals("")) {
                        ...
                        entityPlayer.getEntityData().func_74780_a("GongFa5", 1.0d);
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                ...
                } else if (entityPlayer.getEntityData().func_74769_h("GongFa1") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa2") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa3") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa4") > 0.0d) {
                    if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
