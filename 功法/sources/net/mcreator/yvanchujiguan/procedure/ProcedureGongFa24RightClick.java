...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa24RightClick.class */
public class ProcedureGongFa24RightClick extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa24RightClick(ElementsYvanchujiguanMod instance) {
        super(instance, 91);
    }
        ...
        if (!entityPlayer.func_70093_af()) {
            if (entityPlayer.getEntityData().func_74769_h("GongFa24") != 0.0d) {
                if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals(entityPlayer.func_145748_c_().func_150260_c())) {
                    if (entityPlayer.getEntityData().func_74769_h("GongFa24") > 0.0d) {
                        ...
                        entityPlayer.getEntityData().func_74780_a("GongFa", 24.0d);
                        entityPlayer.getEntityData().func_74778_a("GongFaShow", "上古魔功");
            ...
            if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
                if (entityPlayer.getEntityData().func_74779_i("GongFaShow").equals("")) {
                    if (entityPlayer.getEntityData().func_74769_h("GongFa24") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa22") == 0.0d && !entityPlayer.func_70093_af() && entityPlayer.getEntityData().func_74769_h("ShaQi") >= 100.0d) {
                        ProcedureGongFaMingXianShi.executeProcedure($_dependencies);
                        entityPlayer.getEntityData().func_74780_a("GongFa24", 1.0d);
                        entityPlayer.getEntityData().func_74780_a("GongFa", 24.0d);
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                        ...
                        entityPlayer.func_146105_b(new TextComponentString("煞气不够浓郁，无法习得此功法精髓"), false);
                    }
                    if (entityPlayer.getEntityData().func_74769_h("GongFa24") > 0.0d) {
                        if (!itemstack.func_77942_o()) {
                            itemstack.func_77982_d(new NBTTagCompound());
