...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa14RightClickDo.class */
public class ProcedureGongFa14RightClickDo extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa14RightClickDo(ElementsYvanchujiguanMod instance) {
        super(instance, 81);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entityPlayer.func_70093_af()) {
            if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals(entityPlayer.func_145748_c_().func_150260_c())) {
                if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
                    if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 1.0d && entityPlayer.getEntityData().func_74767_n("ShuiLingGen") && entityPlayer.getEntityData().func_74769_h("GongFa14") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa15") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa16") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa13") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa12") == 0.0d) {
                        ...
                        entityPlayer.getEntityData().func_74780_a("GongFa14", 1.0d);
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                            entityPlayer.func_146105_b(new TextComponentString("已学习" + itemstack.func_82833_r() + "§f需要打坐研习才能掌握功法。"), false);
                        }
                        entityPlayer.getEntityData().func_74780_a("GongFa", 14.0d);
                        entityPlayer.getEntityData().func_74778_a("GongFaShow4", "§b玄冰诀");
                    ...
                    } else if (entityPlayer.getEntityData().func_74769_h("GongFa12") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa13") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa15") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa16") > 0.0d) {
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                    ...
                    if (entityPlayer.getEntityData().func_74769_h("GongFa14") > 0.0d) {
                        if (!itemstack.func_77942_o()) {
                            itemstack.func_77982_d(new NBTTagCompound());
                        }
                        itemstack.func_77978_p().func_74778_a("主人", entityPlayer.func_145748_c_().func_150260_c());
            ...
            } else if (entityPlayer.getEntityData().func_74767_n("ShuiLingGen") && entityPlayer.getEntityData().func_74769_h("GongFa14") > 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa15") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa16") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa13") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa12") == 0.0d) {
                if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
        ...
        if (entityPlayer.func_70093_af() && (entityPlayer instanceof EntityPlayer)) {
            entityPlayer.openGui(YvanchujiguanMod.instance, GuiGui14.GUIID, world, x, y, z);
        }
    }
}
