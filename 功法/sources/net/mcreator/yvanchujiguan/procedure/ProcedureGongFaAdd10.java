...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFaAdd10.class */
public class ProcedureGongFaAdd10 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFaAdd10(ElementsYvanchujiguanMod instance) {
        super(instance, 73);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        entityPlayer.getEntityData().func_74778_a("功法顺序暂存", "10");
        if (entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存")) == 1.0d && entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存") + "Num") >= entityPlayer.getEntityData().func_74769_h("单层进度最大值")) {
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 3.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("PowerReply", entityPlayer.getEntityData().func_74769_h("PowerReply") + 160.0d);
