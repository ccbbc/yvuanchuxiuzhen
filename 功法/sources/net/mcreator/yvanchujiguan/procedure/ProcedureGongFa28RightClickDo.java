...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa28RightClickDo.class */
public class ProcedureGongFa28RightClickDo extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa28RightClickDo(ElementsYvanchujiguanMod instance) {
        super(instance, 96);
    }
        ...
        if (!entityPlayer.func_70093_af()) {
            ...
            if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
                if (entityPlayer.getEntityData().func_74779_i("GongFaShow").equals("")) {
                    if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 1.0d && entityPlayer.getEntityData().func_74767_n("JinLingGen") && entityPlayer.getEntityData().func_74767_n("MuLingGen") && entityPlayer.getEntityData().func_74767_n("ShuiLingGen") && entityPlayer.getEntityData().func_74767_n("HuoLingGen") && entityPlayer.getEntityData().func_74767_n("TuLingGen") && entityPlayer.getEntityData().func_74769_h("GongFa28") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa32") == 0.0d) {
                        ProcedureGongFaMingXianShi.executeProcedure($_dependencies);
                        entityPlayer.getEntityData().func_74780_a("GongFa28", 1.0d);
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                        ...
                        entityPlayer.getEntityData().func_74778_a("FanRenXiuXian1", itemstack.func_82833_r());
                    } else if (!entityPlayer.getEntityData().func_74767_n("JinLingGen") || !entityPlayer.getEntityData().func_74767_n("MuLingGen") || !entityPlayer.getEntityData().func_74767_n("ShuiLingGen") || !entityPlayer.getEntityData().func_74767_n("HuoLingGen") || !entityPlayer.getEntityData().func_74767_n("TuLingGen")) {
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                            entityPlayer.func_146105_b(new TextComponentString("非五行灵根者无法修炼"), false);
                        }
                    } else if (entityPlayer.getEntityData().func_74769_h("GongFa32") > 0.0d) {
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
