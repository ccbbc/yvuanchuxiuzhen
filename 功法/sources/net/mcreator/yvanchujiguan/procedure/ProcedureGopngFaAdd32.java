...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGopngFaAdd32.class */
public class ProcedureGopngFaAdd32 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGopngFaAdd32(ElementsYvanchujiguanMod instance) {
        super(instance, 163);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        entityPlayer.getEntityData().func_74778_a("功法顺序暂存", "32");
        if (entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存")) == 1.0d && entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存") + "Num") >= entityPlayer.getEntityData().func_74769_h("单层进度最大值")) {
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 2.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("ShenShi", entityPlayer.getEntityData().func_74769_h("ShenShi") + 36.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 3.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("ShenShi", entityPlayer.getEntityData().func_74769_h("ShenShi") + 100.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 4.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("ShenShi", entityPlayer.getEntityData().func_74769_h("ShenShi") + 300.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 5.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("ShenShi", entityPlayer.getEntityData().func_74769_h("ShenShi") + 1000.0d);
