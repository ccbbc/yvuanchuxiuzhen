...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFaAdd22.class */
public class ProcedureGongFaAdd22 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFaAdd22(ElementsYvanchujiguanMod instance) {
        super(instance, 109);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        entityPlayer.getEntityData().func_74778_a("功法顺序暂存", "22");
        if (entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存")) == 1.0d && entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存") + "Num") >= entityPlayer.getEntityData().func_74769_h("单层进度最大值")) {
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 1.0d) {
                ...
                if (entityPlayer.getEntityData().func_74769_h("ShaQi") > 150.0d) {
                    entityPlayer.getEntityData().func_74780_a("ShaQi", entityPlayer.getEntityData().func_74769_h("ShaQi") - 150.0d);
                } else {
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 2.0d) {
                ...
                if (entityPlayer.getEntityData().func_74769_h("ShaQi") > 300.0d) {
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 3.0d) {
                ...
                if (entityPlayer.getEntityData().func_74769_h("ShaQi") > 600.0d) {
                    entityPlayer.getEntityData().func_74780_a("ShaQi", entityPlayer.getEntityData().func_74769_h("ShaQi") - 600.0d);
                } else {
                    entityPlayer.getEntityData().func_74780_a("ShaQi", 0.0d);
                }
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 5.0d) {
                ...
                if (entityPlayer.getEntityData().func_74769_h("ShaQi") > 1200.0d) {
                    entityPlayer.getEntityData().func_74780_a("ShaQi", entityPlayer.getEntityData().func_74769_h("ShaQi") - 1200.0d);
                } else {
                    entityPlayer.getEntityData().func_74780_a("ShaQi", 0.0d);
                }
