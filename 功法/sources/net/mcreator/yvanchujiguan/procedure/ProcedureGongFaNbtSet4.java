...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFaNbtSet4.class */
public class ProcedureGongFaNbtSet4 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFaNbtSet4(ElementsYvanchujiguanMod instance) {
        super(instance, 244);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entity.getEntityData().func_74779_i("GongFa名暂存").equals("4")) {
            entity.getEntityData().func_74778_a("GongFaGui3", " §2第一层:加5气血");
            entity.getEntityData().func_74778_a("GongFaGui4", " §2第二层:加5气血");
            entity.getEntityData().func_74778_a("GongFaGui5", " §2第三层:加1法攻");
            entity.getEntityData().func_74778_a("GongFaGui6", " §2第三层突破后提升至练气期");
