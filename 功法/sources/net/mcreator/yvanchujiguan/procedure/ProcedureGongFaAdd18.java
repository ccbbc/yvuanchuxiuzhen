...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFaAdd18.class */
public class ProcedureGongFaAdd18 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFaAdd18(ElementsYvanchujiguanMod instance) {
        super(instance, 105);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        entityPlayer.getEntityData().func_74778_a("功法顺序暂存", "18");
        if (entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存")) == 1.0d && entityPlayer.getEntityData().func_74769_h("GongFa" + entityPlayer.getEntityData().func_74779_i("功法顺序暂存") + "Num") >= entityPlayer.getEntityData().func_74769_h("单层进度最大值")) {
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 2.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("FireAttack", entityPlayer.getEntityData().func_74769_h("FireAttack") + 4.0d);
                entityPlayer.getEntityData().func_74780_a("FireDefense", entityPlayer.getEntityData().func_74769_h("FireDefense") + 2.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 3.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("FireAttack", entityPlayer.getEntityData().func_74769_h("FireAttack") + 12.0d);
                entityPlayer.getEntityData().func_74780_a("FireDefense", entityPlayer.getEntityData().func_74769_h("FireDefense") + 6.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 4.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("FireAttack", entityPlayer.getEntityData().func_74769_h("FireAttack") + 36.0d);
                entityPlayer.getEntityData().func_74780_a("FireDefense", entityPlayer.getEntityData().func_74769_h("FireDefense") + 18.0d);
            ...
            if (entityPlayer.getEntityData().func_74769_h("JingJieNum") >= 5.0d) {
                ...
                entityPlayer.getEntityData().func_74780_a("FireAttack", entityPlayer.getEntityData().func_74769_h("FireAttack") + 216.0d);
                entityPlayer.getEntityData().func_74780_a("FireDefense", entityPlayer.getEntityData().func_74769_h("FireDefense") + 108.0d);
