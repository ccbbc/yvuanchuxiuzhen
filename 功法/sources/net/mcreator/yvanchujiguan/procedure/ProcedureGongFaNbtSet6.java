...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFaNbtSet6.class */
public class ProcedureGongFaNbtSet6 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFaNbtSet6(ElementsYvanchujiguanMod instance) {
        super(instance, 246);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (entity.getEntityData().func_74779_i("GongFa名暂存").equals("6")) {
