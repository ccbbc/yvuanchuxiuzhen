...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFaAdd12.class */
public class ProcedureGongFaAdd12 extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFaAdd12(ElementsYvanchujiguanMod instance) {
        super(instance, 99);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        entityPlayer.getEntityData().func_74778_a("功法顺序暂存", "12");
