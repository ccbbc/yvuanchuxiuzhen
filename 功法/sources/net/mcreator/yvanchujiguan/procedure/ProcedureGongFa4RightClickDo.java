...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa4RightClickDo.class */
public class ProcedureGongFa4RightClickDo extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa4RightClickDo(ElementsYvanchujiguanMod instance) {
        super(instance, 55);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entityPlayer.func_70093_af()) {
            if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals(entityPlayer.func_145748_c_().func_150260_c()) && entityPlayer.getEntityData().func_74769_h("GongFa4") != 0.0d) {
                if (entityPlayer.getEntityData().func_74767_n("HuoLingGen") && entityPlayer.getEntityData().func_74769_h("GongFa4") > 0.0d) {
                    if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                        entityPlayer.func_146105_b(new TextComponentString("修炼功法已切换至 " + itemstack.func_82833_r()), false);
                    }
                    entityPlayer.getEntityData().func_74780_a("GongFa", 4.0d);
                    entityPlayer.getEntityData().func_74778_a("GongFaShow", "烈火诀");
            ...
            if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
                ...
                } else if (!entityPlayer.getEntityData().func_74767_n("HuoLingGen")) {
                    if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                        entityPlayer.func_146105_b(new TextComponentString("非火灵根者无法修炼"), false);
                    }
                } else if (entityPlayer.getEntityData().func_74769_h("GongFa1") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa2") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa3") > 0.0d || entityPlayer.getEntityData().func_74769_h("GongFa5") > 0.0d) {
                    if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
