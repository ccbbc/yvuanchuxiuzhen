...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/procedure/ProcedureGongFa26RightClick.class */
public class ProcedureGongFa26RightClick extends ElementsYvanchujiguanMod.ModElement {
    static Map<String, Object> $_dependencies = new HashMap();

    public ProcedureGongFa26RightClick(ElementsYvanchujiguanMod instance) {
        super(instance, 93);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        if (!entityPlayer.func_70093_af()) {
            if (!(itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals(entityPlayer.func_145748_c_().func_150260_c())) {
                if ((itemstack.func_77942_o() ? itemstack.func_77978_p().func_74779_i("主人") : "").equals("")) {
                    if (entityPlayer.getEntityData().func_74769_h("GongFa26") == 0.0d && entityPlayer.getEntityData().func_74769_h("GongFa25") == 0.0d && !entityPlayer.func_70093_af() && entityPlayer.getEntityData().func_74769_h("ShaQi") >= 100.0d) {
                        ProcedureGongFaMingXianShi.executeProcedure($_dependencies);
                        entityPlayer.getEntityData().func_74780_a("GongFa26", 1.0d);
                        entityPlayer.getEntityData().func_74780_a("GongFa", 26.0d);
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                            entityPlayer.func_146105_b(new TextComponentString("已学习" + itemstack.func_82833_r() + "§f需要打坐研习才能掌握功法。"), false);
                        }
                        entityPlayer.getEntityData().func_74778_a("GongFaShow6", "§4血车真诀");
                    ...
                    } else if (entityPlayer.getEntityData().func_74769_h("GongFa25") > 0.0d) {
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                            entityPlayer.func_146105_b(new TextComponentString("你学的功法与此功法冲突。"), false);
                        }
                        if ((entityPlayer instanceof EntityPlayer) && !((Entity) entityPlayer).field_70170_p.field_72995_K) {
                            entityPlayer.func_146105_b(new TextComponentString("是否切换所学功法，若是请发送/rc6"), false);
                        }
                        ...
                        entityPlayer.func_146105_b(new TextComponentString("煞气不足，无法习得此功法精髓"), false);
                    }
                    if (entityPlayer.getEntityData().func_74769_h("GongFa26") > 0.0d) {
                        if (!itemstack.func_77942_o()) {
                            itemstack.func_77982_d(new NBTTagCompound());
                        }
                        itemstack.func_77978_p().func_74778_a("主人", entityPlayer.func_145748_c_().func_150260_c());
        ...
        if (entityPlayer.func_70093_af() && (entityPlayer instanceof EntityPlayer)) {
            entityPlayer.openGui(YvanchujiguanMod.instance, GuiGui26.GUIID, world, x, y, z);
        }
    }
}
