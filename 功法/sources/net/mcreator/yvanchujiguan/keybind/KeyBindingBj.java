...
import net.mcreator.yvanchujiguan.procedure.ProcedureSangng;
...
/* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/keybind/KeyBindingBj.class */
public class KeyBindingBj extends ElementsYvanchujiguanMod.ModElement {
    private KeyBinding keys;
    static Map<String, Object> $_dependencies = new HashMap();

    public KeyBindingBj(ElementsYvanchujiguanMod instance) {
        super(instance, 155);
    }
    ...
    public void init(FMLInitializationEvent event) {
        this.keys = new KeyBinding("key.mcreator.bj", 36, "key.categories.misc");
    ...
    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/keybind/KeyBindingBj$KeyBindingPressedMessageHandler.class */
    public static class KeyBindingPressedMessageHandler implements IMessageHandler<KeyBindingPressedMessage, IMessage> {
        public IMessage onMessage(KeyBindingPressedMessage message, MessageContext context) {
            ...
            entity.func_71121_q().func_152344_a(() -> {
                KeyBindingBj.pressAction(entity);
            });
            return null;
        }
    }

    /* loaded from: 功法-mc1.12.2-2.0.25.jar:net/mcreator/yvanchujiguan/keybind/KeyBindingBj$KeyBindingPressedMessage.class */
    ...
    public static void pressAction(EntityPlayer entity) {
        ...
        ProcedureSangng.executeProcedure($_dependencies);
    }
}
